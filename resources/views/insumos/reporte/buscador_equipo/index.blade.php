  ...
  <div class="box">
    ...
    <div class="box-body">
      <form method="POST" id="reporte_master" action="{{ route('reporte.buscador_equipo_excel') }}" >
        ...
        <div class="form-group col-md-4 col-xs-6" style="padding-left: 0px;padding-right: 0px;">
          <label for="nombre" class="col-md-3 control-label">{{trans('winsumos.nombre')}}</label>
          <div class="col-md-9">
            <div class="input-group">
              <input value="@if($nombre !=''){{$nombre}}@endif" type="text" class="form-control input-sm" name="nombre" id="nombre" placeholder="{{trans('winsumos_reportes.nombre_equipo')}}" >
              <div class="input-group-addon">
        ...
        <div class="form-group col-md-3 col-xs-6" style="padding-left: 0px;padding-right: 0px;">
          <label for="tipo" class="col-md-3 control-label">{{trans('winsumos.Tipo')}}</label>
          <div class="col-md-9">
            <div class="input-group">
              <input value="@if($tipo!=''){{$tipo}}@endif" type="text" class="form-control input-sm" name="tipo" id="tipo" placeholder="{{trans('winsumos_reportes.tipo_producto')}}" >
              <div class="input-group-addon">
        ...
        <div class="form-group col-md-3 col-xs-6" style="padding-left: 0px;padding-right: 0px;">
          <label for="modelo" class="col-md-3 control-label">{{trans('winsumos.modelo')}}</label>
          <div class="col-md-9">
            <div class="input-group">
              <input value="@if($modelo!=''){{$modelo}}@endif" type="text" class="form-control input-sm" name="modelo" id="modelo" placeholder="{{trans('winsumos_reportes.modelo_producto')}}" >
              <div class="input-group-addon">
        ...
        <div class="form-group col-md-3 col-xs-6" style="padding-left: 0px;padding-right: 0px;">
          ...
          <div class="col-md-9">
            <div class="input-group">
              <input value="@if($marca!=''){{$marca}}@endif" type="text" class="form-control input-sm" name="marca" id="marca" placeholder="{{trans('winsumos_reportes.marca_producto')}}" >
              <div class="input-group-addon">
        ...
        <div class="form-group col-md-3 col-xs-6" style="padding-left: 0px;padding-right: 0px;">
          <label for="serie" class="col-md-3 control-label">{{trans('winsumos.serie')}}</label>
          <div class="col-md-9">
            <div class="input-group">
              <input value="@if($serie!=''){{$serie}}@endif" type="text" class="form-control input-sm" name="serie" id="serie" placeholder="{{trans('winsumos_reportes.serie_producto')}}" >
              <div class="input-group-addon">
        ...
        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr>
                ...
                <th>{{trans('winsumos.Tipo')}}</th>
                <th>{{trans('winsumos.marcas')}}</th>
                <th>{{trans('winsumos_reportes.prestamo')}}</th>
