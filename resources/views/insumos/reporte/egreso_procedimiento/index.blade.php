...
<section class="content">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="#">Insumos Reportes</a></li>
      <li class="breadcrumb-item"><a href="../">Egresos por procedimiento</a></li>
    </ol>
  </nav>
  <div class="box">
    ...
    <div class="box-body dobra">
      <form method="POST" id="reporte_master" action="{{ route('insumos.inventario.egresoprocedimiento.show') }}">
        ...
        <div class="form-group col-md-12 col-xs-12 pull-right" style="text-align: right;">
          <button type="button" onclick='docsexcel(0)' class="btn btn-primary" id="boton_buscar">
            <span class="glyphicon glyphicon-search" aria-hidden="true"></span> Buscar
          </button>
          <button type="button" onclick='docsexcel(1)' class="btn btn-success">
            <span class="glyphicon glyphicon glyphicon-book" aria-hidden="true"></span> Excel
          </button>
        </div>
      </form>
    </div>
