        ...
        <div class="col-md-12 col-xs-24">
            <div class="box box-primary"> 
                <div class="box-header with-border">
                    <div class="col-md-9">
                       <h3 class="box-title">{{trans('winsumos.editar_tipo_producto')}}</h3>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-xs-6{{ $errors->has('estado') ? ' has-error' : '' }}">
                            ...
                            <select id="estado" name="estado" class="form-control">
                                <option {{$tipo->estado == 0 ? 'selected' : ''}} value="0">{{trans('winsumos.inactivo')}}</option>
                                <option {{$tipo->estado == 1 ? 'selected' : ''}} value="1">{{trans('winsumos.activo')}}</option>
                            </select>  
