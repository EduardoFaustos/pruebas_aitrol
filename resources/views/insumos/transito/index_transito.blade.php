...
<section class="content">
    <div class="box">
        <div class="box-header">
            <div class="col-sm-12">
                <h3 class="box-title">{{trans('winsumos.transito')}}</h3>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-2" style="text-align: right">
                            <a class="btn btn-success" target="_blank" href="{{ route('transito.excel_transproducc') }}">{{trans('winsumos.excel')}}</a>
                        </div>
                            ...
                            <table id="tbl_detalles" class="display compact responsive"  role="grid" aria-describedby="example2_info" style="margin-top:0 !important; width: 100%!important;">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{trans('winsumos.bodega_origen')}}</th>
                                        <th>{{trans('winsumos.bodega_destino')}}</th> 
                                ...
                                <tbody>
                                    @foreach($traslados as $x)
                                        <tr id="section{{$x->id}}">
                                            ...
                                            <td>{{$x->observacion}}</td> 
                                            <td>@if(isset($x->usuariocrea)){{$x->usuariocrea->nombre1}} {{$x->usuariocrea->apellido1}}@endif</td> 
    ...
    function actualiza(){
        $('#tbl_detalles').DataTable({ 
            ...
            language: {
                ...
                "infoEmpty": "{{trans('winsumos.mostrando')}} 0 to 0 of 0 {{trans('winsumos.registros')}}",
                "infoFiltered": "({{trans('winsumos.filtrado')}} de _MAX_ {{trans('winsumos.registros')}})",
                "infoPostFix": "",
                "thousands": ",",
                "lengthMenu": "{{trans('winsumos.mostrando')}} _MENU_ {{trans('winsumos.registros')}}",
                "loadingRecords": "{{trans('winsumos.cargando')}}...",
                    ...
                    <table style="width: 92%!important; border: 2px solid black;" class='container table table-hover table-bordered sub_tabla${id}'> 
                        <thead> 
                            <tr> 
                                ...
                                <th>{{trans('winsumos.cantidad_usos')}}</th> 
