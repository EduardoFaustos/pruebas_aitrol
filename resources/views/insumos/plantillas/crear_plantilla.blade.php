          ...
          <form method="POST" id="form_plantilla">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <input type="text" name="nombre" placeholder="Nombre"  class="form-control" style="text-transform: uppercase">
              </div>
              <div class="col-md-2">
              ...
              <!-- <input type="submit" name="" value="Guardar" class="btn btn-success">-->
                ...
                <a onclick="guardar_plantilla();" type="button" class="btn btn-success" id="btn_guardar">{{trans('winsumos.guardar')}}</a>
              </div>
...
<script>
        ...
        function guardar_plantilla(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('insumo_planilla.guardar')}}",
                headers: {
                    'X-CSRF-TOKEN': $('input[name=_token]').val()
                },
                datatype: 'json',
                ...
                success: function(data) {
                    console.log(data);
                    if (data == "ok") {
                        alertas('success', "{{trans('winsumos.correcto')}}", `{{trans('proforma.GuardadoCorrectamente')}}`);
