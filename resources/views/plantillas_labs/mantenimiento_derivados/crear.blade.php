...
<section class="content">
    <div class="box">
        <div class="box-header"><h3 class="box-title">Crear Tipo Pago</h3>
        </div>
        <div class="box-body">
            <form id="crear_plantilla" method="post" action="{{route('tipo_pago.store')}}">
                {{ csrf_field() }}
            
                             
                <div class="box-body">
                    <div class="form-group col-xs-6{{ $errors->has('descripcion_tipo') ? ' has-error' : '' }}">
                        <label for="descripcion_tipo" class="col-md-20 control-label">Tipo Pago</label>
