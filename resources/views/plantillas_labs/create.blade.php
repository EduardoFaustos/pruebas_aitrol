...
<section class="content contenido">
    <div class="box">
        <div class="box-header">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="box-title" style="margin-top: 7px">Crear Plantilla Control LABS</h3>
                </div>
            ...
            <form id="formulario" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12"><br>
                        <h4 align="center" style="color:#a6004c"><i class="fa fa-list"></i>{{trans('winsumos.items_plantilla')}}</h4><br>
                        <br/>
...
<script>
            ...
            if (total.length == 0) {
               ...
               // mensaje = mensaje_producto + mensaje_total + mensaje_v_unitario + mensaje_cantidad + mensaje_plantilla;
                ...
                if (mensaje != "") {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{route('plantillacontrollabs.comprobar')}}",
    ...
    function enviar_formulario() {
        $.ajax({
            type: 'post',
            url: "{{route('plantillacontrollabs.save')}}",
            headers: {
                'X-CSRF-TOKEN': $('input[name=_token]').val()
            },
            datatype: 'json',
