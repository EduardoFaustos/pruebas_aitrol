...
<script type="text/javascript">
	...
	function editarprocedimiento_ecografia(id, id_paciente){
    	var entra = id;
			$.ajax({
			type: "GET",
			url: "{{route('editar.procedimiento_ecografia')}}/"+id+'/'+id_paciente,
			data: "",
			datatype: "html",
			success: function(datahtml, entra){
				$("#procedimiento"+id).html(datahtml);
	  	...
	  	<div class="col-md-12 col-sm-12 col-12">
		    <h1 style="font-size: 15px; margin:0; background-color: #004AC1; color: white;" >
            	<img style="width: 35px; margin-left: 5px; margin-bottom: 5px" src="{{asset('/')}}hc4/img/iconos/pendo.png">
             	<b>PROCEDIMIENTO SELECCIONADO</b>
			</h1>
		</div>
	  	...
	  	<div class="row parent" >
	  		...
	  		@foreach($procedimientos2 as $value)
		    	...
		    	<div class="col-12">
		    		...
		    		@endphp
		    		<div class="box collapse-box " style="border: 2px solid #004AC1; background-color: #004AC1; border-radius: 0px; ">
						  					...
						  					<div class="row">
							  					<div class="col-3" style="margin-right: 10px">
							    					<div class="btn" style="color: white">
									    				<a class="fa fa-pencil-square-o "  @if($value->tipo == 0)onclick="editarprocedimiento({{$value->id_procedimiento}}, '{{$paciente->id}}');" @else onclick="editarprocedimiento_ecografia({{$value->id_procedimiento}}, '{{$paciente->id}}');" @endif ><span style="font-size: 13px">&nbsp;Editar</span>
									    				</a>
								    				</div>
							    				</div>
				...
				<script type="text/javascript">
						...
						@else
							editarprocedimiento_ecografia({{$value->id_procedimiento}}, '{{$paciente->id}}');
						@endif
						  			...
						  			<div class="box" style="border: 2px solid #004AC1; background-color: white; border-radius: 3px; margin-bottom: 0;">
						  				<div class="box-header with-border" style="background-color: #004AC1; color: white; font-family: 'Helvetica general3';border-bottom: #004AC1;padding: 2px;">
						  					<div class="row">
							  					<div class="col-3" style="margin-right: 10px">
							    					<div class="btn" style="color: white">
									    				<a class="fa fa-pencil-square-o " @if($value->tipo_procedimiento == 0)onclick="editarprocedimiento({{$value->id_procedimiento}}, '{{$paciente->id}}');" @else onclick="editarprocedimiento_ecografia({{$value->id_procedimiento}}, '{{$paciente->id}}');" @endif  ><span style="font-size: 13px">&nbsp;Editar</span>
									    				</a>
								    				</div>
							    				</div>
							    				<div class="col-8" style="text-align: center">
