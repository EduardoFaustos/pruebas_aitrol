...
<div class="row">
    ...
    <div id="alerta_datos" class="alert alert-danger alerta_correcto alert-dismissable col-10" role="alert" style="display:none; margin-left: 20px; font-size: 14px">
		...
		<div class="col-12">
			<div id="thallazgos<?php echo e($procedimiento->id); ?>{{$var_tiempo_func}}" style="border: solid 1px;"><?php if(!is_null($protocolo)): ?><?php echo $protocolo->hallazgos ?><?php endif; ?></div>
			<input type="hidden" name="hallazgos" id="hallazgos<?php echo e($procedimiento->id); ?>{{$var_tiempo_func}}">
		</div>
		<div class="col-12">&nbsp;</div>
		<div class="col-12">
		...
		<div class="col-12">
			<div id="tconclusion<?php echo e($procedimiento->id); ?>{{$var_tiempo_func}}" style="border: solid 1px;"><?php if(!is_null($protocolo)): ?><?php echo $protocolo->conclusion ?><?php endif; ?></div>
            <input type="hidden" name="conclusion" id="conclusion<?php echo e($procedimiento->id); ?>{{$var_tiempo_func}}">
		</div>
		...
		<div class="col-12">
		   ...
		   <div class="col-4">
            <select name="id_doctor_examinador">
		...
		<div  style="text-align: center;">
            <button style="font-size: 15px; margin-bottom: 15px; height: 30px; width: 125px;"  type="button" class="btn btn-info btn_ordenes" onclick="guardar_procedimiento_func(<?php echo e($procedimiento->id); ?>)"  ><span class="fa fa-floppy-o"></span>&nbsp;&nbsp;Guardar
            </button>
        </div>
	</form>
</div>
