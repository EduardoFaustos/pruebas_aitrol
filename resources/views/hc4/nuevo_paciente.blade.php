...
<div class="modal-header" style="background-color: #124574; color: white; font-family: 'Helvetica general3';border-bottom: #124574;">
    <h4 class="modal-title" id="myModalLabel">DATOS DEL PACIENTE</h4>
</div>

<div class="modal-body" style="border: 2px solid white;border-radius: 3px;">
    ...
    <div class="panel-body">
        ...
        <form method="POST" id="form" >
          <div class="col-12" >
            ...
            <!--div class="form-group col-md-6  {{ $errors->has('nombre2') ? ' has-error' : '' }}">
                ...
                <div class="col-md-8">
                    <input id="nombre2" type="text" class="form-control"  name="nombre2" value="{{old('nombre2')}}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required >
                    <span class="help-block">
                        <strong id="str_nombre2"></strong>
                    </span>
                </div>
            </div-->
            ...
            <!--div class="form-group col-md-6 {{ $errors->has('apellido2') ? ' has-error' : '' }}">
                ...
                <div class="col-md-8">
                    <input id="apellido2" type="text" class="form-control"  name="apellido2" value="{{old('apellido2')}}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required >
                    <span class="help-block">
                        <strong id="str_nombre1"></strong>
                    </span>
                </div>
            ...
            <!--div class="form-group">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-danger btn_ordenes" style="color:white;"><span class="fa fa-save"> Guardar</span></button>
      ...
      <center>
            <div class="col-md-12">
                <button class="btn btn-danger" style="color:white; background-color:#124574; border-radius: 5px; border: 2px solid white;" onclick="guardar();"><span class="fa fa-save"> Guardar</span></button>
            </div>
        </center>
    </div>
