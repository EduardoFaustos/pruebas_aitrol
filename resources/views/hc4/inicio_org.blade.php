...
<div class="container-fluid">
  <div class="col-md-12">
    <div id="navbar" class="row"  style="z-index: 99999">
      <div class="col-lg-12 col-md-12" style="background: #0E1927;">
        <div class="row row_datos">
          <div class="col-lg-5 col-sm-12 col-12">
            <div class="row">
              <div class="col-12" style="padding: 5px 2px; padding-left: 5px; height: 240px;">
                <a onclick="cargar_pacientes_doctor();" class="boton calendario"  style="color: #0E1927; height: 230px">
                  <div class="row">
                    <div class="col-12" style="height: 42px; text-align: left; color: #0E1927">
                      <img src="{{asset('/')}}hc4/img/bt_ca2.png" style="background-color: none;height: 46px;">
                      <span>AGENDA DEL D&Iacute;A</span>
                    </div>
                    <hr style="background-color: #0E1927;">
                    <div class="col-12" >
                      <div class="row">
                          ...
                          <div class="row">
                            <div class="col-12">
                              <div class="row">
                                ...
                                <div class="col-10" style="text-align: left;">
                                  <span style="color: #0E1927; font-size: 14px;"><b>CALENDARIO DE AGENDA</b></span>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-12">
                              <div class="row">
                                <div class="col-1"></div>
                                  <div class="col-4">
                                    <p class="align-middle" style='text-align: center;margin:0;line-height: 1;color: #0E1927;'><span><b style="font-size: 30px;">{{date('d')}}</b></span><br><span style="line-height: 1; font-size: 16px; text-align: center"> @if(date('N') == 1) Lunes @elseif(date('N') == 2) Martes @elseif(date('N') == 3) Miercoles @elseif(date('N') == 4) Jueves @elseif(date('N') == 5) Viernes @elseif(date('N') == 6) Sabado @elseif(date('N') == 7) Domingo @endif</span></p>
                                  </div>
                                  <div class="col-6" style="text-align: left;">
                                    <div style="height: 8px;"></div>
                                    <span style="font-size:14px; text-align: left; color: #0E1927;">@if(date('m') == 1) Enero @elseif(date('m') == 2) Febrero @elseif(date('m') == 3) Marzo @elseif(date('m') == 4) Abril @elseif(date('m') == 5) Mayo @elseif(date('m') == 6) Junio @elseif(date('m') == 7) Julio @elseif(date('m') == 8) Agosto @elseif(date('m') == 9) Septiembre @elseif(date('m') == 10) Octubre @elseif(date('m') == 11) Noviembre @elseif(date('m') == 12) Diciembre @endif {{date('Y')}}</span>
                                  </div>
                              </div>
                            </div>
                            <hr style="height: 0px;">
          ...
          <div class="col-lg-7 col-sm-12 col-12">
            <div class="row">
              <div class="col-sm-3 col-6" style="padding: 5px 2px;">
                <a  onclick="cargar_horario_doctor();" class="boton"  style="  height: 230px; color: #0E1927; background-image: linear-gradient(to right, #FFFFFF,#FFFFFF,#d1d1d1);border-radius: 10px;">
              ...
              <div class="col-sm-3 col-6" style="padding: 5px 2px;">
                <a onclick="cargar_listado_paciente();" class="boton"  style="  height: 230px; color: #0E1927; background-image: linear-gradient(to right, #FFFFFF,#FFFFFF,#d1d1d1);border-radius: 10px;">
                  <div class="row" style="text-align: center;">
                    <div style="width: 100%;">
              ...
              <div class="col-sm-3 col-6" style="padding: 5px 2px;">
                <a onclick="cargar_ordenes_laboratorio();" class="boton"  style="  height: 230px; color: #0E1927; background-image: linear-gradient(to right, #FFFFFF,#FFFFFF,#d1d1d1);border-radius: 10px;">
                  <div class="row" style="text-align: center;">
                    <div style="width: 100%;">
              ...
              <div class="col-sm-3 col-6" style="padding: 5px 2px;">
                <a  onclick="cargar_crear_editar();" class="boton"  style="  height: 110px; color: #0E1927; background-image: linear-gradient(to right, #FFFFFF,#FFFFFF,#d1d1d1);border-radius: 10px;">
                  <div class="row" style="text-align: center;">
                ...
                <a  onclick="plantilla_proc();" class="boton"  style="margin-top: 5px;  height: 112px; color: #0E1927; background-image: linear-gradient(to right, #FFFFFF,#FFFFFF,#d1d1d1);border-radius: 10px;">
...
<section class="content" >
  <div class="container-fluid" id="info" style="padding-left: 0px; padding-right: 0px;">
    <div class="col-md-12" style="font-family: Helvetica;color: white; margin-top: 5px; padding: 10px; border-radius: 8px; background-color: #6B6B6F; margin-bottom: 10px">
          ...
          <div class="col-lg-8 col-12">
            <div class="row" style="padding-top: 5px">
              ...
              <!--<div class="col-md-2 col-sm-6 col-12" style="text-align: center;">
                <a class="btn btn-danger" onclick="cargar_nuevopaciente();" style="color:white; background-color:#0E1927 ; border-radius: 5px; border: 2px solid white;">  Agregar Nuevo Paciente
                </a>
              </div>
              <div class="col-2"></div>-->
              <div class="col-lg-6 col-12" >
            ...
            <div class="row">
              ...
              <div class="col-lg-2 col-md-4 form-group col-xs-4" >
                <button type="button" onclick="buscador_paciente_fecha();" class="btn btn-danger" style="color:white; background-color: #6B6B6F; border-radius: 5px; border: 2px solid white;"> <i class="fa fa-search" aria-hidden="true">
                </i> &nbsp;BUSCAR&nbsp;</button>
              </div>
            </div>
          </div>
