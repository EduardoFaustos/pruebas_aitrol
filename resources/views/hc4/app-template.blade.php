...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.6 -->
    <link href="{{ asset("/hc4/css/bootstrap.css") }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset("/hc4/css/helvetica.css") }}" rel="stylesheet" type="text/css" />
    <!-- Font Awesome -->
    ...
    <link type="text/css" href="{{asset('imageedit/dist/tui-image-editor.css')}}" rel="stylesheet" />
    <script
...
*{
  font-family: 'Helvetica general3';
    ...
    <script src="{{ asset ("/hc4/js/popper.js") }}" type="text/javascript"></script>
...
-->
  ...
  <!--
    ...
    |---------------------------------------------------------|
    -->
  <body class=" layout-top-nav" id="body2" >
    <div class="wrapper">
    <!-- Main Header -->
    @include('hc4.header')
    <!-- Sidebar -->
    ...
    <script src="{{ asset ("/hc4/js/bootstrap.js") }}" type="text/javascript"></script>
    ...
    <!-- Optionally, you can add Slimscroll and FastClick plugins.
      ...
      <script>
        ...
        function explode(){
          alert('Se ha cerrado sesion por inactividad');
          location.reload();
        }
        setTimeout(explode, 7201000);
  </script>
