...
<script type="text/javascript">
   ...
   {
    window.open("https://mdconsgroup.ec/sandboxdoctor.php", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,location=no,width=800,height=600");
   }
</script>
...
<script type="text/javascript">
    ...
    function guardar_cie10_consulta(hcid, hc_id_procedimiento, div_receta, variable_tiempo){
        $.ajax({
            ...
            headers:{'X-CSRF-TOKEN':$('input[name=_token]').val()},
            datatype: 'json',
            data: { 'codigo': $("#codigo"+hc_id_procedimiento+variable_tiempo).val(), 'pre_def': $("#pre_def"+hc_id_procedimiento+variable_tiempo).val(), 'hcid': hcid, 'hc_id_procedimiento': hc_id_procedimiento, 'in_eg': null, 'id_paciente': '{{$paciente->id}}' },
            success: function(data){
                        ...
                        <div class="box @if(substr($value->fechaini,0,10) != date('Y-m-d'))  collapsed-box @endif " style="border: 2px solid #004AC1; background-color: #004AC1; border-radius: 3px; ">
                            ...
                            <div class="box-body" style="background: white;">
                                <form id="frm_evol{{$value->hc_id_procedimiento}}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-5" style="font-size: 12px">
                                                <b>
                                                    ...
                                                    <a onclick="videollamada();" id="boton" class="btn btn-danger" style="color: white;"> Video Llamada</a>
                                                    @endif
                                                </b>
                                            </div>
                                        </div>
                                    ...
                                    @if(substr($value->fechaini,0,10) == date('Y-m-d'))
                                    <div class="col-12">
                                        <iframe width="100%" height="600px;" src="https://mdconsgroup.ec/consultas/index.php/login"></iframe>
