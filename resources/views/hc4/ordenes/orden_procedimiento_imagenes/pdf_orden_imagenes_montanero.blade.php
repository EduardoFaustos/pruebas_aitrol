...
<body lang=ES-EC style="margin-top: 5px;">
    ...
    <div id="header">
       ...
       <div style="float: left;width: 10%;text-align: left;">
        <img style="width:150px; height: auto;" src="{{base_path().'/public/imagenes/logo_omni2.png'}}">
      </div>
      <div  style="text-align: right;">
          <img style="margin: 0;width: 180px;">
          <p style="font-size: 25px;"><font face="Comic Sans MS,arial,verdana"> Dr. Eduardo Montanero Soledispa</font><br> Traumatólogo - Ortopedista</br><p></td>
      </div>
    </div>
    <br>
    <br>
    ...
    <div id="footer1" style="text-align: center">
      <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:normal'><span style='font-size:6.0pt;mso-bidi-font-size:11.0pt'><o:p><img style="width:1100px; height: 6px" src="{{base_path().'/public/imagenes/lineas_recetas2.png'}}"></o:p></span>
      </p>
