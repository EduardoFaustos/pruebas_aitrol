...
<option selected value="49 ">Ecuador</option>
...
<div class="form-group col-xs-4">
                      <label for="telefono2">Telefono Celular</label>
                      <input type="text" class="form-control" id="telefono2" name="telefono2" placeholder="telefono celular" required>
</div>

<div class="form-group col-xs-4">
                      <label for="telefono3">Telefono Familiar</label>
                      <input type="text" class="form-control" id="telefono3" name="telefono3" placeholder="telefono familiar" required>
</div>
