                                ...
                                <tr class="well">
                                    ...
                                    <td style="max-width:100px;">
                                        ...
                                        <select name="nombre[]" class="form-control select" style="width:100%" required onchange="verificar(this)">
                                            ...
                                            <option value="{{$value->nombre}}" @if($z->codigo==$value->codigo) selected="selected" @endif data-name="{{$value->nombre}}" data-codigo="{{$value->codigo}}" data-descuento="{{$value->mod_desc}}" data-precio="{{$value->mod_precio}}" data-maxdesc="{{$value->descuento}}" data-iva="{{$value->iva}}">{{$value->codigo}} | {{$value->descripcion}}</option>
                                            @endforeach
