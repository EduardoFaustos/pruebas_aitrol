...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="../ventas">Crear Orden de Venta</a></li>
...
<div class="box">
    <div class="box-header header_new">
        ...
        <div class="col-md-1 text-right">
            <a href="{{route('orden_venta')}}" class="btn btn-default btn-gray" >
...
<div class="box-body dobra">
    <form class="form-vertical" id="form">
        ...
        <div class="header row">
            <div class="form-group col-xs-6 col-md-2 px-1 oculto">
            ...
            <div class="form-group col-xs-6  col-md-2  px-1">
                ...
                <div class="col-md-12 px-0">
                    <input type="text" class="form-control" name="tipo" id="tipo" value="VEN-OV" readonly>
                    @if ($errors->has('tipo'))
                        <span class="help-block">
            ...
            <div class="form-group col-xs-6  col-md-2  px-1">
                ...
                <div class="col-md-12 px-0">
                    <input id="fecha" type="date" class="form-control"  name="fecha_asiento" value="{{ old('fecha_asiento') }}"   required >
            ...
            <div class="form-group col-xs-6  col-md-1  px-1 oculto" style="visibility:hidden">
                <div class="col-md-12 px-0">
                ...
                <div class="col-md-12 px-0">
                    <!--<select class="form-control" name="sucursal" id="sucursal" onchange="obtener_caja()" >
                        ...
                        @foreach($sucursales as $value)
                            <option value="{{$value->id}}" selected>{{$value->codigo_sucursal}}</option>
                        @endforeach
                    </select>-->
                    <input id="sucursal" type="text" class="form-control"  name="sucursal" value="0"  >
                </div>
            </div>
            <div class="form-group col-xs-6  col-md-1  px-1 oculto">
                <div class="col-md-12 px-0">
                ...
                <div class="col-md-12 px-0">
                    ...
                    <input id="punto_emision" type="text" class="form-control"  name="punto_emision" value="0"  >
                </div>
            </div>
            <div class="form-group col-xs-6  col-md-2  px-1 oculto">
                <div class="col-md-12 px-0">
...
//precioneto
    ...
    $(".btn_add").click(function(){
        let tipo_consul = document.getElementById("tipo_consulta");
        console.log(tipo_consul.value);
        if(tipo_consul.value == 0){
            swal("No ha seleccionado el Tipo de Consulta"); 
        }else{
            if($("#form").valid()){
                ...
                $("#mifila").html("");
                $.ajax({
                    url:"{{route('ventas.store_ordenes')}}",
                    headers:{'X-CSRF-TOKEN':$('input[name=_token]').val()},
                    type: 'POST',
                    datatype: 'json',
                    data: $("#form").serialize(),
