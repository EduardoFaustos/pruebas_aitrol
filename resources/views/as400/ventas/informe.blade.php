            ...
            <table id="example2" class="table table-striped" role="grid" aria-describedby="example2_info" style="font-size: 12px; text-align:center;">
              <thead>
                <tr class='well-dark'>
                  ...
                  <th width="7.25%" style="text-align:center;" tabindex="0" aria-controls="example2" rowspan="1">Número</th>
                  <th width="12.25%" style="text-align:center;" tabindex="0" aria-controls="example2" rowspan="1">Autorizacion</th>
                  <th width="7%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">CI</th>
                  <th width="6.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">Cliente</th>
                  <th width="6.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">Tipo</th>
                  <th width="16.50%" style="text-align:center;"tabindex="0" aria-controls="example2" colspan="1">Detalle</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">SubTotal12</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">SubTotal0</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">SubTotal</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">Descuento</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">Impuesto</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">Total</th>
