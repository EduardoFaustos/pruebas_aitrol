    ...
    <div class="box-body dobra">
        <form class="form-vertical" id="form">
            ...
            <div class="header row">
                ...
                <div class="form-group col-xs-6 col-md-2 px-1">
                    <div class="col-md-12 px-0">
                        <label for="numero" class=" label_header">N&uacute;mero Factura</label>
                    </div>
                    <div class="col-md-12 px-0">
                    ...
                    <div class="col-md-12 px-0">
                        ...
                        <select class="form-control" name="sucursal" id="sucursal" onchange="obtener_caja()" @if($empresa->electronica==1) @else required @endif>
                            ...
                            @if($empresa->electronica==1)
                              <option selected="selected" value="0">{{$empresa->establecimiento}}</option>
                            @endif
                ...
                <div class="form-group col-xs-6  col-md-2  px-1">
                    ...
                    <div class="col-md-12 px-0">
                        <select class="form-control" name="punto_emision" id="punto_emision" @if($empresa->electronica==1) @else required @endif>
                            <option value="">Seleccione...</option>
                            @if($empresa->electronica==1)
                            <option selected="selected" value="0"> {{$empresa->establecimiento}} {{$empresa->punto_emision}}</option>
                            @endif
                        </select>
                    </div>
                </div>
