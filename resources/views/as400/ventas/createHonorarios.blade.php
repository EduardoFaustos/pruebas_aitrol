...
<section class="content">
                            ...
                            <thead>
                                <tr class='well-dark'>
                                    ...
                                    <th width="10%" tabindex="0">
                                        <button onclick="nuevo('{{$paciente->id}}','{{$p['hc_procedimiento']}}','{{$p['agenda']}}')" type="button" class="btn btn-success btn-gray">
    ...
    <script type="text/javascript">
        ...
        $('body').on('change', '.copago', function() {
            ...
            var total = (parseInt(cant) * parseFloat(precio)) - descuento ;
            //console.log(total);
        ...
        function totales(e) {
            ...
            if (e == 0) {
                $('.cneto').each(function(i, obj) {
                    ...
                    //console.log(iva);
                    var total = (parseInt(cant) * parseFloat(precio)) - parseFloat(0);
                    if (iva == 1) {
                        //console.log(subt12);
                        subt12.push(total);
                        sb12 = sb12 + total;
        ...
        function nuevo(patient, procedimiento, id_agenda) {
