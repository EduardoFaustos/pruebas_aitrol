...
.table-condensed>thead>tr>th>td, .table-condensed>tbody>tr>th>td, .table-condensed>tfoot>tr>th>td, .table-condensed>thead>tr>td, .table-condensed>tbody>tr>td, .table-condensed>tfoot>tr>td {
  ...
  <div class="box">
      ...
      <div class="box-body dobra">
        <form method="POST" id="reporte_master" action="{{ route('indicadorconsolidado.resultado') }}" >
        {{ csrf_field() }}
          ...
          <div class="col-md-12">
            <div class="box box-solid">
              ...
              <div class="box-body">
                ...
                <div class="col-md-4">
                  <h4 style="text-align: center;">{{trans('etodos.IndicadorFinancieroConsolidado')}}</h4>
        ...
        <div class="row">
          ...
          <div class="content">
            ...
            <table id="example2" class="table table-condensed" role="grid" aria-describedby="example2_info" style="font-size: 12px;">
              ...
              <tbody>
                <tr>
                  <td colspan="3"><strong>{{trans('etodos.LIQUIDEZ')}}</strong></td>
                </tr>
                ...
                @php
                  ...
                  //dd($liquidez);
                @endphp
                @foreach($liquidez[$fechault] as $value)
                @php
                //dd($value['cuenta']);
                ...
                @endphp
                  <tr>
                    ...
                    @if ($anios==1)
                    <td style="font-size: 10px;text-align: right; @if($value['saldo'] < 0) color:red; @endif" >{{($value['saldo'])}}</td>
                    @else
                      @foreach($fechagrupo as $fecha)
                      <td style="font-size: 10px;text-align: right; @if($liquidez[$fecha][$index]['saldo'] < 0) color:red; @endif" >{{($liquidez[$fecha][$index]['saldo'])}}</td>
                      @endforeach
                    @endif
                  </tr>
                @php $index++; @endphp
                ...
                <tr>
                  <td colspan="3"><strong>{{trans('etodos.SOLVENCIA')}}</strong></td>
                </tr>
                ...
                @php
                  ...
                  //dd($liquidez);
                @endphp
                @foreach($solvencia[$fechault] as $value)
                @php
                //dd($value['cuenta']);
                ...
                @endphp
                  <tr>
                    ...
                    @else
                      @foreach($fechagrupo as $fecha)
                      <td style="font-size: 10px;text-align: right; @if($solvencia[$fecha][$index]['saldo'] < 0) color:red; @endif" >{{($solvencia[$fecha][$index]['saldo'])}}</td>
                      @endforeach
                    @endif
                  </tr>
                @php $index++; @endphp
                ...
                <tr>
                  <td colspan="3"><strong>{{trans('etodos.GESTIÓN')}}</strong></td>
                </tr>
                ...
                @php
                  ...
                  //dd($liquidez);
                @endphp
                @foreach($gestion[$fechault] as $value)
                @php
                //dd($value['cuenta']);
                ...
                @endphp
                  <tr>
                    ...
                    @else
                      @foreach($fechagrupo as $fecha)
                      <td style="font-size: 10px;text-align: right; @if($gestion[$fecha][$index]['saldo'] < 0) color:red; @endif" >{{($gestion[$fecha][$index]['saldo'])}}</td>
                      @endforeach
                    @endif
                  </tr>
                @php $index++; @endphp
                ...
                <tr>
                  <td colspan="3"><strong>{{trans('etodos.RENTABILIDAD')}}</strong></td>
                </tr>
                ...
                @php
                  ...
                  //dd($liquidez);
                @endphp
                @foreach($rentabilidad[$fechault] as $value)
                @php
                //dd($value['cuenta']);
                ...
                @endphp
                  <tr>
                    ...
                    @else
                      @foreach($fechagrupo as $fecha)
                      <td style="font-size: 10px;text-align: right; @if($rentabilidad[$fecha][$index]['saldo'] < 0) color:red; @endif" >{{($rentabilidad[$fecha][$index]['saldo'])}}</td>
                      @endforeach
                    @endif
                  </tr>
                @php $index++; @endphp
  ...
  <form method="POST" id="print_reporte_master" action="{{ route('indicadorconsolidado.resultado') }}" target="_blank">
    {{ csrf_field() }}
