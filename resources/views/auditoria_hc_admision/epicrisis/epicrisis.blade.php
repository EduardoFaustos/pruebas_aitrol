        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <a target="_blank" class="form-group col-md-3 col-sm-3 col-xs-3" href="{{route('auditoria_epicrisis.imprimir',['id' => $epicrisis->id])}}"><button type="button" class="btn btn-primary btn-sm" ><span class="glyphicon glyphicon-download-alt"></span> Descargar</button>
                    </a>   
                </div>
                <div class="box-body">
                    ...
                    <form id="frm">
                        ...
                        <div class="input-group date col-md-4">
                            ...
                            <input type="text" value="@if(!is_null($epicrisis->fecha_imprime)){{$epicrisis->fecha_imprime}}@else{{$protocolo->historiaclinica->agenda->fechaini}}@endif" name="fecha_imprime" class="form-control input-sm" id="fecha_imprime" onchange="guardar()">
                        </div>
                        <br>
...
<script>
    ...
    function guardar(){
        ...
        $.ajax({
          type: 'post',
          url:"{{route('auditoria_epicrisis.actualiza')}}", 
  ...
  $("#cie10").autocomplete({
    ...
    function cargar_tabla(){
        $.ajax({
                url:"{{route('auditoria_epicrisis.cargar',['id' => $epicrisis->hc_id_procedimiento])}}",
                dataType: "json",
                type: 'get',
                success: function(data){
