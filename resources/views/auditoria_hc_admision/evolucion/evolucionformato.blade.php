...
<head>
  <title>Evolución Auditoría</title>
...
@endphp
<div class=WordSection1><!--EVOLUCION DE TIPO DE ANESTESIA GENERAL-->
...
<table class=MsoTableGrid cellspacing=0 cellpadding=0
 ...
 <tr style='height:50pt'>
  <td width=57 @if($cardiologia!=null) rowspan=3 @else rowspan=2 @endif valign=top style='width:42.55pt;border-top:none;padding:0cm 5.4pt 0cm 5.4pt;height:50.0pt;padding-top: 5pt;border-left:solid windowtext 1.0pt;'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  ...
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal;text-align: right; '><span style='font-size:7.0pt'>{{date ( 'H:i' , strtotime ( '-120 minute' , strtotime ($hora_ini) )) }}</span></p>
  </td>
  ...
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:9px !important;'><?php echo $evolucion[0]->cuadro_clinico ?><br></span>
  <!--span style='font-size:7.0pt'><b>LABORATORIO:<br></b></span-->
  <span style='font-size:7.0pt'><?php echo $evolucion[0]->laboratorio ?><br></span></p>
  </td>
  ...
  normal'> <br>1.- CSV <br> 2.- PREPARAR PARA PROCEDIMIENTO <br> 3.- SOL SAL 0,9% 1000cc a 30gts x min <br> 4.-SEGUIR INDICACIONES DE MEDICO RESIDENTE <br> 5.-SE SOLICITA EXAMENES PRE-QUIRURGICOS @if($cardiologia!=null) <br> 6.- VALORACIÓN CARDIOLÓGICA @endif <br><br>
  </p>
  </td>
 ...
 <tr style='height:50pt'>
  ...
  <td width=47 valign=top style='width:35.45pt;border-top:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;border-left:solid windowtext 1.0pt; padding:0cm 5.4pt 0cm 5.4pt;height:50pt;padding-top: 5pt;'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal;text-align: right; '><span style='font-size:7.0pt'>{{date ( 'H:i' , strtotime ( '-15 minute' , strtotime ($hora_ini) )) }}</span></p>
  </td>
  <td width=150 colspan=4 valign=top style='width:120pt;border-top:none;
  border-left:none;border-right:solid windowtext 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;border-bottom:solid windowtext 1.0pt;height:50.0pt'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:9px !important;'><?php echo str_replace('<','&lt;',$cardiologia->resumen); ?><br></span>
  <!--span style='font-size:7.0pt'><b>LABORATORIO:<br></b></span-->
  <span style='font-size:7.0pt'><?php echo $evolucion[0]->laboratorio; ?><br></span></p>
  </td>
  <td width=130 colspan=3 valign=top style='width:100pt;border-top:none;
 ...
 <tr style='height:35px;'>
  <td width=47 valign=top style='width:35.45pt;border-top:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;border-left:solid windowtext 1.0pt; padding:0cm 5.4pt 0cm 5.4pt;height:35px;padding-top: 5pt;'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal;text-align: right; '><span style='font-size:7.0pt'>{{$hora_media}}</span></p>
  </td>
  <td width=150 colspan=4 valign=top style='width:120;border-top:none;
  border-left:none;border-right:solid windowtext 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;border-bottom:solid windowtext 1.0pt;height:35px;'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:9px !important;'>PASE A SALA DE RECUPERACION DESPUES DE PROCEDIMIENTO CON SIGNOS VITALES ESTABLES.</span></td>
 ...
 <tr style='height:12.8pt'>
  ...
  border-top:none;padding:0cm 5.4pt 0cm 5.4pt;height:12.8pt; border-right:solid windowtext 1.0pt;'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal;text-align: right;'><span style='font-size:9px !important; '>{{$hora_fin}}</span></p>
  </td>
  <td width=150 colspan=4 valign=top style='width:120pt;border-top:none;
  border-left:none;border-right:solid windowtext 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;border-bottom:solid windowtext 1.0pt;height:50.0pt'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:9px !important;'><?php echo $evolucion[1]->cuadro_clinico ?><br></span>
  <!--span style='font-size:7.0pt'><b>LABORATORIO:<br></b></span-->
  <span style='font-size:7.0pt'><?php echo $evolucion[1]->laboratorio ?><br></span></p>
  </td>
<tr style='height:12.8pt'>
