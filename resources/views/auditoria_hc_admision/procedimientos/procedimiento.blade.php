...
<div class="container-fluid" >
    <div class="row">
        ...
        <!--Revisar aqui que el enlace esta para historia clinica anterior-->

        <div class="col-md-2" style="padding-left: 0px;padding-right: 0px;">
            <a type="button" href="{{route('auditoria_agenda.detalle', ['id' => $id_agenda ])}}" class="btn btn-success btn-sm">
            ...
            <div class="box box-primary collapsed-box" style="margin-bottom: 5px;" >
                <div class="box-header">
                    ...
                    <div class="col-md-6" >
                        <span style="color: orange;">
                            @if($aud_evoluciones_proc->count()=='0')
                                Procedimiento sin Evoluciones
                            @else
                                Tiene {{$aud_evoluciones_proc->count()}} evoluciones para el procedimiento
                            @endif
                        </span>
                    </div>
                ...
                <div class="box-body" style="padding: 5px;">
                    <div class="col-md-12" style="overflow:scroll; height: 500px;">
                        ...
                        @if($aud_evoluciones_proc->count()>0)
                        @foreach($aud_evoluciones_proc as $value)

                        <div class="table-responsive col-md-12 col-xs-12" style="max-height: 500px;font-size: 14px;padding: 0px;border: @if($agenda->proc_consul=='1') @if($value->hc_id_procedimiento == $protocolo->id_hc_procedimientos) orange 1.5px @else black 1px @endif @else black 1px @endif solid; margin: 5px 0;padding-left: 0px;" ondblclick="editar_consulta({{$value->id_evolucion_org}},{{$agenda->id}})">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    @if($value->proc_consul=='0')CONSULTA {{DB::table('especialidad')->find($value->espid)->nombre}} 
                                    @elseif($value->proc_consul=='1')PROCEDIMIENTO: 
                                    @php
                                ...
                                <tr>
                                    ...
                                    $hc_cie10 = DB::table('hc_cie10')->where('hc_id_procedimiento',$value->hc_id_procedimiento)->get(); 
                        ...
                        <table class="table table-bordered  dataTable" >
                            <tbody style="font-size: 12px;">
                                ...
                                @if(($extension == 'jpg') || ($extension == 'jpeg') || ($extension == 'png'))
                                    <a data-toggle="modal" data-target="#foto" href="{{ route('auditoria_hc_video.mostrar_lab_externo', ['id' => $imagen->id]) }}">
                    ...
                    <div class="table-responsive col-md-12">
                        <table class="table table-bordered  dataTable" >
                            <tbody style="font-size: 12px;">
                                ...
                                @endphp
                                @if(($extension == 'jpg') || ($extension == 'jpeg') || ($extension == 'png'))
                                    <a data-toggle="modal" data-target="#foto" href="{{ route('auditoria_hc_video.mostrar_foto', ['id' => $imagen->id]) }}">
                                        <img  src="{{asset('hc_ima')}}/{{$imagen->nombre}}" width="90%" style="max-height: 140px;">
                                    </a>
            ...
            <div class="box box-primary" >
                <div class="box-header">
                    ...
                    <div class="col-md-8" style="padding-left: 0px;">
                        ...
                        <a href="{{route('auditoria_hc_reporte.seleccion', ['id_protocolo' => $protocolo->id, 'agenda' => $agenda->id, 'ruta' => '0'  ])}}">
                ...
                <div class="box-body" style="padding: 5px;">
                    ...
                    <div class="col-md-6" >
                        ...
                        <form id="frm2">
                            ...
                            <input type="hidden" name="protocolo2" value="{{$protocolo->id_protocolo_org}}">
                            <div class="col-md-12" style="padding: 1px;background: #e6ffff;">
                                <b>Fecha Procedimiento: </b>
                                ...
                                @elseif($mes == '11') Noviembre 
                                @elseif($mes == '12') Diciembre 
                                @endif del {{substr($agenda->fechaini,0,4)}} 
                            ...
                            <div class="col-md-6" style="padding: 1px;">
                                ...
                                <span>
                                    ...
                                    @if($protocolo->estado_pentax=='0') EN ESPERA 
                                    @elseif($protocolo->estado_pentax=='1') PREPARACIÓN 
                                    @elseif($protocolo->estado_pentax=='2') EN PROCEDIMIENTO 
                                    @elseif($protocolo->estado_pentax=='3') RECUPERACIÓN 
                                    @elseif($protocolo->estado_pentax=='4') ALTA 
                                    @elseif($protocolo->estado_pentax=='5') SUSPENDIDO 
                                    @endif @else "NO ASISTE" @endif
                                </span>
                            </div>
                            @endif
                            ...
                            <div class="col-md-6" style="padding: 1px;">
                                ...
                                <span>
                                    @if(!is_null($agenda->est_amb_hos))
                                        @if($agenda->est_amb_hos=='0') AMBULATORIO 
                                        @elseif($agenda->est_amb_hos=='1') HOSPITALIZADO 
                                        @endif 
                                    @endif
                                </span>
                            </div>
                            ...
                            <div class="col-md-12" style="padding: 1px;">
                                ...
                                <span class="bg-blue" style="border-radius: 4px;padding: 3px;margin-right: 5px;">

                                {{$value->procedimiento->observacion}}
                            ...
                            <div class="col-md-3" style="padding: 1px;display: none " >
                                ...
                                <select id="id_doctor1" name="id_doctor1" class="form-control input-sm" required onchange="guardar_procedimiento();">
                                    ...
                                    <option 
                                        @if($protocolo->id_doctor1==$value->id)selected 
                                        @endif value={{$value->id}}>Dr. {{$value->nombre1}} {{$value->apellido1}}
                                    </option>
                            ...
                            <div class="col-md-4" style="padding: 1px;">
                                ...
                                <select id="id_anestesiologo" name="id_anestesiologo" class="form-control input-sm" required onchange="guardar_procedimiento();">
                                    ...
                                    <option 
                                     ...
                                     @if($protocolo->id_anestesiologo==$value->id)selected @endif value="{{$value->id}}">Dr. {{$value->nombre1}} {{$value->apellido1}}
                            ...
                            <div class="col-md-4" style="padding: 1px;">
                                ...
                                <select id="id_doctor2" name="id_doctor2" class="form-control input-sm" onchange="guardar_procedimiento();">
                                    ...
                                    @if($protocolo->id_doctor2==$value->id)selected 
                                    @endif value="{{$value->id}}">Enf. {{$value->nombre1}} {{$value->apellido1}}
                            ...
                            <div class="col-md-3" style="padding: 1px;">
                                ...
                                <select id="id_doctor3" name="id_doctor3" class="form-control input-sm" onchange="guardar_procedimiento();">
                                    ...
                                    @if($protocolo->id_doctor3==$value->id)selected 
                                    @endif value="{{$value->id}}">Enf. {{$value->nombre1}} {{$value->apellido1}}
...
<select id="cortesia" name="cortesia" class="form-control input-sm" required onchange="actualiza(event);">
                    ...
                    <div class="col-md-6">
                        ...
                        <form id="hc_protocolo">
                            <input type="hidden" name="id" value="{{$hc_procedimiento->id}}">
                            <input type="hidden" name="id_hc_procedimiento_org" value="{{$hc_procedimiento->id_procedimientos_org}}">
                            <div class="col-md-12" style="padding: 1px;">
                            ...
                            <div class="col-md-6" style="padding: 1px;" id="div_empresa"></div>
                            <br>
                            <div class="col-md-12" style="padding: 1px;">
...
<script type="text/javascript">
    ...
    function cargar_empresa(){
        ...
        $.ajax({
          type: 'get',
          url:"{{ url('auditoria_empresa/auditoria_historiaclinica/cargar') }}/{{$hc_procedimiento->id}}/{{$agenda->id}}/"+$('#id_seguro').val(), 
    ...
    function guardar_procedimiento2(){
        ...
        if(err==''){
            ...
            $.ajax({
              type: 'post',
              url:"{{route('auditoria_procedimiento.paciente')}}",
              headers:{'X-CSRF-TOKEN':$('input[name=_token]').val()},
