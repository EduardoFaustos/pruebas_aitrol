			...
			@if($protocolo->auditoria_procedimiento->procedimiento_completo != "")
				@if($protocolo->auditoria_procedimiento->procedimiento_completo->grupo_procedimiento->imagen != "")
					@if($i < 4)
						...
						<tr style="padding: 0;">
						@endif
						<td style="margin: 0;padding: 0 4px 0px 0px;"><img style="width: 185px; height: 185px;" src="{{base_path().'/storage/app/procedimiento_completo/'.$protocolo->auditoria_procedimiento->procedimiento_completo->grupo_procedimiento->imagen}}" hspace=12></td>
						@if($j >= 3)
						</tr>
						@endif
