			...
			@foreach($imagenes as $value)
				@if($i < 8)
					...
					@endif
						...
						<td style="margin: 0;padding: 0 0px 0px 0px; width: 192px;">
							<div style="position:relative;overflow: hidden; width: 192px; height: 192px;margin: 0; padding: 0;  ">
								<img style="margin: 0;width: 265px; height: 192px;" src="{{base_path().'/storage/app/hc_ima/'.$value->nombre}}" hspace=12>
							</div>
						</td>
						@else
						<td style="margin: 0;padding: 0 0px 0px 0px;width: 192px;">
							<div style="position:relative;overflow: hidden; width: 192px; height: 192px; margin: 0; padding: 0;  ">
								<img style="margin: 0;width: 180px; height: 192px;position: absolute; " src="{{base_path().'/storage/app/hc_ima/'.$value->nombre}}" hspace=12>
							</div>
						</td>
						@endif
					@if($j >= 3)
