...
<body>
	...
	<div id="contenido">
		...
		<br>
		<table style="margin-left: -23px;padding: 0;table-layout:fixed; width:710px; margin-top: -15px;" >
			...
			@if($protocolo->auditoria_procedimiento->procedimiento_completo != "")
				@if($protocolo->auditoria_procedimiento->procedimiento_completo->grupo_procedimiento->imagen != "")
					<tr style="padding: 0; margin:0;">
						<td style="margin: 0;padding: 0 0px 0px 0px;width: 248px;">
							<div style="position:relative;overflow: hidden; width: 248px; height: 235px; margin: 0; padding: 0;  ">
								<img style="width: 248px; height: 235px;" src="{{base_path().'/storage/app/procedimiento_completo/'.$protocolo->auditoria_procedimiento->procedimiento_completo->grupo_procedimiento->imagen}}" hspace=12>
							</div>
						</td>
			...
			@foreach($imagenes as $value)
				@if($i < 6)
					...
					@endif
						...
						<td style="margin: 0;padding: 0 0px 0px 0px; width: 248px;">
							<div style="position:relative;overflow: hidden; width: 248px; height: 235px;margin: 0; padding: 0;  ">
								<img style="margin: 0;width: 355px; height: 235px;" src="{{base_path().'/storage/app/hc_ima/'.$value->nombre}}" hspace=12>
							</div>
						</td>
						@else
						<td style="margin: 0;padding: 0 0px 0px 0px;width: 248px;">
							<div style="position:relative;overflow: hidden; width: 248px; height: 235px; margin: 0; padding: 0;  ">
								<img style="margin: 0;width: 248px; height: 235px;position: absolute; " src="{{base_path().'/storage/app/hc_ima/'.$value->nombre}}" hspace=12>
							</div>
						</td>
						@endif
					@if($j >= 2)
		...
		<div id="hallazgos" style="width: 107%;margin-left: -17px;border: 1px black solid;font-size: 10px !important; line-height: 0.8; text-align: justify;">
		...
		<table width="716px;" class="final">
			...
			<tr>
				<td style="font-size: 9px !important;font-family: 'Source Sans Pro',sans-serif;" ><?php echo $protocolo->conclusion; ?></td>
			</tr>
		</table>
	</div>
	<div id="footer">
