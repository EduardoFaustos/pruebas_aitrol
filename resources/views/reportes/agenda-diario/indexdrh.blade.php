...
<section class="content">
  <div class="box">
    <div class="box-header">
      <div class="row">
      <form method="POST" action="{{route('consultam.reporteagenda')}}">
        ...
        <form method="POST" action="{{route('consultam.excel')}}">
          <input type="hidden" name="_token" value="{{ csrf_token() }}"> 
      ...
      <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
        <thead>
          <tr role="row">
            ...
            <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Birthdate: activate to sort column ascending">Confirmación</th>
            ...
            <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1">Médico P.</th>              
            ...
            <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1">Ubicación</th>
