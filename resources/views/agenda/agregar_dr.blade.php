...
<div class="modal-body"> 
    ...
    <div class="panel-body">
        ...
        <form method="POST" action="#" id="form" >
            ...
            <div class="form-group col-md-6 cl_inicio {{ $errors->has('inicio') ? ' has-error' : '' }} {{ $errors->has('id_doctor1') ? ' has-error' : '' }}" >
                ...
                <div class="col-md-7">
                    <div class="input-group date">
                        ...
                        <input type="text" value="" name="inicio" class="form-control" id="inicio" required onchange="incremento(event)">
                    </div>
                   <span class="help-block">
            ...
            <div id="cambio15a" class="form-group col-md-6 cl_cortesia {{ $errors->has('cortesia') ? ' has-error' : '' }} ">
            ...
            <div id="cambio3" class="form-group col-md-12 cl_procedimiento {{ $errors->has('id_procedimiento') ? ' has-error' : '' }}">
                <label for="id_procedimiento" class="col-md-2 control-label">Procedimientos </label>
                <div class="col-md-10" style="padding-left: 10px;">
                    <select id="id_procedimiento" class="form-control select2" name="procedimiento[]" multiple="multiple" data-placeholder="Seleccione" style="width: 92.1%;" >
