        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border" style="padding: 5px;">
                    ...
                    <div class="form-group col-md-3">
                        <span class="label pull-right bg-yellow">Cortesias del día: {{$cortesias_dia}}</span><br><span class="label pull-right bg-red">Vip del día: {{$vip_dia}}</span>  
                    </div>
                     <!--div class="form-group col-md-3">
                ...
                <div class="box-body">
                    ...
                    <form class="form-vertical" id="target" role="form" method="POST" action="{{ route('agenda.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-7">
                            ...
                            <!--nombre1-->
                        <div class="form-group col-md-6 {{ $errors->has('nombre1') ? ' has-error' : '' }}has-success" id="cambio5" style="padding-left: 0;">
                        ...
                        <!--seguro-->
                        <div id="cambio15b" class="form-group col-md-3  " style="padding-left: 0;">
                        ...
                        <div id="cambio15a" class="form-group col-md-6 {{ $errors->has('cortesia') ? ' has-error' : '' }} has-warning" >
                            <label for="cortesia" class="col-md-4 control-label">Cortesia</label>
                            <div class="col-md-7">
                                <select id="cortesia" name="cortesia" class="form-control input-sm" required onchange="color_cortesia();">
                                    <option style="background-color: white;" @if( old('cortesia') != '') @if( old('cortesia') =='NO') selected @endif @else @if(!is_null($cortesia_paciente)) @if($cortesia_paciente->cortesia=='NO') selected @endif @endif @endif value="NO">NO</option>
                                    <option @if( old('cortesia') != '') @if( old('cortesia') =='SI') selected @endif @else @if(!is_null($cortesia_paciente)) @if($cortesia_paciente->cortesia=='SI' && $tipo_horario == '1') selected @endif @endif @endif value="SI">SI</option>
                                </select> 
                        ...
                        <div id="cambio7" class="form-group col-md-3 {{ $errors->has('espid') ? ' has-error' : '' }}" style="padding-left: 0;" >
                        ...
                        <div class="form-group col-md-3 {{ $errors->has('proc_consul') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6" style="padding-left: 0;">
                                <select id="proc_consul" name="proc_consul" class="form-control input-sm" onchange="campos();" required>
                                    ...
                                    @endif
                                    <option value="0" @if(old('proc_consul')!='')@if(old('proc_consul')=="0"){{"selected"}}@endif @else @if($tipo_horario == '1' || $tipo_horario == '3') selected @endif @endif>Consulta</option>
                                    @if($tipo_horario != '-1' )
                                        @if($tipo_horario != '3')
                                        <option value="1" @if(old('proc_consul')!='') @if(old('proc_consul')=="1"){{"selected"}}@endif @else @if($tipo_horario == '2') selected @endif @endif>Procedimiento</option>
                                        @endif
                                    @endif 
                        ...
                        <div id="iempresa" class="form-group col-md-6 {{ $errors->has('id_empresa') ? ' has-error' : '' }} ">
                            <label for="id_empresa" class="col-md-2 control-label" style="padding-left: 0;">Empresa</label>
                            <div class="col-md-9" style="padding-left: 0;">
                        ...
                        <!--vip -->
                        <div id="ivip" class="form-group col-md-6 {{ $errors->has('vip') ? ' has-error' : '' }} oculto">
                            <label for="vip" class="col-md-5 control-label" style="color: red;padding-left: 0;">VIP</label>
                            <input type="checkbox" id="vip" class="flat-red" name="vip" value="1"  @if(old('vip')=="1") checked @endif>
                            @if ($errors->has('vip'))
                            <span class="help-block">
...
<script>    
    ...
    function color_cortesia(){
            
        var cortesia = document.getElementById('cortesia').value;
        if(cortesia=='SI'){
            document.getElementById('cortesia').style.backgroundColor='#ffe0cc';    
        }else{
            document.getElementById('cortesia').style.backgroundColor='white';     
        }
