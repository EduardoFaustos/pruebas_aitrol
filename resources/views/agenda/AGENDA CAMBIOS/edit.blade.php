            ...
            <div class="box box-primary">
                <div class="box-header with-border" >
                    ...
                    @endphp
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-4" style="padding: 1px;">
                            <a class="btn btn-primary btn-sm"  id="examenes_externos"  href="{{ route('factura.agenda', ['id' => $agenda->id]) }}" > Facturar</a>
                        </div>
                ...
                <div class="box-body">
                    @if($orden_proced == '[]' )
                        @php $orden_proced = array(); @endphp
                    @endif
                    @if($orden_proced != array())
                        <div class="box box-primary">
                            <div class="box-header with-border">
