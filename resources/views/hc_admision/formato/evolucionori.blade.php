...
height=50 @if($procedimiento->id_seguro != 5) src="{{base_path().'/storage/app/logo/logo1391707460001.png'}}" @endif
hspace=12></p>
...
<table class=MsoTableGrid cellspacing=0 cellpadding=0
 ...
 <tr style='height:50pt'>
  ...
  normal'> <br>1.- CSV <br> 2.- PREPARAR PARA PROCEDIMIENTO <br> 3.- SOL SAL 0,9% 1000cc a 30gts x min <br> 4.-SEGUIR INDICACIONES DE MEDICO RESIDENTE
  </p>
  </td>
