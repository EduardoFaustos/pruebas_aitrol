					...
					<tr style="padding: 0; margin:0;">
						<td style="margin: 0;padding: 0 0px 0px 0px;width: 248px;">
							<div style="position:relative;overflow: hidden; width: 248px; height: 235px; margin: 0; padding: 0;  ">
								<img style="width: 248px; height: 235px;" src="{{base_path().'/storage/app/procedimiento_completo/'.$protocolo->procedimiento->procedimiento_completo->grupo_procedimiento->imagen}}" hspace=12>
							</div>
						</td>
