                                ...
                                <div class="col-md-12" style="padding: 1px;">
                                   <h4><b>Datos Generales</b></h4>
                                    ...
                                    <div class="col-md-12 has-error" style="padding: 1px;">
                                        ...
                                        <textarea class="form-control input-sm" id="observaciones" name="observaciones" style="width: 100%;background-color: #ffffb3;" rows="7" onchange="guardar_protocolo();">{{$hc_procedimiento->observaciones}}</textarea>
                                    </div> 
                                </div>
...
<script type="text/javascript">
    ...
    function cargar_empresa2(){
        ...
        $.ajax({
          type: 'get',
          url:"{{ url('empresa2/historiaclinica/cargar') }}/{{$hc_procedimiento->id}}/{{$agenda->id}}/"+$('#id_seguro').val(), 
