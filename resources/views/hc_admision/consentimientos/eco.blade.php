...
<head>
    <meta charset="utf-8" />
    <title>CRM - CONSENTIMIENTO ECO-rev02</title>
    <style>
        * {
            font-size: 12px;
            padding: -1px;
...
<body>
    <div id="container">
        <table class="table" style="width: 100%;">
            <tr>
                <td class="td" style="font-weight: bold;">1. CONSENTIMIENTO INFORMADO PARA : ECOENDOSCOPIA (ULTRASONIDO ENDOSCOPICO)</td>
            </tr>
        </table>
        <table class="table" style="width: 100%;">
            <tr>
        ...
        <table class="table" style="width: 100%;text-align:center ">
            ...
            <tbody>
                <tr>
                    <td class="td">Es una técnica mixta que utiliza la imagen endoscópica (introducción de un cable con luz y cámara) y ecográfica. La prueba permite el examen ecográfico, toma de biopsias y algunos tratamientos de lesiones en la pared del esófago, estómago y primera parte del intestino delgado (duodeno) así como de algunos órganos vecinos, como páncreas, vías biliares o ganglios linfáticos, directamente desde el interior del tubo digestivo.</td>
                    <td><img style="margin:6px;margin-top:10px;height: 60px;width:60px;" src="{{public_path('/imagenes/cprm.png')}}" />
                        <img style="margin:6px;margin-top:10px;height: 60px;width:60px;" src="{{public_path('/imagenes/imagen1.png')}}" /></td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">El día del procedimiento ingresará a un área de preparación donde se le colocará una vía intravenosa, el anestesiólogo procederá a la administración de medicamentos anestésicos, debiendo estar el paciente en posición decúbito supino (boca arriba) y se colocará un tubo endotraqueal que se conecta a su vía aérea. Una vez anestesiado, se le pondrá un protector bucal y el médico iniciará el procedimiento introduciendo a través de la boca un tubo flexible con un sistema de iluminación y una cámara (endoscopio) que además lleva en su punta el sistema de ecografía, haciéndolo progresar a través de esófago y el estómago hasta el duodeno (primera parte del intestino delgado), en busca de alguna alteración. Posteriormente se procede a emitir ondas de ultrasonido que determinarán la integridad de las estructuras vecinas.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">Entre 45 y 60 minutos (excepcionalmente el tiempo puede ser mayor)..</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">La Ecoendoscopía intervencionista permite realizar intervenciones endoscópicas sobre distintas lesiones como la biopsia (extracción y estudio) de ganglios linfáticos u otras lesiones situados alrededor del tubo digestivo, la punción de quistes o acúmulos de líquido que estén en contacto con la pared digestiva o la descompresión de la vía biliar obstruida. En algunos de estos casos puede ser necesario emplear contrastes yodados o Rayos X.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">Pueden producirse reacciones adversas a la medicación administrada (Rash, edema, Prurito, angioedema, espasmos de glotis, etc) que suelen ser leves sin repercusión alguna. Otras complicaciones menores son roturas dentales, mordedura de lengua, luxaciones mandibulares o afonía.</td>
            </tr>
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
                    16. RIESGOS INFRECUENTES
                </td>
                <td style="width: 70%;" class="td">En los casos de Ecoendoscopía con punción los más graves son la hemorragia y la perforación de algún punto del tubo digestivo u órgano de vecindad o la infección de alguna cavidad. Otras complicaciones raras son infeccion, sangrado y pancreatitis.</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
                ...
                <tr>
                    ...
                    <td style="width: 70%;" class="td">   Entre las alternativas se encuentran estudios radiológicos como Resonancia Magnética Nuclear, tomografía computarizada abdominal, biopsias através de la piel y cirugías convencionales.</td>
                </tr>
                <tr>
                    <td style="width: 30%;font-weight: bold;" class="td">
                        19. MANEJO POSTERIOR AL PROCEDIMIENTO
                    </td>
                    <td style="width: 70%;" class="td">  Una vez finalizado el procedimiento medico ambulatorio, permanecerá durante aproximadamente 2-3 horas en observación para monitorear la evolución del paciente después del procedimiento medico ambulatorio. Y recuperar su nivel de conciencia producto de la sedación.
                        Puede presentar también molestias orofaríngeas (dolor de garganta) que pueden perdurar hasta 3 o 4 días. En caso de requerir algún cuidado adicional nuestro personal médico se lo comunicará en el momento que ya pueda salir de nuestras instalaciones.
                        En caso de presentar los siguientes signos de alarma deberá comunicarse en forma inmediata con nosotros: dolor abdominal intenso con náuseas y vómitos, fiebre mayor o igual a 38ºC o deposiciones negruzcas o sanguinolentas.</td>
                </tr>
                <tr>
                    <td style="width: 30%;font-weight: bold;" class="td">
                        20. CONSECUENCIAS POSIBLES SI NO SE REALIZA LA EXPLORACIÓN
                    </td>
                    <td style="width: 70%;" class="td"> No detección de tumores menores a un centímetro que por otros medios no podrán ser realizados.</td>
                </tr>
