...
<head>
    <meta charset="utf-8" />
    <title>POEM-Consentimiento informado</title>
    <style>
        * {
            font-size: 13px;
...
<body>
    <div id="content">
        <table>
            <tr>
                <td style="font-weight: bold;">1. CONSENTIMIENTO INFORMADO PARA MIOTOMIA ENDOSCOPICA PERORAL (POEM) </td>
            </tr>
            <tr>
        ...
        <p style="text-align: justify;">Este documento sirve para que usted, o quien lo represente, dé su consentimiento para esta exploración. Eso significa que nos autoriza a realizarla. Puede retirar este consentimiento cuando lo desee. Firmarlo no le obliga a hacerse la exploración. De su rechazo no se derivará ninguna consecuencia adversa respecto a la calidad del resto de la atención recibida. Lea la información siguiente.
        </p>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td style="font-weight: bold;">10. Nombre del Procedimiento recomendado: {{substr($nombre->nombre, 0, 20)}}</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">11. ¿EN QUÉ CONSISTE?</td>
            </tr>
            <tr>
                <td style="width:100%; text-align:justify; ">El procedimiento al que va a someterse consiste en la realización de un túnel submucoso en el esófago, a través del cual se accede hasta el cardias para proceder a partir de éste a cortar las fibras musculares (circulares y longitudinales) para que la presión del esfínter esofágico inferior disminuya, de tal manera los alimentos pasarán con mayor facilidad del esófago al estómago.</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">12. ¿CÓMO SE REALIZA?</td>
            </tr>
            <tr>
                <td style="text-align:justify;">La técnica a realizar consiste en la introducción del endoscopio por vía oral, abriendo un pequeño paso en la cubierta del esófago (mucosa) y procediendo a realizar un túnel submucoso hasta sobrepasar 5 cms. el cardias (esfínter esofágico inferior), una vez alcanzado éste nivel se procede a realizar un corte de las fibras musculares circulares y longitudinales (miotomía), finalmente se procede a cerrar la apertura mucosa a nivel del esófago habitualmente con clips endoscópicos. Este procedimiento medico se realiza bajo anestesia general.
            ...
            <tr>
                <td style="font-weight: bold;text-transform:uppercase;">13. Gráfico del procedimiento medico</td>
            </tr>
            <tr>
                <td><img class="centrado" src="{{public_path('/imagenes/crm.jpg')}}"></td>
            </tr>
            <tr>
                <td style="font-weight: bold;">14. Duración estimada del procedimiento medico</td>
            </tr>
            <tr>
                <td style="text-align:justify;">El tiempo aproximado de duración de este procedimiento es de 60 minutos, existiendo casos excepcionales en los que la duración sea mayor.</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">15. BENEFECIOS DEL PROCEDIMIENTO:</td>
            </tr>
            <tr>
                <td style="text-align:justify;">El principal beneficio del procedimiento radica en que al disminuir la presión del esfínter esofágico inferior los alimentos pasan del esófago al estómago con mayor facilidad, mejorando así la calidad de vida de los pacientes y su estado nutricional.
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="text-align:justify;">Cualquier actuación médica tiene riesgos. La mayor parte de las veces estos no se materializan, y en el procedimiento no se producen daños o efectos secundarios indeseables. Pero hay ocasiones en que no es así, por eso es importante que usted conozca los riesgos que pueden aparecer en este proceso o intervención.

                    Los pacientes a los que se le realiza este procedimiento pueden experimentar reflujo gastroesofágico, la mayoría de las veces es asintomático, pero hay ocasiones en las que puede ser necesario un tratamiento médico. Ocasionalmente puede haber recurrencia de los síntomas en relación a su acalasia, en cuyo caso puede ser necesario realizar nuevamente la miotomía endoscópica.
            ...
            <tr>
                <td style="text-align:justify;">A pesar de la adecuada elección de la técnica y de su correcta realización, pueden presentarse complicaciones indeseables como la perforación del mediastino con infección (mediastinitis), perforación de la mucosa y/o hemorragia. La mayoría de las complicaciones suelen resolverse vía endoscópica, sin embargo, pueden haber situaciones en las que sea necesario realizarse una intervención quirúrgica.
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="text-align:justify;">Existen alternativas al procedimiento, como por ejemplo por la vía quirúrgica la cual es mucho más invasiva y con mayores riesgos. También el tratamiento endoscópico a base de dilatación e inyección de sustancias a nivel del esfínter esofágico inferior, cuyos resultados no son muy alentadores a corto plazo, requiriendo múltiples sesiones.
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="text-align:justify;">Una vez concluido el procedimiento, el paciente será transferido a un área de observación (internación corta) donde permanecerá durante 24 horas. En este tiempo el paciente permanecerá en observación y revisión de su estado clínico, administración de medicamentos necesarios post-procedimiento y finalmente se realiza un estudio radiológico contrastado (tránsito esófago-gástrico con contraste hidrosoluble) para identificar precozmente cualquier complicación derivada del procedimiento endoscópico.
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>En caso de no realizarse el procedimiento, no mejorará su forma de alimentarse, persistiendo la dificultad para ingerir los alimentos.
