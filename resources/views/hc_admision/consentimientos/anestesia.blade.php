...
<head>
    <meta charset="utf-8" />
    <title>AUTORIZACIÓN PARA PROCEDIMIENTO ANESTÉSICO</title>
    <style>
        * {
            font-size: 12px;
...
<body>
    <div id="container">
        <table class="table" style="width: 100%;">
            <tr>
                <td class="td" style="font-weight: bold;">1. {{trans('consentimientos.AUTORIZACIÓNPARAPROCEDIMIENTOANESTÉSICO')}}</td>
            </tr>
        </table>
        <table class="table" style="width: 100%;">
            <tr>
                <td class="td" style="font-weight: bold;">2. {{trans('consentimientos.PROFESIONALQUEREALIZAELPROCEDIMIENTO')}}:</td>
            </tr>
        </table>
        <table class="table" style="width: 100%;">
            <tr>
                <td class="td" style="font-weight: bold;">3.{{trans('consentimientos.Fecha')}} : </td>
                <td class="td" style="font-weight: bold;">4.{{trans('consentimientos.Hora')}}Hora : </td>
            </tr>
        </table>
        <table style="background : #C2BCBA ;width:100%;text-align:center;border: 1px solid black">
            <tr>
                <td style="font-weight: bold;">5.{{trans('consentimientos.INFORMACIONDELPACIENTE')}}</td>
            </tr>
        </table>
        <table class="table" style="width: 100%;text-align:center ">
            <tr>
                <td style="width: 100%;font-weight: bold;" class="td" rowspan="2">{{trans('consentimientos.DOCUMENTODEINDENTIFICACION')}}</td>
                <td style="width: 100%;font-weight: bold;" class="td">{{trans('consentimientos.CEDULA')}}</td>
                <td style="width: 100%;" class="td">{{$paciente->id}}</td>

            </tr>
            <tr>
                <td style="width: 100%;font-weight: bold;" class="td">{{trans('consentimientos.PASAPORTE')}}</td>
        ...
        <table class="table" style="width: 100%;">
            <thead>
                <tr>
                    <th class="th">{{trans('consentimientos.ApellidoPaterno')}}</th>
                    <th class="th">{{trans('consentimientos.ApellidoMaterno')}}</th>
                    <th class="th">{{trans('consentimientos.Nombres')}}Nombres</th>
                    <th class="th">{{trans('consentimientos.FechadeNacimiento')}}</th>
                    <th class="th">{{trans('consentimientos.Edad')}}</th>
                </tr>
            </thead>
            <tbody>
                <tr>
        ...
        <table class="table" style="width: 100%;">
            <tr>
                <td style="background : #C2BCBA;font-weight:bold" class="td">6. {{trans('consentimientos.INFORMACIÓNALPACIENTE')}}: </td>
            </tr>
            <tr>
                <td class="td">
                    Es deber del centro de salud informar las consecuencias de su decisión, así como el artículo 7 del Código de Ética Médica que prescribe que los procedimientos de anestesia general se realizarán en centros hospitalarios o clínicas con personal calificado y con medios suficientes para dicho procedimiento.
                </td>
            </tr>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
                    8.{{trans('consentimientos.TIPODEATENCIÓN')}}
                </td>
                <td style="width: 30%;font-weight: bold;" class="td">
                {{trans('consentimientos.AMBULATORIA')}} 
                </td>
                <td style="width: 70%;" class="td"></td>
                <td style="width: 30%;font-weight: bold;" class="td">
                {{trans('consentimientos.HOSPITALIZACIÓN')}} 
                </td>
                <td style="width: 70%;" class="td"></td>
        ...
        <table class="table" style="width: 100%;text-align:center ">
            ...
            <tbody>
                <tr>
                    <td class="td">La anestesia es un medicamento que bloquea la conciencia del dolor. Se utiliza durante determinados procedimientos médicos. El tipo de anestesia dependerá del procedimiento y de su estado general de salud. La anestesia puede ser de tipo sedación o general. </td>
                    <td><img style="height:100px;margin:15px" src="{{public_path('/imagenes/anestesia.jpg')}}" /></td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            <thead>
                <tr>
                    <th>
                        11. EXPLICACIÓN DEL PROCEDIMIENTO ANESTÉSICO
                    </th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">La Anestesia General proporciona al paciente un estado reversible de pérdida de conciencia, analgésica y relajación muscular, Los fármacos anestésicos deprimen la respiración y a menudo es necesario introducir un tubo por la boca en la tráquea y conectarlo a un ventilador que mantiene la respiración del paciente durante el procedimiento El anestesiólogo se encarga de tomar las medidas necesarias para disminuir al máximo la aparición de estas molestias.
                        La Sedación farmacológica.
                        El objetivo es mantener al paciente tranquilo, cómodo, comunicativo si es necesario. Se administran medicamentos por vía endovenosa calculados, individualizando cada caso y procedimiento
                    </td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">Dependerá de la duración de la exploración endoscópica.</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">Lesiones de cuerdas vocales, dentadura o lengua, Crisis Hipotensivas o hipertensivas leves, reacciones anafilácticas (alergias)</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
                    14. RIESGOS INFRECUENTES
                    (GRAVES)
                </td>
                <td style="width: 70%;" class="td">Reacciones alérgicas graves, compromiso neurológico grave como el estado de coma o las convulsiones, paro cardiorespiratorio, muerte.</td>
            </tr>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            <tbody>
                <tr>
                    <td style="width: 30%;font-weight: bold;" class="td">
                        15. ALTERNATIVAS DE LA EXPLORACIÓN
                    </td>
                    <td style="width: 70%;" class="td">Ninguna.</td>
                </tr>
                <tr>
                    <td style="width: 30%;font-weight: bold;" class="td">
                        16. MANEJO POSTERIOR AL PROCEDIMIENTO
                    </td>
                    <td style="width: 70%;" class="td"> Deberá pasar al Área de Recuperación en donde el paciente será monitorizado y se levantará progresivamente.</td>
                </tr>
                <tr>
                    <td style="width: 30%;font-weight: bold;" class="td">
                        17. CONSECUENCIAS POSIBLES SI NO SE REALIZA LA EXPLORACIÓN
                    </td>
                    <td style="width: 70%;" class="td"> No se podrá realizar la exploración solicitada por su médico.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            <thead>
                <tr>
                    <th class="th">
                        18. DE EXISTIR, ESCRIBA LOS RIESGOS ESPECIFICOS RELACIONADOS CON EL PACIENTE (edad y estado de salud)
                    </th>
                </tr>
            </thead>
        </table>
        ...
        <table class="table" style="width: 100%;text-align:center; ">
            <tr>
                <td class="td" style="font-weight: bold;background : #C2BCBA">19. DECLARACIÓN DEL CONSENTIMIENTO INFORMADO</td>
                <td class="td" style="font-weight: bold;">FECHA:</td>
                <td class="td" style="font-weight: bold;">HORA</td>
        ...
        <table class="table" style="width: 100%;text-align:center; ">
            <tr>
                <td class="td" style="font-weight: bold;background : #C2BCBA">20. NEGATIVA DEL CONSENTIMIENTO INFORMADO</td>
                <td class="td" style="font-weight: bold;">FECHA:</td>
                <td class="td" style="font-weight: bold;">HORA</td>
            </tr>
        </table>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                <td class="td">SI EL PACIENTE NO ESTÁ EN CAPACIDAD DE FIRMAR EL CONSENTIMIENTO INFORMADO (a ser llenado también en caso de ser el paciente menor de edad o presente una incapacidad): </td>
        ...
        <table class="table" style="width: 100%;text-align:center; ">
            <tr>
                <th style="background : #C2BCBA" class="th">21. REVOCATORIA DEL CONSENTIMIENTO INFORMADO</th>
                <td class="td" style="font-weight: bold;">FECHA:</td>
                <td class="td" style="font-weight: bold;">HORA</td>
            </tr>
        </table>
