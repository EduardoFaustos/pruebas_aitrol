...
<head>
    <meta charset="utf-8" />
    <title>CRM - CONSENTIMIENTO POEM-rev02</title>
    <style>
        * {
            font-size: 12px;
            padding: -1px;
...
<body>
    <div id="container">
        <table class="table" style="width: 100%;">
            <tr>
                <td class="td" style="font-weight: bold;">1. CONSENTIMIENTO INFORMADO PARA MIOTOMIA ENDOSCOPICA PERORAL (POEM)</td>
            </tr>
        </table>
        <table class="table" style="width: 100%;">
            <tr>
        ...
        <table class="table" style="width: 100%;text-align:center ">
            ...
            <tbody>
                <tr>
                    <td class="td">El procedimiento al que va a someterse consiste en la realización de un túnel submucoso en el esófago, hasta el cardias cortar las fibras musculares (circulares y longitudinales) para que la presión del esfínter esofágico inferior disminuya, de tal manera los alimentos pasarán con mayor facilidad del esófago al estómago. </td>
                    <td><img style="margin:6px;margin-top:10px;height: 80px;width:80px;" src="{{public_path('/imagenes/crm.jpg')}}" />
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">La técnica a realizar consiste en la introducción del endoscopio por vía oral, abriendo un pequeño paso en la cubierta del esófago (mucosa) y procediendo a realizar un túnel submucoso hasta sobrepasar 5 cms.
                        El cardias (esfínter esofágico inferior), una vez alcanzado este nivel se procede a realizar un corte de las fibras musculares circulares y longitudinales (miotomía), finalmente se procede a cerrar la apertura mucosa a nivel del esófago habitualmente con clips endoscópicos. Este procedimiento medico se realiza bajo anestesia general.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">Entre 60 y 90 minutos aproximadamente (excepcionalmente el tiempo puede ser mayor).</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">Disminuir la presión del esfínter esofágico inferior para que los alimentos pasen del esófago al estómago con mayor facilidad.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">Posterior al procedimiento pueden experimentar reflujo gastroesofágico, puede haber recurrencia de los síntomas en relación a su acalasia, en cuyo caso puede ser necesario realizar nuevamente la miotomía endoscópica.</td>
            </tr>
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
                    16. RIESGOS INFRECUENTES
                </td>
                <td style="width: 70%;" class="td">Pueden presentarse complicaciones indeseables como la perforación del mediastino con infección (mediastinitis), perforación de la mucosa y/o hemorragia. La mayoría de las complicaciones suelen resolverse vía endoscópica.</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
                ...
                <tr>
                    ...
                    <td style="width: 70%;" class="td">  No mejorará su forma de alimentarse, persistiendo la dificultad para ingerir los alimentos.</td>
                </tr>
