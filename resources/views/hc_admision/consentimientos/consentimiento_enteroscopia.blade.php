...
<head>
    <meta charset="utf-8" />
    <title>ENTEROSCOPIA Anterograda o Alta-Consentimiento informado</title>
    <style>
        * {
            font-size: 13px;
...
<body>
    <div id="container">
        <table>
            <tr>
                <td style="font-weight: bold;">1. CONSENTIMIENTO INFORMADO PARA ENTEROSCOPIA ANTEROGRADA O ALTA </td>
            </tr>
            <tr>
        ...
        <table style="width:100%; ">
            ...
            <tr>
                <td style="font-weight: bold;">10. Nombre del procedimiento recomendado: {{substr($nombre->nombre, 0, 25)}} </td>
            </tr>
            <tr>
                <td style="font-weight: bold;">11. ¿EN QUÉ CONSISTE?</td>
            </tr>
            <tr>
                <td style="width:100%; text-align:justify; ">La exploración a la que va a someterse sirve para el diagnóstico y tratamiento de enfermedades del intestino delgado (duodeno, yeyuno e ileon). Para el procedimiento médico ambulatorio se usa un tubo largo y flexible con un sistema de iluminación y una cámara (enteroscopio). Se pueden utilizar sistemas de ayuda, como balones que se inflan y desinflan alternativamente, que permiten avanzar el enteroscopio por las curvas del intestino delgado. Se introduce por la boca (anterógrada o alta) y se avanza progresivamente a través del intestino delgado hasta encontrar la zona de estudio. Es posible que, a pesar de todo, no se consiga una exploración completa de todo el intestino delgado, requiriendo utilizar la vía retrógrada o baja (a través del ano) en determinadas ocasiones.</td>
            </tr>
            <tr>
                <td style="font-weight: bold;">12. ¿CÓMO SE REALIZA?</td>
            </tr>
            <tr>
                <td style="text-align:justify;">La exploración endoscópica se realiza en una posición cómoda sobre el lado izquierdo o boca arriba (decúbito supino). Comúnmente es un procedimiento extenso, por lo que se deberá hacer con anestesia general.

                    En algunos casos, una vez finalizada la exploración endoscópica, habrá un periodo de observación para detectar la posible aparición de complicaciones.


                </td>
            </tr>
            <tr>
                <td style="font-weight: bold;">13. Gráfico de la exploración endoscópica </td>
            </tr>
            <tr>
                <td><img style="width: 150px;height:150px;margin:15px" src="{{public_path('/imagenes/enteroscopia1.jpg')}}">
                    <img style="width: 150px;height:150px;margin:15px" src="{{public_path('/imagenes/enteroscopia2.jpg')}}"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="text-align:justify;">Cualquier actuación médica tiene riesgos. La mayor parte de las veces éstos no se materializan, y la exploración no produce daños o efectos secundarios indeseables, pero hay ocasiones que no es así. Por eso es importante que usted conozca los riesgos que pueden aparecer en este proceso.

                    En las exploraciones más prolongadas puede quedar sensación de hinchazón por el aire introducido durante la misma.

                    Las complicaciones son poco frecuentes, pero pueden producirse reacciones no deseadas producto de la anestesia general que podrían obligar a dar por finalizada la técnica. Otras complicaciones menores son sensación de hinchazón, roturas dentales, mordedura de lengua, luxaciones mandibulares o afonía.
            ...
            <tr>
                <td style="text-align:justify;">Puede producirse hemorragia al tratar grandes lesiones o por alguna que ya estuviese sangrando. Podría ocurrir también una perforación de alguna zona del intestino o aún menos frecuente, una pancreatitis aguda. Como consecuencia de alguna de estas complicaciones, excepcionalmente podría ser necesario un tratamiento urgente o una operación.
            ...
            <tr>
                <td style="text-align:justify;">Cuando se prescribe una enteroscopia ya se han agotado los métodos diagnósticos de imagen o existe una lesión en el intestino delgado que se debe estudiar o tratar. Por ello, la única alternativa suele ser una enteroscopia intraoperatoria en la que se explora el intestino durante una intervención quirúrgica que supone más riesgos y complicaciones.
            ...
            <tr>
                <td style="text-align:justify;">Luego del procedimiento, el paciente es trasladado al Área de Recuperación en donde después de recuperar su nivel de conciencia, producto de la sedación y comprobada su recuperación, puede ser dado de alta.

                    Se recomienda siempre acudir acompañado para la realización del estudio antes mencionado. De la misma manera se recomienda permanecer en compañía durante las siguientes doce horas, no pudiendo reincorporarse a las actividades habituales o conducir hasta pasado este periodo.
