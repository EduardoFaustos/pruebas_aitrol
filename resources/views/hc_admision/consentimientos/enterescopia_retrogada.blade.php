...
<head>
    <meta charset="utf-8" />
    <title>CRM - CONSENTIMIENTO ENTEROSCOPIA RETROGRADA</title>
    <style>
        * {
            font-size: 12px;
            padding: -1px;
...
<body>
    <div id="container">
        <table class="table" style="width: 100%;">
            <tr>
                <td class="td" style="font-weight: bold;">1. CONSENTIMIENTO INFORMADO PARA : ENTEROSCOPIA RETROGRADA O BAJA</td>
            </tr>
        </table>
        <table class="table" style="width: 100%;">
            <tr>
        ...
        <table class="table" style="width: 100%;text-align:center ">
            ...
            <tbody>
                <tr>
                    <td class="td">Consiste en el diagnóstico y tratamiento de enfermedades del intestino delgado habitualmente en ileon o yeyuno distal, Se introduce por el ano (retrógrada) y se avanza progresivamente a través del colon hasta el intestino delgado y encontrar la zona de estudio. Es posible que, a pesar de todo, no se consiga una exploración completa de todo el intestino delgado, requiriendo utilizar la vía anterógrada (a través de la boca) en determinadas ocasiones. </td>
                    <td><img style="margin:6px;margin-top:10px;height: 60px;width:100px;" src="{{public_path('/imagenes/retrogada.png')}}" />
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">La exploración se realiza en una posición cómoda sobre el lado izquierdo o boca arriba (decúbito supino), se deberá hacer con anestesia general.
                        Se introduce por el ano (retrógrada) y se avanza progresivamente a través del colon hasta el intestino delgado y encontrar la zona de estudio. Es posible que, a pesar de todo, no se consiga una exploración completa de todo el intestino delgado, requiriendo utilizar la vía anterógrada (a través de la boca) en determinadas ocasiones.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">Aproximadamente entre 45 y 60 minutos (excepcionalmente el tiempo puede ser mayor)</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">La enteroscopia permite el diagnóstico de lesiones del intestino delgado que puedan ser las causantes de una hemorragia digestiva de origen desconocido, es decir, aquella de la que no se conoce su causa a pesar de haberla estudiado con endoscopias convencionales, permite también el estudio de ciertas enfermedades inflamatorias.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">Las complicaciones son poco frecuentes, pueden producirse reacciones no deseadas por la anestesia general que podrían obligar a dar por finalizada la técnica.</td>
            </tr>
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
                    16. RIESGOS INFRECUENTES
                </td>
                <td style="width: 70%;" class="td">Puede producirse hemorragia al tratar grandes lesiones o por alguna que ya estuviese sangrando, podría ocurrir también una perforación del colon o del intestino delgado. Como consecuencia de alguna de estas complicaciones, excepcionalmente puede ser necesario un tratamiento urgente o una cirugía</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
                ...
                <tr>
                    ...
                    <td style="width: 70%;" class="td"> La única alternativa suele ser una enteroscopia intraoperatoria en la cual se explora el intestino durante una intervención quirúrgica que supone más riesgos y complicaciones.</td>
                </tr>
                <tr>
                    <td style="width: 30%;font-weight: bold;" class="td">
                        19. MANEJO POSTERIOR AL PROCEDIMIENTO
                    </td>
                    <td style="width: 70%;" class="td">    Luego del procedimiento, el paciente es trasladado a la sala de recuperación en donde después de recuperar su nivel de conciencia producto de la sedación y comprobada su recuperación, puede ser dado de alta con un acompañante.</td>
                </tr>
                <tr>
                    <td style="width: 30%;font-weight: bold;" class="td">
