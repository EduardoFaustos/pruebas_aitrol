...
<body>
    <div id="container">
        ...
        <table class="table" style="width: 100%;text-align:center ">
            ...
            <tbody>
                <tr>
                    <td class="td">Para el diagnóstico y tratamiento de enfermedades del intestino delgado (duodeno, yeyuno e ileon), Para el procedimiento médico ambulatorio se usa un tubo largo y flexible con un sistema de iluminación y una cámara (enteroscopio). </td>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">La exploración endoscópica se realiza con anestesia general, en una posición cómoda sobre el lado izquierdo o boca arriba (decúbito supino, Se introduce por la boca (anterógrada o alta) y se avanza progresivamente a través del intestino delgado hasta encontrar la zona de estudio.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">La Enteroscopia Anterograda o Alta permite el diagnóstico de lesiones del intestino delgado que pueden ser las causantes de una hemorragia digestiva de origen desconocido, también permite el estudio de ciertos casos de enfermedades inflamatorias (enfermedad de Crohn), de pólipos y poliposis familiares (como el síndrome de Peutz-Jeghers) o de los hallazgos vistos en otras pruebas de imagen.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">En las exploraciones más prolongadas puede quedar sensación de hinchazón por el aire introducido durante la misma.</td>
            </tr>
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
                    16. RIESGOS INFRECUENTES
                </td>
                <td style="width: 70%;" class="td">Puede producirse hemorragia al tratar grandes lesiones o por alguna que ya estuviese sangrando. Podría ocurrir también una perforación de alguna zona del intestino o aún menos frecuente</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td"> Cuando se prescribe una enteroscopia ya se han agotado los métodos diagnósticos de imagen o existe una lesión en el intestino delgado que se debe estudiar o tratar.</td>
            </tr>
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
                    19. MANEJO POSTERIOR AL PROCEDIMIENTO
                </td>
                <td style="width: 70%;" class="td"> Luego del procedimiento, el paciente es trasladado al Área de Recuperación en donde después de recuperar su nivel de conciencia, producto de la sedación y comprobada su recuperación, puede ser dado de alta.</td>
            </tr>
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
                    20. CONSECUENCIAS POSIBLES SI NO SE REALIZA LA EXPLORACIÓN
                </td>
                <td style="width: 70%;" class="td"> Mal diagnóstico, diagnóstico errado o diagnóstico tardío de enfermedades del tracto digestivo alto.</td>
            </tr>
