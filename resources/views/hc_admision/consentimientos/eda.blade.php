...
<body>
    <div id="container">
        ...
        <table class="table" style="width: 100%;text-align:center ">
            ...
            <tbody>
                <tr>
                    <td class="td">Consiste en el examen del esófago, estómago y primera parte del intestino delgado (duodeno) mediante un tubo flexible con un sistema de iluminación y una cámara (endoscopio), que se introduce a través de la boca que permite observar el interior del tubo digestivo </td>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">La exploración se realiza en posición dorsal (acostado), sobre el lado izquierdo. Durante ese tiempo la respiración es normal. Para proteger los dientes y el endoscopio, se introduce un protector bucal. Se le administrará un sedante intravenoso, aunque en ocasiones puede requerirse antestesia general.
                        El endoscopio se introduce a través del esófago hasta el estómago y el duodeno. Luego, se introduce aire a través del dispositivo para facilitarle la visualización al médico. Se examina el revestimiento del esófago, del estómago, y de la parte superior del duodeno. Se puede tomar biopsias con el dispositivo. Estas son muestras de tejido que se observan bajo el microscopio. Se pueden llevar a cabo diferentes tratamientos, como administrar localmente medicamentes para parar un sangrado, dilatar alguna obstrucción del esófago u otras patologías.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">Cuando sea necesario conocer la existencia de alguna enfermedad en su esófago, estómago o duodeno, extraer objetos deglutidos y que han quedado atascados, extirpar pólipos, esclerosar o ligar varices esofágicas, aplicar calor a lesiones que pueden ser causa de hemorragia o anemia o destruir con gas argón o láser ciertas lesiones.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">Reacciones no deseadas a la medicación administrada, roturas dentales, mordedura de lengua, luxaciones mandibulares o afonía.</td>
            </tr>
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
                    16. RIESGOS INFRECUENTES
                </td>
                <td style="width: 70%;" class="td">Perforación, la hemorragia, reacciones alérgicas medicamentosas, alteraciones cardiopulmonares y transmisión de infecciones.
                    Otras complicaciones graves eventuales derivadas del riesgo quirúrgico particular de cada paciente.</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td"> Procedimientos como: Exploración radiológica, La cápsula endoscópica o una intervención quirúrgica.</td>
            </tr>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            <tr>
