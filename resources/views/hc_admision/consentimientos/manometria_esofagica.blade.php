...
<body>
    <div id="container">
        ...
        <table class="table" style="width: 100%;text-align:center ">
            ...
            <tbody>
                <tr>
                    <td class="td">La técnica a la que usted va a someterse consiste en la medición de las presiones que producen los movimientos del esófago y del esfínter entre el esófago y estómago. Sirve para conocer la fuerza y coordinación de los músculos que participan en estos movimientos</td>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">Se realiza mediante una sonda (tubo fino y flexible) que se introduce a través de la nariz. La introducción de la sonda se realiza en posición de sentado y la exploración se realiza en una posición cómoda sobre el lado izquierdo. Durante la realización del procedimiento medico puede respirar sin problema por la nariz o por la boca. En algunos momentos se le indicará que trague una pequeña cantidad de agua. No se le aplicará ninguna medicación ni sedación.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">El conocimiento de la fuerza y coordinación de los músculos del esófago permite diagnosticar o confirmar enfermedades.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
...
(POCO GRAVES)
                ...
                <td style="width: 70%;" class="td">Cualquier actuación médica tiene riesgos. La mayor parte de las veces los riesgos no se materializan, y la intervención no produce daños o efectos secundarios indeseables. Pero a veces no es así. Por eso es importante que usted conozca los riesgos que pueden aparecer en este proceso o intervención. Las complicaciones de la manometría esofágica son excepcionales. Habitualmente son leves y derivadas de la introducción de la sonda. En algunas personas se puede producir un sangrado leve por la nariz, y en otras ocasiones tos al tocar con la sonda la entrada de las vias respiratorias</td>
            </tr>
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
...
(GRAVES)
                ...
                <td style="width: 70%;" class="td">La perforación de la lámina del hueso de la nariz (etmoides) o la aspiración son complicaciones graves pero excepcionales. Se deben considerar también los problemas de salud que presente cada paciente para las exploraciones que se vayan a realizar.</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td"> La radiografía con contraste o la endoscopia digestiva alta pueden dar alguna información sobre la presencia de reflujo gastroesofágico, pero no son un sustituto de la manometría esofágica.</td>
            </tr>
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td"> No diagnosticar adecuadamente patologías derivadas del esófago</td>
            </tr>
