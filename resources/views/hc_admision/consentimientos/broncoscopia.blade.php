...
<body>
    <div id="container">
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">Como primer paso y con el paciente habitualmente acostado, según el tipo de procedimiento, se usa anestesia general e intubación orotraqueal y en ocasiones anestesia local en las zonas de paso (laringe, tráquea y bronquios). Se introduce el broncoscopio y tras visualizar todos los bronquios e identificar las posibles lesiones se procede a la toma de muestras. Las muestras pueden ser obtenidas mediante: aspirado bronquial para la recogida de secreciones bronquiales; lavado broncoalveolar, que permitirá analizar la zona periférica del árbol respiratorio; cepillado bronquial, que consiste en realizar un raspado de la mucosa bronquial; punción transbronquial atravesando las paredes bronquiales en busca de tejidos que quedan ocultos tras los bronquios; biopsia, con pinza, de la superficie bronquial; y/o bien biopsia transbronquial introduciendo la pinza a lo lejos del bronquio, fuera de nuestra visión directa, ayudados o no por radioscopia externa.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">El estudio permite la visualización directa del interior del aparato respiratorio, la toma de biopsias y un diagnostico especifico de las patologías respiratorias, así como un diagnóstico precoz de las enfermedades malignas de la tráquea, bronquios y pulmones.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">Entre las situaciones pueden presentar ronquera, tos, fiebre, dolor local, nauseas o mareos y expectoración de pequeñas cantidades de sangre, que suelen auto limitarse y no representan un riesgo para la vida.</td>
            </tr>
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
                    16. RIESGOS INFRECUENTES
                </td>
                <td style="width: 70%;" class="td">Entre los riesgos pocos frecuentes se pueden presentar hhemorragia, hipotensión, hipertensión y neumotórax (entrada de aire al tórax fuera del pulmón), especialmente cuando se realizan biopsias transbronquiales. La frecuencia de estas complicaciones es baja.</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
                <tr>
                    ...
                    <td style="width: 70%;" class="td"> Entre las alternativas al procedimiento se encuentran: estudios bacteriológicos de esputo, citología de esputo y tomografía con emisión de positrones.</td>
                </tr>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            <tr>
                ...
                <td style="width: 70%;" class="td"> Luego del procedimiento, el paciente es trasladado a la sala de recuperación en donde después de recuperar su nivel de conciencia después de la sedación y comprobada su recuperación, puede ser dado de alta siempre que cuente con una persona que lo acompañe. No podrá conducir ningún tipo de vehículos en las siguientes 24 horas.</td>
            </tr>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            <tr>
                ...
                <td style="width: 70%;" class="td"> Mal diagnóstico, diagnostico errado o diagnóstico tardío de enfermedades del aparato respiratorio bajo.</td>
            </tr>
        </table>
        <table class="table" style="width: 100%;text-align:center; ">
            <tr>
