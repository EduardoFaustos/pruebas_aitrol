...
<head>
    <meta charset="utf-8" />
    <title>CRM - CONSENTIMIENTO ECO ANORECTAL-rev02</title>
    <style>
        * {
            font-size: 12px;
            padding: 0px;
...
<body>
    <div id="container">
        <table class="table" style="width: 100%;">
            <tr>
                <td class="td" style="font-weight: bold;">1. CONSENTIMIENTO INFORMADO PARA : ECOENDOSCOPIA ANO RECTAL TAMBIEN LLAMADO (ULTRASONIDO ENDOSCOPICO ANO RECTAL)</td>
            </tr>
        </table>
        <table class="table" style="width: 100%;">
            <tr>
        ...
        <table class="table" style="width: 100%;text-align:center ">
            ...
            <tbody>
                <tr>
                    <td class="td">El procedimiento al que usted va a someterse es una técnica mixta que utiliza la imagen endoscópica (introducción de un cable con luz y cámara) y ecográfica. La prueba permite el examen ecográfico, toma de biopsias y algunos tratamientos de lesiones en la pared del recto. </td>
                    <td><img style="margin:6px;margin-top:10px;height:60px;width:60px;" src="{{public_path('/imagenes/anorectal.jpg')}}" />
                        <img style="margin:6px;margin-top:10px;height:60px;width:60px;" src="{{public_path('/imagenes/anorectal1.jpg')}}" /></td>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">Debe realizarse una limpieza del colon previamente para que la prueba se lleve a cabo de la mejor manera. El médico iniciará el procedimiento, donde introduce a través del ano un tubo flexible con un sistema de iluminación y una cámara (endoscopio) y haciéndolo progresar hasta el recto-sigma en busca de alguna alteración. Posteriormente se procede a emitir ondas de ultrasonido que determinarán el tipo de lesión a este nivel y la integridad de las estructuras vecinas.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">45-60 minutos aproximadamente (excepcionalmente el tiempo puede ser mayor).</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify;" class="td">La Ecoendoscopía o ultrasonido endoscópico permite conocer las características ecográficas y precisar el diagnóstico de lesiones y extensión de las mismas.</td>
                </tr>
            </tbody>
        </table>
        <table class="table" style="width: 100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width: 70%;" class="td">Pueden producirse reacciones adversas a la medicación administrada (Rash, edema, Prurito, angioedema, espasmos de glotis, etc) que suelen ser leves sin repercusión alguna.
                    Adicionalmente entre los riesgos poco graves, puede haber algo de sangrado tras la realización del procedimiento por el contacto del endoscopio con la lesión a investigar que en ocasiones es muy friable y sangra con facilidad.</td>
            </tr>
            <tr>
                <td style="width: 30%;font-weight: bold;" class="td">
                    16. RIESGOS INFRECUENTES
                </td>
                <td style="width: 70%;" class="td">Puede ocurrir una perforación del colon. Como consecuencia de alguna de estas complicaciones, excepcionalmente puede ser necesario un tratamiento urgente o una cirugía.</td>
            </tr>
        ...
        <table class="table" style="width: 100%;text-align:center;">
                ...
                <tr>
                    ...
                    <td style="width: 70%;" class="td"> Entre las alternativas al procedimiento se encuentra estudios radiológicos como Resonancia Magnética Nuclear, tomografía computarizada.</td>
                </tr>
                <tr>
                    <td style="width: 30%;font-weight: bold;" class="td">
                        19. MANEJO POSTERIOR AL PROCEDIMIENTO
                    </td>
                    <td style="width: 70%;" class="td"> Luego del procedimiento, el paciente es trasladado a la sala de recuperación, donde permanecerá aproximadamente 1 hora, hasta recuperar su nivel de conciencia producto de la sedación, una vez comprobada su recuperación, puede ser dado de alta con su acompañante.
                        Después de éste tiempo, el paciente deberá retornar a su lugar de origen (domicilio, hospital), teniendo en consideración que el aire que se usa para insuflar el colon, durante el procedimiento, puede causar distensión abdominal y eliminación de gases durante aproximadamente 24 horas.</td>
                </tr>
                <tr>
                    <td style="width: 30%;font-weight: bold;" class="td">
                        20. CONSECUENCIAS POSIBLES SI NO SE REALIZA LA EXPLORACIÓN
                    </td>
                    <td style="width: 70%;" class="td"> Mal diagnóstico, diagnóstico errado o tardío de enfermedades del recto. </td>
                </tr>
