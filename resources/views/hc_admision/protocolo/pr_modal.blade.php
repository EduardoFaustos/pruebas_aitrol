...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="myModalLabel" style="text-align: center;">PROTOCOLO OPERATORIO</h4>
</div>

<div class="modal-body">
	<div class="row" style="padding: 10px;">
		<form class="form-vertical" role="form" method="POST" action="{{ route('protocolo.guardar_op') }}">
            {{ csrf_field() }}
            ...
            <div class="box-body col-md-12">
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class=class="col-md-6" >
		              <button type="submit" class="btn btn-warning btn-sm" formaction="{{ route('protocolo_cpre_eco.guardar_op_cpre_eco') }}" formtarget="_blank"> Protocolo Operatorio CPRE+ECO</button>
		            </div>
                </div>
