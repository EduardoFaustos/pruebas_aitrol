...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="myModalLabel" style="text-align: center;">FORMATO DE EVOLUCION</h4>
</div>

<div class="modal-body">
	<div class="row" style="padding: 10px;">
		<form class="form-vertical" role="form" method="POST" action="{{ route('evolucion.guardar_op') }}">
                {{ csrf_field() }}
                ...
                <div class="box-body col-md-12">
	                ...
	                <div class="form-group col-md-12">
	                    <div class="col-md-6 col-md-offset-4">
	                    	@if($protocolo->id != 37109 && $protocolo->id != 49387)
	                        <button type="submit" class="btn btn-primary" formtarget="_blank">
	                            Descargar Formato Evolucion
	                        </button>
	                        @elseif($protocolo->id != 37109)
	                        <a href="{{asset('evolucion-49387.pdf')}}" class="btn btn-primary" target="_blank">
	                        	Descargar Formato Evolucion
	                        </a>
	                        @else
