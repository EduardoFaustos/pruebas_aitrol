...
<div class="modal-body">
  <form method="post" action="{{route('controldoc.generar_cert')}}">
    ...
    <div class="form-group col-md-12" >
      ...
      <div class="col-md-5">
        <div class="input-group date" id="fecha">
            ...
            <input type="date" value="{{substr($historia->fechaini, 0,10)}}" name="cfecha" class="form-control pull-right input-sm" id="cfecha" required autocomplete="off" >
        </div>
      </div>
    </div>
    ...
    <div class="form-group col-md-12" >
      <label class="col-md-6 control-label">{{trans('admision.InicioConsulta')}}</label>
      <div class="col-md-5">
        <div class="input-group date" id="desde">
            <div class="input-group-addon">
                <i class="glyphicon glyphicon-time"></i>
            </div>
            <input type="time" value="{{substr($historia->fechaini, 11, 8)}}" name="idesde" class="form-control pull-right input-sm" id="idesde" autocomplete="off" >
        </div>
      </div>
    </div>

    <div class="form-group col-md-12" >
      <label class="col-md-6 control-label">{{trans('admision.FindeConsulta')}}</label>
      <div class="col-md-5">
        <div class="input-group date" id="hasta">
            <div class="input-group-addon">
                <i class="glyphicon glyphicon-time"></i>
            </div>
            <input type="time" name="ihasta"  class="form-control pull-right input-sm" id="ihasta" autocomplete="off" >
        </div>
      </div>
    </div>
    ...
    <div class="form-group col-md-12">
      ...
      <input id="familiar" type="text" class="form-control input-sm" name="familiar" value="">
    </div>
