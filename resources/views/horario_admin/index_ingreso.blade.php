  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="box box-default @if(session()->get('error')  ) @else collapsed-box @endif  ">
        ...
        <div class="box-body">
          <form class="form-horizontal" role="form" method="POST" action="{{ route('horario.unico2') }}">
    ...
    $('#calendar').fullCalendar({
      ...
      events: [
        ...
        @foreach($horarios as $value) {
          title: "<?php if ($value->ndia == 0) {
                    echo "Horario Domingo";
                  }
                  if ($value->ndia == 1) {
                    echo "Horario Lunes";
                  }
                  ...
                  if ($value->ndia == 3) {
                    echo "Horario Miercoles";
                  }
                  if ($value->ndia == 4) {
                    echo "Horario Jueves";
                  }
                  if ($value->ndia == 5) {
                    echo "Horario Viernes";
                  }
                  if ($value->ndia == 6) {
                    echo "Horario Sabado";
          ...
          start: '<?php if ($value->ndia == 7) {
                  ...
                  if ($value->ndia == 6) {
                    echo $s;
                  } ?> {{$value->hora_ini}}', // a start time (10am in this example) 
          end: '<?php if ($value->ndia == 7) {
                  echo $d;
                }
                if ($value->ndia == 1) {
                  echo $l;
                ...
                if ($value->ndia == 6) {
                  echo $s;
                } ?> {{$value->hora_fin}}', // an end time (2pm in this example) 
        ...
        @foreach($extra as $value) {
          title: "Horario Extra Añadido \n @if($value->tipo == 0) Tipo de  Horario: Todos @endif @if($value->tipo == 1) {{trans('horarioadmin.tipodehorario')}}: {{trans('horarioadmin.consultas')}} @endif @if($value->tipo == 2) {{trans('horarioadmin.tipodehorario')}}: {{trans('horarioadmin.procedimiento')}} @endif",
      ...
      select: function(start, end, jsEvent) { // click on empty time slot
        ...
        $("#agregarHorario2").load('{{route("horario.agregar_modal2")}}/' + start + '/' + end + '/{{$id}}');
