...
<section class="content">
  <div class="box">
    <div class="box-header">
      <div class="row">
        <div class="col-sm-8">
          <h3 class="box-title">{{trans('tarifario.BuscaPacienteNombre')}}</h3>
        </div>
        <div class="col-sm-4">
        </div>
      </div>
    ...
    <div class="box-body">
      ...
      <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            ...
            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
              <thead>
                <tr role="row">
                  ...
                  <th>{{trans('tarifario.Nombres')}}</th>
                  <th>{{trans('tarifario.Cedula')}}</th>
                </tr>
              </thead>
              <tbody>
        ...
        <div class="row">
          <div class="col-sm-5">
            <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">{{trans('tarifario.Mostrando')}} 1 {{trans('tarifario.al')}} {{count($paciente)}} {{trans('tarifario.de')}} {{$paciente->total()}} {{trans('tarifario.Registros')}}</div>
          </div>
          <div class="col-sm-7">
