<div class="modal-header">
    ...
    <h4 class="modal-title" style="text-align: center;"><b>PACIENTE:</b> {{$consultas->id_paciente}}
        {{$consultas->nombre1}} {{$consultas->nombre2}} {{$consultas->apellido1}} {{$consultas->apellido2}}</h4>
    <div style="text-align: right;"><span class="label label-primary"
            style="font-size: 100%;">@if($consultas->estado_pentax=='1') <b>PREPARACIÓN</b> @endif
            @if($consultas->estado_pentax=='0') <b>EN ESPERA</b> @endif
            @if($consultas->estado_pentax=='2') <b>EN PROCEDIMIENTO</b> @endif
            @if($consultas->estado_pentax=='3') <b>RECUPERACIÓN</b> @endif
            @if($consultas->estado_pentax=='4') <b>ALTA</b> @endif
            @if($consultas->estado_pentax=='5') <b>SUSPENDER</b> @endif
        </span></div>
</div>
        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">Mostrando
                    {{count($pentax_logs)}} Registros</div>
            </div>
            <div class="col-sm-7">
