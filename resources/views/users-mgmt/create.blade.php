    ...
    <div class="row">
        <div class="box box-primary col-xs-24">
            <div class="box-header">
                <h3 class="box-title">{{trans('adminusuarios.agregarnuevousuario')}}</h3>
            </div>
            <form class="form-vertical" role="form" method="POST" action="{{ route('user-management.store') }}">
                ...
                <div class="box-body col-xs-24">
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('nombre1') ? ' has-error' : '' }}">
                        <label for="nombre1" class="col-md-4 control-label">{{trans('adminusuarios.primernombre')}}</label>
                        <div class="col-md-7">
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('nombre2') ? ' has-error' : '' }}">
                        <label for="nombre2" class="col-md-4 control-label">{{trans('adminusuarios.segundonombre')}}</label>
                        <div class="col-md-7">
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('apellido1') ? ' has-error' : '' }}">
                        <label for="apellido1" class="col-md-4 control-label">{{trans('adminusuarios.primerapellido')}}</label>
                        <div class="col-md-7">
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('apellido2') ? ' has-error' : '' }}">
                        <label for="apellido2" class="col-md-4 control-label">{{trans('adminusuarios.segundoapellido')}}</label>
                        <div class="col-md-7">
                    ...
                    <div class="form-group col-xs-6 {{ $errors->has('id_pais') ? ' has-error' : '' }}">
                        <label for="id_pais" class="col-md-4 control-label">{{trans('adminusuarios.pais')}}</label>
                        <div class="col-md-7">
                            ...
                            <select id="id_pais" name="id_pais" class="form-control">
                                @for($i=0;$i<=count($pais)-1;$i++) <option value="{{$pais[$i]->id}}">{{$pais[$i]->nombre}}</option>
                                    @endfor
                            </select>
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('ciudad') ? ' has-error' : '' }}">
                        <label for="ciudad" class="col-md-4 control-label">{{trans('adminusuarios.ciudad')}}</label>
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('direccion') ? ' has-error' : '' }}">
                        <label for="direccion" class="col-md-4 control-label">{{trans('adminusuarios.direccion')}}</label>
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('telefono1') ? ' has-error' : '' }}">
                        <label for="telefono1" class="col-md-4 control-label">{{trans('adminusuarios.telefono')}}</label>
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('telefono2') ? ' has-error' : '' }}">
                        <label for="telefono2" class="col-md-4 control-label">{{trans('adminusuarios.celular')}}</label>
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('ocupacion') ? ' has-error' : '' }}">
                        <label for="ocupacion" class="col-md-4 control-label">{{trans('adminusuarios.ocupacion')}}</label>
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('fecha_nacimiento') ? ' has-error' : '' }}">
                        <label for="fecha_nacimiento" class="col-md-4 control-label">{{trans('adminusuarios.fechadenacimiento')}}</label>
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('id_tipo_usuario') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-7">
                            <select id="id_tipo_usuario" name="id_tipo_usuario" class="form-control">
                                @for($i=0;$i<=count($tipousuarios)-1;$i++) @if ($tipousuarios[$i]->estado != 0)
                    ...
                    <div id="cdoctores" class="form-group col-xs-6{{ $errors->has('color') ? ' has-error' : '' }} oculto">
                        <label for="color" class="col-md-4 control-label">{{trans('adminusuarios.coloragenda')}}</label>
                ...
                <div class="form-group col-xs-6{{ $errors->has('email') ? ' has-error' : '' }}">
                    <label for="email" class="col-md-4 control-label">{{trans('adminusuarios.email')}}</label>
                ...
                <div class="form-group col-xs-6{{ $errors->has('password') ? ' has-error' : '' }}">
                    <label for="password" class="col-md-4 control-label">{{trans('adminusuarios.contrasena')}}</label>
                ...
                <div class="form-group col-xs-6">
                    <label for="password-confirm" class="col-md-4 control-label">{{trans('adminusuarios.confirmarcontrasena')}}</label>
