...
<div class="modal fade fullscreen-modal" id="log" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<div class="modal fade fullscreen-modal" id="doctor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <div class="box-header">
    <div class="row">
        <div class="col-md-6">
          <h3 class="box-title">Pacientes Hospitalizados dados de Alta</h3>
        </div>
  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{route('hospitalizados.buscar2')}}">
        {{ csrf_field() }}
        ...
        <div class="table-responsive col-md-12">
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info" style="font-size: 12px;">
            ...
            @foreach ($hospitalizados as $value)
                <tr role="row">
                  <td >{{ substr($value->fechafin,0,10)}}</td>
                  ...
                  <td>  
                      ...
                      <div class="form-group col-md-3">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <a href="{{route('hospitalizados.log',['id' => $value->id])}}" class="btn btn-block btn-success btn-xs" data-toggle="modal" data-target="#log">
                        Log
                        </a>  
                      </div>
                  </td>
...
<script type="text/javascript">
  ...
  $(document).ready(function($){
    ...
    $(".breadcrumb").append('<li class="active">Altas</li>');
   ...
   $('#log').on('hidden.bs.modal', function(){
                location.reload();
