...
@section('content')
    <div>   
        ...
        <p class="txt10 gray"><img src="{{base_path().'/storage/app/preparaciones_img/check.png'}}", width="15 px">     Desayuno blando.</p><br>
        <p class="txt10 gray"><img src="{{base_path().'/storage/app/preparaciones_img/check.png'}}", width="15 px">     4 horas antes de asistir al procedimiento <b>aplicar en enema flett</b>.</p><br>
        <p class="txt10 gray"><img src="{{base_path().'/storage/app/preparaciones_img/check.png'}}", width="15 px">     En caso de algún retraso o emergencia qu tenga el médico se le indicará oportunamente.</p><br>
    </div>
    <div>
