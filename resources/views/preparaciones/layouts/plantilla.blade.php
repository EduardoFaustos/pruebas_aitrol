...
<body class="container" style="margin-top:60px">
    ...
    <div class="center">
        <p class="txt20 blue"><b>{{$procedimiento}}</b>@if(isset($nombre_secundario))<span class="orange txt20"><b> @php echo $nombre_secundario; @endphp</b></span>@endif</p>
    </div><br><br>
    <div class="foreOrange">
        <p>     <b>Nota: </b>No pacientes renales, ni con enfermedad inflamatoria activa: colitis ulcerativa</p>
    </div><br>
