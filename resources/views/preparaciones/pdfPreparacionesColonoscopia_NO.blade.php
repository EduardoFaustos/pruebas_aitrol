...
@section('content')
    ...
    <div>
        ...
        <table width="100%">
            <tr>
                <td width="25%">
                    <center><p class="foreBlue2"><b>10:00 - 11:00</b></p></center>
                </td>
                <td width="35%">
                    <img src="{{base_path().'/storage/app/preparaciones_img/neolax.png'}}", width="220 px"><br>
                    <p></p>
                </td>
                <td width="25%">
        ...
        <center><b class="txt10 orange">*Terminada toda la medicación. Paciente debe hidratarse bien.</b></center>
        <p class="txt10"> </p>
    ...
    <div>
        <p class="txt14 blue"><b>Indicaciones de medicamentos</b></p>
