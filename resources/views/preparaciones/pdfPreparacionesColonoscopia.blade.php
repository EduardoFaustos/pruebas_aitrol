...
@section('content')
    <div>
        ...
        <p  class="txt14 blue"><b>Empezar la medicación de la siguiente manera</b></p><br><br>
    </div>
    <div>
        <table width="90%">
            <tr>
                <td width="25%" align="center">
                   <p class="foreBlue2"><b>18:00</b></p>
                </td>
                <td width="35%">
                    <img src="{{base_path().'/storage/app/preparaciones_img/vaso_travapik.png'}}", width="220 px">
                    <p> <br> </p>
                </td>
                <td width="25%" align="center">
                    <p class="foreBlue2"><b>Cada 20 min</b></p>
                </td>
                <td width="35%">
                    <img src="{{base_path().'/storage/app/preparaciones_img/vaso_agua.png'}}", width="220 px">
                    <p class="txt10 gray">En total se debe ingerir 5 <br> vasos de agua (1 litro) <br> </p>
                </td>
            </tr>
            <tr>
                <td width="25%" align="center">
                    <p class="foreBlue2"><b>21:00</b></p>
                </td>
                <td width="35%">
                    <img src="{{base_path().'/storage/app/preparaciones_img/vaso_travapik.png'}}", width="220 px">
                    <p> <br> </p>
