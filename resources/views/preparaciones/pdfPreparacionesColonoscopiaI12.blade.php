...
@section('content')
    ...
    <div>
        ...
        <table width="100%">
            <tr>
                <td width="25%">
                    <center><p class="foreBlue2"><b>22:00 - 23:00</b></p></center>
                </td>
                <td width="35%">
                ...
                <td width="25%">
                    <center><p class="foreBlue2"><b>23:00 - 00:00</b></p></center>
                </td>
                <td width="35%">
                    <img src="{{base_path().'/storage/app/preparaciones_img/vaso_agua.png'}}", width="220 px"><br>
                </td>
        ...
        <table width="100%">
            <tr>
                ...
                <td width="50%">
                    <p class="txt10 gray">Terminado el segundo frasco, debe tomar 2 medidas del dosificador de líquidos transparentes como:agua, agua de coco o suero oral de coco.</p>
                </td>
            </tr>
        </table><br>
        <center><b class="txt10 orange">*El día del examen acudir en ayunas no tomar ni agua.</b></center><br>
