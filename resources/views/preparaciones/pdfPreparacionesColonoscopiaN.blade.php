...
@section('content')
    <div>
        ...
        <center><b class="txt10 orange">*A las 20:00 de la noche tomar 1 comprimido de dulcolax</b></center>
        <p class="txt10"> </p>
        <p class="txt10 gray"><img src="{{base_path().'/storage/app/preparaciones_img/check.png'}}", width="15 px">     ___________: <b class="txt10 blue">Día anterior del examen dieta líquida</b> todo cernido, té y líquidos transparentes como: agua, agua de coco o suero oral de coco.</p>
        <center><b class="txt10 orange">*A las 16:30 tomar una tableta de peimperam 10 mg (cloplan)</b></center>
        <p class="txt10"> </p>
    </div><br>
    <div>
        <table width="100%">
            <tr>
                <td width="18%">
                    <center><p class="foreBlue2"><b>17:00 - 21:00</b></p></center>
                </td>
                <td width="82%">
                    <img src="{{base_path().'/storage/app/preparaciones_img/nulytely.png'}}", width="900 px">
                </td>
            </tr>
        </table><br>
        <center><b class="txt10 orange">*En total debe diluir 4 sobres en 4 litros de agua (es recomendable tomar un vaso de 10 a 15 minutos)</b><br><br><br></center>
        <table width="100%">
            <tr>
                <td width="25%">
                    <p> </p>
                ...
                <td width="15%">
                    <center><p class="foreBlue2"><b>21:00</b></p></center>
                </td>
                <td>
                    <img src="{{base_path().'/storage/app/preparaciones_img/te_sugar.png'}}", width="250 px">
                </td>
            </tr>
        </table>
        <center><b class="txt10 orange">*El día del examen acudir en ayunas no tomar ni agua.</b></center>
