...
<section class="content">
    <div class="box">
        <div class="box-header"><h3 class="box-title">{{(trans('nivel.CrearNivel'))}}</h3>
        </div>
        <div class="box-body">
            <form id="crear_nivel" method="post" action="{{route('nivel.store')}}">
                {{ csrf_field() }}
                ...
                <div class="box-body">
                    <div class="form-group col-xs-6{{ $errors->has('nombre_corto') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="nombre_corto" size="20" class="form-control" value=" " maxlength="100">
                    </div>
                </div>
                ...
                <div class="box-body">
                    <div class="form-group col-xs-6{{ $errors->has('grupo') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="grupo" size="20" class="form-control" value=" " maxlength="3">
                    </div>
                </div>
