...
<section class="content">
    <div class="box ">
        ...
        <div class="box-body dobra">
            <form class="form-vertical" role="form" method="POST" action="{{route('productos.update_saldos',['id'=>$saldos->id])}}">
                {{ csrf_field() }}
                <div class="box-body col-xs-24">
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('codigo') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-7">
                            <select class="form-control select2" name="id_producto" style="width: 100%;" required id="id_producto">
                                <option value=""> Seleccione ...</option>
                                @foreach($productos as $p)
                                    <option @if($saldos->id_producto==$p->id) selected="selected" @endif value="{{$p->id}}"> {{$p->codigo}} {{$p->nombre}} </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('nombre') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-7">
                            <input id="descripcion" type="text" class="form-control" name="descripcion" value="{{$saldos->descripcion}}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required autofocus autocomplete="off">
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" style="text-align: right;" required name="cantidad" id="cantidad" onkeypress="return isNumberKey(event)" onchange="calcular(this)" value="{{$saldos->cantidad}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <div class="col-md-7">
                        <input type="text" class="form-control" style="text-align: right;" required name="costo" id="costo" onkeypress="return isNumberKey(event)" onchange="calcular(this)" value="{{$saldos->costo}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('tipo') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-7">
                           <input type="text" class="form-control" style="text-align: right;" required name="total" id="total" readonly value="{{$saldos->total}}">
                            @if ($errors->has('total'))
                            <span class="help-block">
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('nota') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-7">
                            <textarea class="form-control" rows="2" name="nota" id="nota">{{$saldos->nota}}</textarea>
                            @if ($errors->has('nota'))
                            <span class="help-block">
                    ...
                    <div class="form-group col-xs-6{{ $errors->has('nota') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-7">
                            <input class="form-control" type="date" name="fecha" value="{{$saldos->fecha}}" id="fecha">
                        </div>
                    </div>
