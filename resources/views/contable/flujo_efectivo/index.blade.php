@extends('contable.flujo_efectivo.base')
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="../">Flujo de efectivo</a></li> 
    </ol>
  </nav>
    <div class="box" style=" background-color: white;">
      ...
      <div class="box-body dobra">
        <form method="POST" id="reporte_master" action="{{ route('flujoefectivo.show') }}" >
        {{ csrf_field() }}
      ...
      @include('contable.flujo_efectivo.show')
  ...
  <form method="POST" id="print_reporte_master" action="{{ route('flujoefectivo.show') }}" target="_blank">
          {{ csrf_field() }}
