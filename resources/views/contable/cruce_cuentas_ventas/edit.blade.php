                    ...
                    <div class="col-md-12 px-1">
                        <div class="form-row ">
                            ...
                            <div class=" col-md-2 px-1">
                                <label class="label_header">Estados</label>
                                <input style="@if($cruce->estado==1) background-color: green; @else background-color: red; @endif" readonly class="form-control col-md-1">
                            </div>
                            <div class=" col-md-2 px-1">
