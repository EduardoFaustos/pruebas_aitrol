...
<section class="content">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="#">Nota Credito Cliente</a></li>
    </ol>
  </nav>
  ...
  <div class="box dobra" style=" background-color: white;">
    ...
    <!-- /.box-header -->
    <div class="box-body ">
      <form method="POST" id="reporte_master" action="{{ route('nota_credito_cliente.informe_notacreditoclientes') }}">
        {{ csrf_field() }}
    ...
    <!-- /.box-body -->
    <form method="POST" id="print_reporte_master" action="{{ route('nota_credito_cliente.excel_ncc') }}" target="_blank">
      {{ csrf_field() }}
      ...
      <div class="row">
        ...
        <div class="box-body">
          ...
          <div id="imprimir">
            ...
            <div class="col-md-4">
              <h4 style="text-align: center;">INFORME DE NOTA DE CREDITO CLIENTE </h4>
            ...
            <table id="example2" class="table table-striped" role="grid" aria-describedby="example2_info" style="font-size: 12px; text-align:center;">
              <thead>
                <tr class='well-dark'>
                  <th width="6.25%" style="text-align:center;" tabindex="0" aria-controls="example2" rowspan="1">{{trans('contableM.fecha')}}</th>
                  <th width="7.25%" style="text-align:center;" tabindex="0" aria-controls="example2" rowspan="1">{{trans('contableM.numero')}}</th>
                  <th width="7%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">CI</th>
                  <th width="6.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.cliente')}}</th>
                  <th width="6.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.tipo')}}</th>
                  <th width="16.50%" style="text-align:center;"tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.detalle')}}</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.BaseImponible')}}</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.SubTotal12')}}</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.SubTotal0')}}</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.subtotal')}}</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.descuento')}}</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.impuesto')}}</th>
                  <th width="3.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.total')}}</th>
                  <th width="6.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.estado')}}</th>
                  <th width="6.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.creadopor')}}</th>
                  <th width="6.25%" style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.anuladopor')}}</th>
                </tr>
              </thead>
              <tbody>
                @php
                ...
                @php
                $subtotalf=0;
                $subtotalf= $value->tar_iva_12+$value->sub_sin_imp+$value->descuento;;
                $base_imponible += $value->subtotal;
                ...
                <tr>
                  ...
                  <td style="text-align:center;">{{number_format($detalle_base,2,'.',',')}}</td>
                  <td style="text-align:center;">{{number_format($value->tar_iva_12,2,'.',',')}}</td>
                  <td style="text-align:center;">{{number_format($value->sub_sin_imp,2,'.',',')}}</td>
                  <td style="text-align:center;">@if(($value)!=null) {{number_format($subtotalf,2,'.',',')}} @endif </td>
                  <td style="text-align:center;">@if(($value)!=null) @if(($value->$descuento==null))0.00 @else {{$value->descuento}}@endif @endif </td>
                  <td style="text-align:center;">@if(($value)!=null) {{$value->impuesto}} @endif </td>
                  <td style="text-align:center;">@if(($value)!=null) @if($value->electronica==0) {{number_format($value->total_credito,2,'.',',')}}  @else @php $sg= $value->total_credito - $value->descuento; @endphp {{number_format($sg,2,'.',',')}}  @endif @endif </td>
              ...
              <tr>
                  ...
                  <td style="text-align:center; font-weight: bold; ">
                    <p>{{number_format($total_base_retencion,2,'.',',')}}</p>
                  </td>
                  <td style="text-align:center; font-weight: bold; ">
                  ...
                  <td style="text-align:center; font-weight: bold; ">
                    <p>{{number_format($subtotal+$descuento,2,'.',',')}}</p>
                  </td>
                  <td style="text-align:center; font-weight: bold; ">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('.select2_cuentas').select2({
        ajax:{
            type: 'GET',
            url: "{{route('notacreditocliente.autocomplete')}}",
            dataType: 'json',
            delay: 300,
