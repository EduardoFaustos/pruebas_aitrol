  ...
  <section class="content">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">{{trans('contableM.TipoTarjeta')}}</a></li>
        <li class="breadcrumb-item active" aria-current="page">{{trans('contableM.actualizar')}}</li>
      </ol>
    </nav>
    <form  class="form-vertical" role="form" method="POST" action="{{route('tipo_tarjeta.actualizar')}}">
      {{ csrf_field() }}
      <input  name="id_tipo_pago" id="id_tipo_pago" type="text" class="hidden" value="@if(!is_null($tip_pago)){{$tip_pago->id}}@endif" >
      <div class="box">
        <div class="box-header color_cab">
          <div class="col-md-9">
            <h5><b>DETALLE TIPO TARJETA</b></h5>
          </div>
        ...
        <div class="box-body dobra">
            ...
            <div class="form-group  col-xs-6">
              ...
              <div class="col-md-7">
                <input id="tipo_tarj" name="tipo_tarj" type="text" value="{{$tip_pago->nombre}}" class="form-control" autocomplete="off">
              </div>
            </div>
            <!--ESTADO TIPO TARJETA-->
            <div class="form-group col-xs-6">
                ...
                <div class="col-md-7">
                  ...
                  <option {{ $tip_pago->estado == 1 ? 'selected' : ''}} value="1">{{trans('contableM.activo')}}</option>
                  <option {{ $tip_pago->estado == 0 ? 'selected' : ''}} value="0">{{trans('contableM.inactivo')}}</option>
                  </select>
                </div>
            </div>
