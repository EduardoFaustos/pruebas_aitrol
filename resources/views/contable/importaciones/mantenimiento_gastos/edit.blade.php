    	...
    	<div class="box">
            ...
            <div class="box-body dobra">
                ...
                <div class="col-md-10">
	                    ...
	                    <div class="col-md-3">
	                        <input type="text" class="form-control" id="codigo" name="codigo" value="{{$gasto->codigo}}" readonly/>
	                    </div>
	                </div>
            		<div class="col-md-10">
	                    ...
	                    <div class="col-md-3">
	                        <select id="id_plan_cuenta" name="id_plan_cuenta"  class="form-control select2_cuentas" style="width: 100%;" required>
	                            ...
	                            @foreach($plan as $plan)
	                                <option @if($gasto->id_plan_cuenta == $plan->id ) selected @endif value="{{$plan->id}}">{{$plan->nombre}}</option>
	                            @endforeach
	                        </select>
	                    </div>
                ...
                <div class="col-md-12" style="text-align: center;">
                    <button class="btn btn-success btn-gray" onclick="actualizar_gasto('{{$id}}');" id="btn_actualiza"><i class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></i>Actualizar
                    </button>
                </div>
...
<script type="text/javascript">
    ...
    function actualizar_gasto(id){
        $('#btn_actualiza').prop("disabled", true);
    	$.ajax({
	        type: 'post',
	        url: "{{url('contable/importacion/gastos/update')}}/"+id,
	        headers: {
	        ...
	        success: function(data) {
                ...
                if (data.respuesta == 'si') {
                    ...
                    $('#btn_actualiza').prop("disabled", false);
                }	          
	        },
	        error: function(data) {
	            console.log(data);
