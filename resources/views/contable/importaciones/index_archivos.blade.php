        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div class="col-md-9">
                        <h4>Ingreso Archivos de Importación</h4>
                    </div>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-xs-12{{ $errors->has('conclusiones') ? ' has-error' : '' }}">
                            <label for="conclusiones" class="col-md-12 control-label">Seleccione los archivos o arrastrelos al recuadro</label>
                            <div class="col-md-12">
                                <form method="POST" action="{{route('gastosimportacion.guardar_archivo')}}" enctype="multipart/form-data" class="dropzone" id="addimage">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2>Historial Archivos de importación</h2>
                                ...
                                <table class="table table-bordered  dataTable">
                                    <tbody style="font-size: 12px;">
                                        ...
                                        <div class="col-md-3" style='margin: 10px 0; text-align: center;'>
                                            ...
                                            <a type="button" href="{{asset('contable/importaciones/archivo_descarga')}}/{{$imagen->id}}" class="btn btn-primary btn-sm">
                                                <!-- ruta 0 desde la historia clinica -->
                                                <span class="glyphicon glyphicon-download-alt"> </span>
                                            </a>
                                            <a type="button" onclick="eliminar2('{{$imagen->id}}');" class="btn btn-danger btn-sm" target="_blank">
                                                <!-- ruta 0 desde la historia clinica -->
                                            ...
                                            <span>{{substr($imagen->created_at, 0, 10)}}</span><br>
                                            <a type="button" href="{{asset('contable/importaciones/archivo_descarga')}}/{{$imagen->id}}" class="btn btn-primary btn-sm" target="_blank">
                                                <!-- ruta 0 desde la historia clinica -->
                                                <span class="glyphicon glyphicon-download-alt"></span>
                                            </a>
                                            <a type="button" onclick="eliminar2('{{$imagen->id}}');" class="btn btn-danger btn-sm" target="_blank">
                                            ...
                                            <a data-remote="{{ route('gastosimportacion.anteprima',['id_imagen'=>$imagen->id])}}" class="btn btn-info btn-sm" data-toggle="modal" data-target="#ver_anteprima">
...
<script>
    ...
    function eliminar2(id) {
        ...
        if (opcion == true) {
            $.ajax({
                type: 'get',
                url: '{{ url("contable/importaciones/eliminar_archivo")}}/' + id,
                headers: {  
