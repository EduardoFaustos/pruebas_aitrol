...
<section class="content">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Importacion</a></li>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-9 col-sm-9 col-6">
                            ...
                            <div class="box-title"><b>ORDEN DE COMPRA IMPORTACIÓN</b></div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-xs-3 px-1">
                                ...
                                <select class="form-control select2_proveedor validaciones" onchange="buscarDireccion();" style="width: 100%;" name="proveedor" id="proveedor">
...
<script>
    ...
    const crearFila = () => {
        ...
        let fila = `
                <tr >
                                ...
                                <td>
                                    <input readonly onchange="totalProducto(${id})" id="precioneto${id}" class="form-control px-1 text-right precioneto validar" type="text" style="height:20px;" onkeypress="return isNumberKey(event)" value="0.00" onblur="this.value=parseFloat(this.value).toFixed(2);" name="precioneto[]" required>
                                </td>
    ...
    function guardarImportacion(e) {
        ...
        if (!validar_campos()) {
            if (!validarProducto()) {
                $.ajax({
                    type: 'post',
                    url: "{{route('importaciones.store_orden')}}",
                    headers: {
    ...
    function ingresar_cero() {
        ...
        console.log(parseInt(secuencia))
