    ...
    <div class="box-body dobra">
        <div class="header row">
            ...
            <div class="form-group col-xs-4 px-1">
                ...
                <div class="col-md-12 px-0">
                    <input id="banco" type="text" class="form-control" name="banco" value="@if(!is_null($registro)) @if(isset($registro->banco)){{$registro->banco->nombre}} #{{$registro->banco->numero_de_cuenta}} @endif @endif" disabled>
                    <select class="form-control " name="banco" id="banco" required>
                                            <option value="">Seleccione..</option>
                                            @foreach($banco as $value)
                                                <option {{$value->id == $comprobante_egreso->id_caja_banco ? 'selected' : ''}} value="{{$value->id}}">{{$value->nombre}}</option>
                                            @endforeach
                   </select>
                </div>
            </div>
            ...
            <div class="form-group col-xs-12  col-md-12  px-1 pv-10">
                ...
                <div class="table-responsive col-md-12 px-0" style="max-height: 250px; overflow:hidden">
                    ...
                    <table id="example2" role="grid" aria-describedby="example2_info">
                        ...
                        <tbody id="crear">
                            ...
                            <tr class="well" style="position: relative;">
                                ...
                                <td> <input class="form-control" style="text-align: left;" type="text" name="nuevo_saldo{{$cont}}" id="nuevo_saldo{{$cont}}" value="{{$value->saldo}}" readonly></td>
                                <td> <input class="form-control" style="text-align: center;" type="text" name="abono_base{{$cont}}" id="abono_base{{$cont}}" value="{{$value->abono}}" readonly> </td>
