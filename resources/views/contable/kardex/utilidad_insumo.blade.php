                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            ...
                            <div id="imprimir">
                                ...
                                <div class="col-md-4">
                                    <h4 style="text-align: center;">UTILIDAD DE INSUMOS</h4>
                                    @if(($fecha_desde!=null))
                                ...
                                <table id="example2" class="display compact" style="font-size: 12px; width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        $usos= Sis_medico\Inventario::utilidad_insumo($x->id_producto);
                                        $usos_t+=$usos;
                                        @endphp
                                        <tr class="bold">
                                            <td>{{$tipo}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>SUMAN</td>
                                            <td>{{$usos_t}} </td>
                                            <td>{{$costos_totales}}</td>
                                            <td>{{$a->costos_a}}</td>
                                            <td>{{$a->costos_principales}}</td>
                                            <td>{{$totales}}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
