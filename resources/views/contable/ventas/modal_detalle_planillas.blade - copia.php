              ...
              <tbody>   
                        ...
                        @php $i=1; @endphp
                            @foreach($hc->procedimiento as $ps)
                              ...
                              @php
                                ...
                                if($seguro->tipo == 0){ //PUBLICO
                                    $convenio = $convenios->where('id_empresa',$id_empresa)->where('id_seguro',$seguro->id)->first();
                                }

                               
                                if($seguro->tipo == 1){ //PRIVADO

                                  $convenios = $convenios->where('id_seguro',$seguro->id)->get(); 
                            ...
                            <tr>
                                ...
                                <td>Seguro: {{ $seguro->nombre}} Nivel: {{$convenio->nivel->nombre}}</td>  @if($i==1) {{dd($seguro, $convenio->nivel)}}@endif       
                                <td>
