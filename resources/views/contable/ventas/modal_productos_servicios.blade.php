        ...
        <div style="padding-top: 10px;padding-left: 100px" class="form-group col-md-12">
              <center>
                  <div id="example2" class="dataTables_wrapper form-inline dt-bootstrap">
                    ...
                    <div class="row">
                      <div class="col-sm-5">
                        <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">{{trans('contableM.mostrando')}} {{count($lista_productos)}} / {{count($lista_productos)}} de {{$lista_productos->total()}} {{trans('contableM.registros')}}</div>
                      </div>
                      <div class="col-sm-7">
