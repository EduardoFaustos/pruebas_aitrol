...
<section class="content">
    ...
    <div class="box">
        <div class="box-header header_new">
            <div class="col-md-9">
                <h3 class="box-title">Nueva Factura de Venta - Recibo de Cobro -</h3>
            </div>
        ...
        <form class="form-vertical" id="form">
            ...
            <div class="form-group col-xs-6  col-md-2  px-1">
                ...
                <div class="form-group col-xs-6  col-md-1  px-1">
                    ...
                    <div class="col-md-12 px-0">
                        <input type="text" class="form-control" name="tipo" id="tipo" value="VEN-R" readonly>
                        @if ($errors->has('tipo'))
                        <span class="help-block">
                ...
                <div class="col-md-12 px-1">
                    <label class="control_header">Ingresar Recibo de Cobro</label>
                </div>
                <div class="col-md-2 px-1">
                    <input type="text" class="form-control" placeholder="Ingrese #" name="recibo_cobro" onchange="recibo(this)" id="recibo_cobro">
                </div>
            ...
            if($(e).val()!=""){
                $.ajax({
                    ...
                    success: function(datahtml, data) {
                        ...
                        $("#content_producto").append(datahtml);
                        $('.select').select2({
                           tags:false
                        });
                        $(e).val('');
