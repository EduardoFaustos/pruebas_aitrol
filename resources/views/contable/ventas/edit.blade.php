...
<section class="content">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{trans('wfact_venta.detalle')}}</li>
        </ol>
    </nav>
    <div class="box">
        <div class="box-header header_new">
            ...
            <a class="btn btn-success btn-gray " data-remote="{{ route('compras.modal_estado',[$ventas->id_asiento])}}" class="btn btn-info btn-sm" data-toggle="modal" data-target="#visualizar_estado">
        <i class="glyphicon glyphicon-eye-open"  aria-hidden="true"></i>&nbsp;&nbsp;{{trans('wfact_venta.visualizar_asiento_diario')}}
        </a>
        <a class="btn btn-success btn-gray " style="margin-left: 3px;" href="{{route('librodiario.edit',['id'=>$ventas->id_asiento])}}" target="_blank">
            <i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;&nbsp;{{trans('wfact_venta.editar_asiento_diario')}}
        </a>

            <div class="col-md-1 text-right">
            <a class="btn btn-default btn-gray" data-remote="{{ route('modalsubir_ventas',['id'=> $ventas->id])}}"  data-toggle="modal" data-target="#modalpdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> {{trans('wfact_venta.subir')}}</a>
            </div>
        ...
        <div class="header row">
            ...
            <div class="form-group col-xs-6  col-md-2  px-1">
                   ...
                   <!--  <select class="form-control" name="sucursal" id="sucursal" onchange="obtener_caja()" class="col-md-12 px-0">
                    ...
                    <input type="text" class="form-control col-md-12" value="{{$ventas->sucursal}}" disabled>
                </div>
                <div class="form-group col-xs-6  col-md-2  px-1">
                    <div class="col-md-12 px-0">
                        <label for="punto_emision" class="label_header">{{trans('contableM.pemision')}}</label>
                    </div>
                    <input type="text" class="form-control col-md-12"  disabled value="{{$ventas->punto_emision}}">
                </div>
                <div class="form-group col-xs-6 col-md-2 px-1">
                    <div class="col-md-12 px-0">
                ...
                <div class="form-group col-xs-6 col-md-2 px-1">
                    <div class="col-md-12 px-0">
                        <label for="numero" class=" label_header">{{trans('wfact_venta.Numero')}}</label>
                    </div>
                    <div class="col-md-12 px-0">
                ...
                <div class="form-group col-xs-6  col-md-2  px-1">
                    <div class="col-md-12 px-0">
                        <label for="empresa" class="label_header">{{trans('wfact_venta.empresa')}}</label>
                    </div>
                    <div class="col-md-12 px-0">
                ...
                <div class="form-group col-xs-12  px-1">
                    ...
                    <div class="col-md-2 px-0">
                        <select class="form-control" name="tipo_consulta" id="tipo_consulta" readonly>
                            ...
                            <option value="1" {{ $ventas->tipo_consulta == "1" ? 'selected' : ''}}>{{trans('wfact_venta.consulta')}}</option>
                            <option value="2" {{ $ventas->tipo_consulta == "2" ? 'selected' : ''}}>{{trans('wfact_venta.Procedimiento')}}</option>
                    ...
                    @foreach($result as $s=>$z)
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                @endphp
                                @if(!is_null($ek))
                                <label>{{$ek->apellido1}} {{$ek->apellido2}} {{$ek->nombre1}} {{$ek->nombre2}} </label>
                                ...
                                <div class="panel-body" style="padding:0;">
                                    <div class="col-md-12 table-responsive " style="padding:0 !important;">
                                        <table class="table table-bordered table-hover dataTable noacti" role="grid" aria-describedby="example2_info" style="margin-top:0 !important;">
                                            <thead>
                                                <tr class="well-dark">
                                                    <th width="35%" tabindex="0">{{trans('wfact_venta.descri_producto')}}</th>
                                                    <th width="10%" tabindex="0">{{trans('contableM.cantidad')}}</th>
                                                    <th width="10%" tabindex="0">{{trans('wfact_venta.precio')}}</th>
                                                    <th width="10%" tabindex="0">{{trans('contableM.cobrarseguro')}}</th>
                                                    <th width="10%" tabindex="0">% {{trans('wfact_venta.descuento')}}</th>
                                            ...
                                            <tbody id="entrega">
                                                ...
                                                <tr>
                                                    <td style="max-width:100px;">
                                                        ...
                                                        @php 
                                                            $func= DB::table('ct_productos')->where('codigo',$x['id_ct_productos'])->first();

                                                        @endphp
                                                        <input type="text" class="form-control" style="width: 96%; height: 20px" value="{{$func->nombre}}" disabled>
                                                        <textarea wrap="hard" rows="3" class="form-control px-1 desc_producto" disabled placeholder="{{trans('wfact_venta.detalle_prod')}}">{{$x['detalle']}}</textarea>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endphp
                                                        <input type="text" class="form-control pneto" disabled onkeypress="return isNumberKey(event)" style="width:90%;display:inline;height:20px;" value="{{$precio}}">
                    ...
                    <table id="example2" class="table table-bordered table-hover dataTable table-striped" role="grid" aria-describedby="example2_info">
                        ...
                        <tfoot class='well'>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td colspan="2" class="text-right">{{trans('wfact_venta.base_imponible')}}Base Imponible</td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td colspan="2" class="text-right">{{trans('wfact_venta.transporte')}}</td>
                ...
                <div class="table-responsive wrap">
                    <table id="example2" class="table table-bordered table-hover dataTable table-striped" role="grid" aria-describedby="example2_info">
                        <thead>
                            <tr class='well-dark'>
                                <th width="55%" class="" tabindex="0">{{trans('wfact_venta.descri_producto')}}</th>
                        ...
                        <tbody id="agregar_cuentas">
                            ...
                            <tr class="well" style="position: relative;">
                                ...
                                <td style="width: 5%; text-align: center;">@if(!is_null($value->cantidad)){{number_format($value->cantidad* $value->precio - $value->copago, 2)}}@endif</td>
                                <td style="width: 5%; text-align: center;">
                        ...
                        <tfoot class='well'>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td colspan="2" class="text-right">{{trans('contableM.base_imponible')}}</td>
                                <td id="base" class="text-right px-1">@if(!is_null($ventas)){{number_format($ventas->base_imponible,2)}}@endif</td>
                                <input type="hidden" name="base1" id="base1" class="hidden">
                            </tr>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td colspan="2" class="text-right">{{trans('contableM.iva')}} 12%</td>
                                <td id="tarifa_iva" class="text-right px-1">@if(!is_null($ventas)){{number_format($ventas->impuesto,2)}}@endif</td>
                                <input type="hidden" name="tarifa_iva1" id="tarifa_iva1" class="hidden">
                            </tr>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td colspan="2" class="text-right">{{trans('contableM.transporte')}}</td>
                                <td id="transporte" class="text-right px-1">@if(!is_null($ventas)){{number_format($ventas->transporte,2)}}@endif</td>
                                <input type="hidden" name="transporte1" id="transporte1" class="hidden">
                            </tr>
                            <tr>
                ...
                <div class="col-md-12 table-responsive ">
                    ...
                    <table id="example1" role="grid" class="table table-bordered table-hover dataTable" aria-describedby="example1_info" style="margin-top:0 !important">
                        <thead>
                            <tr class='well-dark'>
                                <th width="20%" style="text-align: center;">{{trans('wfact_venta.Tipo')}}</th>
                                ...
                                <th width="20%" style="text-align: center;">{{trans('wfact_venta.banco')}}</th>
                ...
                <div class="box box-solid box-warning" style="background-color: white;display:none">
                    <div class="header box-header with-border">
                        <div class="box-title col-md-9"><b style="font-size: 16px;">{{trans('wfact_venta.Facturas de Venta')}}</b></div>
                    ...
                    <div class="box-body" style="background-color: #ffffff;">
                        <form class="form-vertical" id="crear_factura" role="form" method="POST">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-xs-2">
                                        <label style="padding-left: 0px;font-size: 13px">{{trans('contableM.estado')}}:</label>
                                    ...
                                    <div class="col-md-1 col-xs-1" style="padding-left: 2px;padding-right: 2px;">
                                        <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.Id')}}</label>
                                    ...
                                    <div class="col-md-1 col-xs-1" style="padding-left: 2px;padding-right: 2px;">
                                        <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.Numero')}}:</label>
                                        <div class="input-group">
                                    ...
                                    <div class="col-md-1 col-xs-1" style="padding-left: 2px;padding-right: 2px;">
                                        <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.Tipo')}}:</label>
                                        <div class="input-group">
                                    ...
                                    <div class="col-md-2 col-xs-2" style="padding-left: 2px;padding-right: 2px;">
                                        <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.divisas')}}:</label>
                                        <!--<div class="input-group">
                                <input id="divisas" name="divisas" type="text"  class="form-control" value="@if(!is_null($ventas)){{$ventas->divisas}}@endif" disabled>
                                    ...
                                    <div class="col-md-2 col-xs-2" style="padding-left: 2px;padding-right: 2px;">
                                        <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.fecha_emision')}}:</label>
                                        <div class="input-group">
                            ...
                            <div class="col-md-12">
                                <div class="card1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h8>{{trans('wfact_venta.datos_cliente')}}</h8>
                                        </div>
                                        <!--Código del Cliente-->
                                        <div class="col-md-2 col-xs-2">
                                            <label for="id" class="control-label" style="font-size: 13px">{{trans('wfact_venta.Cliente')}}:</label>
                                        ...
                                        <div class="col-md-3 col-xs-3" style="padding-left: 2px;padding-right: 2px;">
                                            <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.direccion')}}</label>
                                        ...
                                        <!--Ruc/Cid del Cliente-->
                                        <div class="col-md-2 col-xs-2" style="padding-left: 2px;padding-right: 2px;">
                                            <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.ruc')}}</label>
                                            <div class="input-group">
                                        ...
                                        <div class="col-md-2 col-xs-2" style="padding-left: 2px;padding-right: 2px;">
                                            <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.telefono')}}</label>
                                            <div class="input-group">
                                        ...
                                        <!--Email del Cliente-->
                                        <div class="col-md-2 col-xs-2" style="padding-left: 2px;padding-right: 2px;">
                                            <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.correo')}}</label>
                                            <div class="input-group">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h8>{{trans('wfact_venta.datos_paciente')}}</h8>
                                        </div>
                                        <!--Cedula Paciente-->
                                        <div class="col-md-2 col-xs-2">
                                            <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.cedula')}}</label>
                                        ...
                                        <!--Nombre Paciente-->
                                        <div class="col-md-3 col-xs-3" style="padding-left: 2px;padding-right: 2px;">
                                            <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.Paciente')}}</label>
                                        ...
                                        <!--Seguro Paciente-->
                                        <div class="col-md-2 col-xs-2" style="padding-left: 2px;padding-right: 2px;">
                                            <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.seguro')}}</label>
                                            <input id="seguro" name="seguro" type="text" class="form-control" value="@if(!is_null($seguro)){{$seguro->nombre}}@endif" disabled>
                                        </div>
                                        <!--Procedimiento-->
                                        <div class="col-md-2 col-xs-2" style="padding-left: 2px;padding-right: 2px;">
                                            <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.Procedimiento')}}</label>
                                        ...
                                        <div class="col-md-2 col-xs-2" style="padding-left: 2px;padding-right: 2px;">
                                            <label class="control-label" style="font-size: 13px">{{trans('wfact_venta.fecha_procedimiento')}}</label>
                            ...
                            <div class="form-group col-md-12">
                                <div class="card">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <h8>{{trans('wfact_venta.forma_pago')}}</h8>
                                        </div>
                                        <div class="form-group col-md-3 col-sm-3">
                                            <label for="efectivo" class="col-form-label-sm">{{trans('wfact_venta.valor_efectivo')}}</label>
                            ...
                            <div class="col-md-12" style="padding-top: 8px">
                                <div class="row">
                                    <!--Nota-->
                                    <label class="col-md-1 control-label" style="font-size: 13px">{{trans('wfact_venta.detalle_asiento')}}</label>
                                    <div class="col-md-6">
                        ...
                        <div class="table-responsive col-mds-12" style="min-height: 100px; max-height: 250px;">
                            <table id="example2" role="grid" aria-describedby="example2_info">
                                <caption><b>{{trans('wfact_venta.detalle_prod')}}</b></caption>
                                <thead style="background-color: #FFF3E3">
                                    <tr style="position: relative;">
                                        <th style="width: 10%; text-align: center;">{{trans('wfact_venta.codigo')}}</th>
                                        <th style="width: 15%; text-align: center;">{{trans('wfact_venta.descri_producto')}}</th>
                                        <th style="width: 5%; text-align: center;">{{trans('contableM.cantidad')}}</th>
                                        <th style="width: 5%; text-align: center;">{{trans('contableM.precio_unitario')}}</th>
                                        <th style="width: 5%; text-align: center;">% {{trans('wfact_venta.descuento')}}</th>
                                        <th style="width: 5%; text-align: center;">{{trans('wfact_venta.descuento')}}</th>
                                        <th style="width: 5%; text-align: center;">{{trans('contableM.precio_unitario')}}</th>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="col-md-12" style="padding: 5px">
                                        <div class="row">
                                            <label class="col-md-6">{{trans('wfact_venta.subtotal_sin_iva')}}</label>
                                    ...
                                    <div class="col-md-12" style="padding: 5px">
                                        <div class="row">
                                            <label class="col-md-6">{{trans('wfact_venta.base_imponible')}}</label>
                                    ...
                                    <div class="col-md-12" style="padding: 5px">
                                        <div class="row">
                                            <label class="col-md-6">{{trans('wfact_venta.iva')}} 12%</label>
                                    ...
                                    <div class="col-md-12" style="padding: 5px">
                                        <div class="row">
                                            <label class="col-md-6">{{trans('wfact_venta.transporte')}}</label>
                                    ...
                                    <div class="col-md-12" style="padding: 5px">
                                        <div class="row">
                                            <label class="col-md-6">{{trans('wfact_venta.total')}}</label>
                ...
                <div class="col-md-12">
                    ...
                    <a href="{{ route('venta.excel', ['id' => $ventas->id]) }}" class="btn btn-primary">{{trans('wfact_venta.ver_excel')}}</a>
                </div>
                @endif
               
            </form>
            <div class="col-md-12 px-1" style="text-align:center; display: none;">
                <button type="button" class="btn btn-success btn-gray jef"> <i class="fa fa-save"></i> {{trans('wfact_venta.actualizar')}} </button>
            </div>
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if (data != "error") {
                                    ...
                                    if (data.error != "no") {
                                        swal("{{trans('wfact_venta.error')}}", data.error, "error");
                                    } else {
                                    ...
                                    swal("{{trans('wfact_venta.error')}}", "{{trans('wfact_venta.intente_nuevamente')}}", "error");
                                }
