...
@php
  ...
  $usuario_permiso = Sis_medico\Agenda_Permiso::where('id_usuario', $usuario)->where('estado', '1')->where('cierre_caja_labs', '1')->first();
@endphp
...
<section class="content">
  ...
  <div class="box" style=" background-color: white;">
    ...
    --->
        ...
        <form id="formulario_enviar" method="POST" action="{{route('c_caja.index')}}">
          {{ csrf_field() }}
          <input type="hidden" name="desdeCierre" id="desdeCierre" >
          <input type="hidden" name="hastaCierre" id="hastaCierre" >
        </form>

    @if(is_null($usuario_permiso) and $rol_usuario == '5' )
      <div class="box-body dobra">
        <form method="POST" id="reporte_master" action="{{ route('c_caja.index') }}">
          ...
          <div class="col-md-2" >
            <button type="button" class="btn btn-warning" onclick="facturar_masivo()">{{trans('contableM.Facturar')}}</button>
          </div>
          <div class="form-group col-md-2 col-xs-2">
            <a class="btn btn-primary btn-xs" onclick="factura_agrupada();">{{trans('contableM.FacturaAgrupada')}}</a>
          </div>
          <div class="form-group col-md-2 col-xs-6" >
            <button type="submit" class="btn btn-primary btn-sm" formaction="{{ route('cierrecaja.nr_cierre_laboratorio') }}" formtarget="_blank"><span class="glyphicon glyphicon-stats" aria-hidden="true"> NUEVO RPT CIERRE</button>
          </div>
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-2">
              ...
              <div class="col-md-2">
                ...
                <div class="col-md-12">
                    <input type="text" style="width: 100%;" class="form-control" name="ordenid" id="ordenid" placeholder="Ingrese # Orden" >
                </div>
              </div>
              <div class="col-md-2">
                <label class="col-md-12">{{trans('contableM.tipo')}}</label>
                <div class="col-md-12">
                  <select class="form-control" style="width: 100%;" name="facturado" id="facturado">
              ...
              <div class="col-md-2">
                <label class="col-md-12">{{trans('contableM.Seguro')}}</label>
                <div class="col-md-12">
        ...
        <div class="col-md-12">
          <div class="box box-solid">
            ...
            <div class="box-body">
                  ...
                  <div class="row">
                      <div class="form-group col-md-1">
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <span>{{number_format($datosFinalF['efectivo'],2,'.','')}}</span>
                            </div>
                          </div>
                      </div>
                       <div class="form-group col-md-1">
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <span>{{number_format($datosFinalF['cheque'],2,'.','')}}</span>
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="form-group col-md-1">
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <span>{{number_format($datosFinalF['deposito'],2,'.','')}}</span>
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="form-group col-md-1">
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <span>{{number_format($datosFinalF['transferencia'],2,'.','')}}</span>
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="form-group col-md-2">
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <span>{{number_format($datosFinalF['credito'],2,'.','')}}</span>
                            </div>
                          </div>
                      </div>
                      <div class="form-group col-md-2">
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <span>{{number_format($datosFinalF['debito'],2,'.','')}}</span>
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="form-group col-md-2">
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <span>{{number_format($datosFinalF['pendiente'],2,'.','')}}</span>
                            </div>
                          </div>
                      </div>
                      <div class="form-group col-md-1">
                          <div class="row">
                            <div class="col-md-12">
                              <label>{{trans('contableM.NoFacturados')}}</label>
                            </div>
                            <div class="col-md-12" style="background-color: red;color: white;">
                              <span >{{number_format($datosFinalF['no_facturados_cant'],2,'.','')}}</span>
                            </div>
                          </div>
                      </div>
                      <div class="form-group col-md-1">
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <span>{{number_format($datosFinalF['facturados_cant'],2,'.','')}}</span>
                            </div>
                          </div>
                      </div>
                  </div>
              ...
              >
            -->
              @if(!is_null($usuario_permiso) || $rol_usuario == '1' || $rol_usuario == '20')
                <form method="POST" >
                  {{ csrf_field() }}
                  <div class="form-group col-md-12 col-xs-12" style="margin: 5px">
                    <a class="btn btn-primary btn-xs" onclick="factura_agrupada();">{{trans('contableM.FacturaAgrupada')}}</a>
                  </div>
                  <div class="col-md-8">
                    <div class="row">
                      <div class="col-md-6">
                        <label for="ct_fecha_desde" class="col-md-12 control-label">{{trans('contableM.Desde')}}</label>
                        <div class="col-md-12">
                          <div class="input-group date col-md-12">
                            <div class="input-group-addon">
                              <i class="fa fa-calendar"></i>
                            </div>
                            <input type="text" class="form-control col-md-12" name="ct_fecha_desde" id="ct_fecha_desde" >
                            <div class="input-group-addon">
                              <i class="glyphicon glyphicon-remove-circle" onclick="document.getElementById('ct_fecha_desde').value = ''; "></i>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <label for="ct_fecha_hasta" class="col-md-12 control-label">{{trans('contableM.Hasta')}}</label>
                        <div class="col-md-12">
                          <div class="input-group date col-md-12">
                            <div class="input-group-addon">
                              <i class="fa fa-calendar"></i>
                            </div>
                            <input type="text" class="form-control col-md-12" name="ct_fecha_hasta" id="ct_fecha_hasta" autocomplete="off">
                            <div class="input-group-addon">
                              <i class="glyphicon glyphicon-remove-circle" onclick="document.getElementById('ct_fecha_hasta').value = ''; "></i>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="col-md-1">
                        <br>
                        <button class="btn btn-success" type="submit" formaction="{{route('cierrecaja.ct_reporte_cierre_excel')}}"> <i class="fa fa-file-excel-o">&nbsp;&nbsp;{{trans('contableM.excel')}}</i> </button>
                      </div>
                      <div class="col-md-1">
                        <br>
                        <button class="btn btn-success" type="submit" formaction="{{ route('cierrecaja.ct_reporte_cierre_pdf') }}" formtarget="_blank"> <i class="fa fa-file-pdf-o">&nbsp;&nbsp;{{trans('contableM.Pdf')}}</i> </button>
                      </div>
                </form>
              @endif
                </div>
                ...
                <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade active in" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="table table-responsive col-md-12">
                      <div class="content ">
                        <table id="examples2" class="compact dataTable nowrap stripe " role="grid" aria-describedby="example2_info" style="width:100%;">
                          <thead>
                            <tr>
                              <th style="width: 2%;">#</th>
                  ...
                  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="table table-responsive col-md-12">
                    <div class="content ">
                      <table id="examples3" class="compact dataTable nowrap stripe " role="grid" aria-describedby="example2_info" style="width:100%;">
                        <thead>
                          <tr>
                            <th style="width: 2%;">#</th>
                            <th style="width: 8%;" aria-controls="example2">{{trans('contableM.fecha')}}</th>
    ...
    <div class="modal fade bd-example-modal" id="modalCierre" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" id="contentCierre" role="document">
...
<script type="text/javascript">
  ...
  function facturar_masivo(){

    $.ajax({
      type: 'post',
      url: "{{ route('cierrecaja.facturar_masivo')}}",
      ...
      "columns": [{
        ...
        },
        {
          "data": function(data) {
            ...
            var c2="0";
            var c3="0";
            var url_observacion = "javascript:text_observacion(" + data.id_orden + ")";
            var observacion = '<a class="btn btn-success btn-xs" href="' + url_observacion + '"> <i class="fa fa-comment"></i>';
            ...
            if (typeof(data.orden) == 'object') {
              ...
              if (typeof(data.orden.id) == 'undefined') {
                ...
                if (data.orden.fecha_envio != null && data.orden.comprobante != null) {
                  ride=data.orden.comprobante
                  ride= ride.split('-');
                  c1= parseInt(ride[0]);
                  c2= parseInt(ride[1]);
                  c3= parseInt(ride[2]);
                  console.log(c3, ride[2]);
            ...
            if(data.facturado == "Facturado"){
              newbu = "";
            }
            console.log(data.estadoArqueo);
            if(c1!=0){
              return data.estadoArqueo === null ? ' <div style="text-align: center;"> ' + check + '  ' + newbu + '</i> </a><a class="btn btn-info btn-xs" onclick="emitir_sri(' + newfor + ')" > SRI </a> <a class="btn btn-warning btn-xs" onclick="pdf_ride(' + c1 + ','+c2+','+c3+')" > RIDE</a> ' + observacion + ' </div>' : '';
            }else{
              return data.estadoArqueo === null ? ' <div style="text-align: center;"> ' + check + '  ' + newbu + '</i> </a><a class="btn btn-info btn-xs" onclick="emitir_sri(' + newfor + ')" > SRI </a> ' + observacion + ' </div>' : '';
            }
          },
          "targets": 0,
          "orderable": false
      ...
      "footerCallback": function(row, data, start, end, display) {
        ...
        for(i=0; i<data.length; i++){
          if(data[i].facturado!='Cierre Caja'){
            ...
            total10+= parseFloat(data[i].online);
          }
        ...
        var finale = total3 + total4 + total5 + total6 + total7 + total8 + total9 + total10;
      ...
      "columns": [{
        ...
        },
        {
          "data": function(data) {
            ...
            if(c1!=0){
              return ' <div style="text-align: center;"> ' + check + '  ' + newbu + '</i> </a><a class="btn btn-info btn-xs" onclick="emitir_sri(' + newfor + ')" > SRI</a> <a class="btn btn-warning btn-xs" onclick="pdf_ride(' + c1 + ','+c2+','+c3+')" > RIDE</a> ' + observacion + ' </div>';
            }else{
              return ' <div style="text-align: center;"> ' + check + '  ' + newbu + '</i> </a><a class="btn btn-info btn-xs" onclick="emitir_sri(' + newfor + ')" > SRI</a> ' + observacion + ' </div>';
            }
  ...
  $(function() {
    ...
    $('#ct_fecha_desde').datetimepicker({
      format: 'YYYY/MM/DD',
      defaultDate: '{{$fecha}}',

    });
    $('#ct_fecha_hasta').datetimepicker({
      format: 'YYYY/MM/DD',
      defaultDate: '{{$fecha}}',
  ...
  function pdf_ride(c1,c2,c3){
    console.log(c3);
    if(c1==0){
      alert('No existe RIDE.')
    }else{
      var url="{{url('/contable/ventas/ride_pdf/')}}/"+'00'+c1+'-'+'00'+c2+'-'+ c3.toString().padStart(9, 0)+'/'+'0993075000001'+'/'+'pdf';
  ...
  function noway(e) {
      ...
      $("#desdeCierre").val($("#ct_fecha_desde").val());
      $("#hastaCierre").val($("#ct_fecha_hasta").val());
      $('#examples2').DataTable().clear().destroy();
  ...
  function bindTable() {
    ...
    var ct_fecha_desde = $('#ct_fecha_desde').val();
    var ct_fecha_hasta = $('#ct_fecha_hasta').val();
    var table = $('#examples2').DataTable({
      "searching": false,
      dom: 'lBrtip',
      paging: false,
      ...
      "ajax": "{{route('cierre_caja.getData',['fecha'=>$fecha])}}&idUser=" +user+"&ordenid="+ordenid+"&facturado="+facturado+"&idSeguro="+seguroid+"&ct_fecha_desde="+ct_fecha_desde+"&ct_fecha_hasta="+ct_fecha_hasta,
  ...
  async function text_observacion(id) {
    try {
      const { value: text } = await Swal.fire({
                      input: 'textarea',
                      inputPlaceholder: 'Ingrese observacion...',
                      inputAttributes: {
                        'aria-label': 'Ingrese observacion'
                      },
                    ...
                    if (text) {
                        $.ajax({
                          type: 'get',
                          url:"{{ url('contable/cierre_caja/observacion/')}}/"+id,
                          datatype: 'json',
                          data: {'observacion':text},
                          success: function(data){
                            Swal.fire(`{{trans('contableM.correcto')}}!`,"Observacion ingresada","success");
