<div class="modal-header">
  <h3 style="margin:0;">Ingrese Datos de Recibo</h3>
</div>
<div class="modal-body">
  <form id="frm_datos_facturas">
    <div class="box-body">
      ...
      @endphp
      <h4 style="color: red">{{trans('contableM.paciente')}} {{$orden->id_paciente}}: {{$orden->paciente->apellido1}} {{$orden->paciente->apellido2}} {{$orden->paciente->nombre1}} {{$orden->paciente->nombre2}} - Seguro: {{$orden->seguro->nombre}}</h4>
      <div class="form-group col-md-3">
          <label for="cedula_factura" class="control-label">{{trans('contableM.Documento')}}</label>
      ...
      <div class="form-group col-md-6">
          <label for="nombre_factura" class="control-label">{{trans('contableM.nombre')}}</label>
      ...
      <!--Direccion-->
        <div class="form-group col-md-3">
          <label for="direccion_factura" class="control-label">{{trans('contableM.direccion')}}</label>
        ...
        <!--ciudad-->
        <div class="form-group col-md-3">
            <label for="ciudad_factura" class="control-label">{{trans('contableM.ciudad')}}</label>
        ...
        <!--email-->
        <div class="form-group col-md-6">
            <label for="email_factura" class="control-label">{{trans('contableM.email')}}</label>
        ...
        <div class="form-group col-md-12" style="text-align: center;">
          <button type="button" class="btn btn-info" id="boton_sri" onclick="return alert('enviar')"> <i class="fa fa-save"></i> </button>
        </div>
    </div>
  </form>
</div>
