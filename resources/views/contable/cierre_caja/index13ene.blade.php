      ...
      "columns": [{
        ...
        },
        {
          "data": function(data) {
            ...
            if(c1!=0){
              return ' <div style="text-align: center;"> ' + check + '  ' + newbu + '</i> </a><a class="btn btn-info btn-xs" onclick="emitir_sri(' + newfor + ')" > SRI</a> <a class="btn btn-warning btn-xs" onclick="pdf_ride(' + c1 + ','+c2+','+c3+')" > RIDE</a>  </div>';
            }else{
