...
<div class="box">
<div class="box-header"><h3 class="box-title">Editar Transportista</h3>
        </div>
    <form id="editar_plantilla" method="post" action="{{route('transportistas.update')}}">
        ...
        <div class="box-body">
            <div class="form-group col-xs-6{{ $errors->has('id_empresa') ? ' has-error' : '' }}">
                ...
                <input type="text" name="id_empresa" size="20" class="form-control" value="{{$mantenimientos_transportistas->id_empresa}}" required maxlength="100">
            </div>
        </div>
        ...
        <div class="box-body">
            <div class="form-group col-xs-6">
                ...
                <input id="entidadLogo" name="entidadLogo" type="file" class="ruta_logo form-control" size="20" class="form-control" value="{{$mantenimientos_transportistas->logo}}" required maxlength="100">
        ...
        <!--<div class="box-body">
                    <div class="form-group col-xs-6">
                        <label for="identificacion" class="col-md-20 control-label">Editar Identificación</label>
                        <input type="text" name="identificacion" size="20" class="form-control" value="{{$mantenimientos_transportistas->identificacion}}" required maxlength="100">
                    </div>
                </div>-->
        ...
        <div class="form-group">
            <div class="col-md-6 col-md-offset-4">
                <button type="submit" name="btnFalla" id="btnFalla" class="btn btn-primary">
                    Actualizar
                </button>
            </div>
        </div>
