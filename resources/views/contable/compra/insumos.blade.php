...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="../ventas">Registro de Factura de Insumos</a></li>
...
<div class="box">
    <div class="box-header header_new">
        <div class="col-md-9">
            <h3 class="box-title">Nueva Factura de Insumos</h3>
        </div>
...
<div class="box-body dobra">
    <form class="form-vertical" method="post" action="{{route('insumos_search')}}" id="form">
        ...
        <div class="header row">
            ...
            <div class="form-group col-xs-6  col-md-2  px-1">
                <div class="col-md-12 px-0">
                    <label for="fecha_desde" class="label_header">Desde</label>
                </div>
                <div class="col-md-12 px-0">
            ...
            <div class="form-group col-xs-6  col-md-2  px-1">
                <div class="col-md-12 px-0">
                    <label for="fecha_hasta" class="label_header">Hasta</label>
                </div>
                <div class="col-md-12 px-0">
                    <div class="input-group date">
                        <div class="input-group-addon">
            ...
            <div class="form-group col-xs-6  col-md-2  px-1">
                <div class="col-md-12 px-0">
                    <label for="id_seguro" class="label_header">Seguro</label>
                </div>
                <div class="col-md-12 px-0">
            ...
            <div class="form-group col-xs-6  col-md-2  px-1">
                <div class="col-md-12 px-0">
                    <label for="tipo_servicio" class="label_header">Tipo Servicio</label>
                </div>
                <div class="col-md-12 px-0">
                    <select class="form-control" name="tipo_servicio" id="tipo_servicio" required>
                        <option @if(($tipox)==1) selected="selected" @endif value="1">Consulta</option>
                        <option @if(($tipox)==2) selected="selected" @endif value="2">Procedimiento</option>
            ...
            <div class="form-group col-xs-6 col-md-2 px-1">
                <label class="label_header">Identificación Paciente</label>
                <input type="text" class="form-control" name="identificacion_paciente" id="identificacion_paciente" placeholder="Ingrese CI: ">
            </div>
            <div class="form-group col-md-1 col-xs-2" >
                <button type="button" class="btn btn-primary btn-sm search"  id="boton_buscar" style="margin-top:10px">
                <span class="glyphicon glyphicon-search" aria-hidden="true"></span> Buscar</button>  
            </div>
            @if(!is_null($ordenes))
            <div class="form-group col-md-1 col-xs-2" >
                <button type="button" class="btn btn-primary btn-sm"  id="butonexcel" onclick="excelPreview()" style="margin-top:10px">
                <span class="glyphicon glyphicon-pdf" aria-hidden="true"></span> Preview Excel</button>  
            </div>
            @endif
        ...
        <div class="col-md-12" id="items" style=" height: 300px; overflow-y: scroll;" >
            @if(isset($searchinsumos))
                        ...
                        @if(($ordenes)!="")
                            ...
                            @foreach($ordenes as $x)
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading"><input type="checkbox" name="activo[]" value="1" class="relactivo" checked />
                                        <input type="hidden" name="veractivo[]" class="veractivo" value="1">
                                        <input type="hidden" name="pacientex[]" value="{{$x->id_paciente}}">
                                        <input type="hidden" name="id_orden[]" value="{{$x->id}}" >
                                        {{$x->nombres_paciente}}   - {{$x->fecha}}
                                                        ...
                                                        @if(isset($x->detalles))
                                                            ...
                                                            @foreach($x->detalles as $z)
                                                                ...
                                                                <tr  id="mifila">
                                                                    ...
                                                                    <input type="hidden" name="nombre[]" class="codigo_producto" />
                                                                        <select name="codigo[]" class="form-control select2" style="width:95%; height:20px;" required onchange="verificar(this)" >
                                                                            ...
                                                                            @foreach($productos as $value)
                                                                                ...
                                                                                <option @if(($tipox)==1) @if(($value->codigo)==($z->id_ct_productos)) selected="selected" @endif @endif value="{{$value->codigo}}" data-name="{{$value->nombre}}" data-codigo="{{$value->nombre}}" data-descuento="{{$value->mod_desc}}"  data-precio="{{$value->mod_precio}}" data-maxdesc="{{$value->descuento}}"  data-iva="{{$value->iva}}">{{$value->codigo}} | {{$value->descripcion}}</option>
                                                                            @endforeach
                                                                    ...
                                                                    <td>
                                                                        <input class="form-control text-right cneto" type="text" style="width: 80%;height:20px;" onkeypress="return isNumberKey(event)" onblur="this.value=parseFloat(this.value).toFixed(0);" name="cantidad[]" value="@if(!is_null($z->cantidad)) {{$z->cantidad}} @endif" required >
                                                                    </td>
                                                                    <td>
                                                                     
                                                                        <select  name="precio[]" class="form-control select2_precio pneto" style="width:70%;display:inline;" required  >
                                                                        
                                                                        <option @if(($z->precio)>0) selected="selected" @endif value="{{number_format($z->copago,2,'.','')}}">{{number_format($z->copago,2,'.','')}}</option>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input class="form-control text-right copago" type="text" style="width: 80%;height:20px;" onkeypress="return isNumberKey(event)" onblur="this.value=parseFloat(this.value).toFixed(2);"  value="0" name="copago[]" readonly>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input class="form-control px-1 text-right" type="text" style="height:20px;" onkeypress="return isNumberKey(event)"  onblur="this.value=parseFloat(this.value).toFixed(2);" name="precioneto[]" value="@if(!is_null($z->copago)){{number_format($z->copago,2,'.','')}}@endif" required>
                                                                    </td>
                                                                    <td>
                                                                        <input class="form" type="checkbox" @if($z->check_iva>0) selected="selected" @endif style="width: 80%;height:20px;"  name="valoriva[]" value="@if($z->check_iva!=null){{$z->check_iva}}@endif" disabled>
...
//precioneto
    ...
    function totales(e){
        ...
        if(e==0){
            $('.cneto').each(function(i, obj) {
            var cant = $(this).val();
            var e = $(this).parent().prev().children().closest(".select2");
            var precio1 = 0;
            var precio2 = 0;
            var precio3 = 0;
            var precio4 = 0;
            ...
            //console.log("totales");
            //console.log(precio, copago, descuento, iva);
            var total = (parseInt(cant)* parseFloat(precio))-parseFloat(0)-parseFloat(copago);
            if(iva == 1){
                subt12.push(total);
                sb12 = sb12+ total;
    ...
    $('.search').click(function(){
        ...
        var mydata= {finicio:desde , ffin: hasta, seguro: seguro, tipo: tipo};
            $.ajax({
                type: 'post',
                url:"{{route('insumos_search')}}",
                headers:{'X-CSRF-TOKEN':$('input[name=_token]').val()},
                datatype: 'json',
                data: {finicio:desde , ffin: hasta, seguro: seguro, tipo: tipo},
                success: function(data){
                    ...
                    if(tipo == 2){
                        ...
                        var n = 0;
                        if(data[0].length==[]){
                            $("#items").append("<div class='title'>No hay resultados</div>");
                            }
                        data[0].forEach(function(dat){
                            
                            console.log("dat", dat.fechaini);
                            
                            var nombre = dat.nombre1+ " "+ dat.nombre2+" "+ dat.apellido1+ " "+dat.apellido2;
                            var it = nuevoItem(nombre, data[1][n], dat.id_hc_procedimientos);
                            $("#items").append(it);
                        ...
                        $("#items").html("");
                        console.log("conglomerado de consultas");
                        var it = consultas();
                        //console.log(data[0][0].length);
                       
                        if(data[0][0]!=0){
                            $("#items").append(it);
                           // $("#items").find('option[data-name="CONSULTA"]').attr('selected', 'selected').change();
                           console.log("estoy aqui");
                           console.log($("#items").last().find('.select2').find('option[data-name="CONSULTA"]').attr('selected', 'selected').change());
                            //$("#items").last().find('.select2').find('option[value="CONSULTA"]').attr('selected', 'selected').change();
                            $("#items").last().find('.select2').each(function() {
                                console.log($(this));
                                $(this).find('option[value="CONSULTA"]').attr('selected', 'selected').change()
                                //console.log($(this).find('option[value="'+arr[n]+'"]'));
                                //n++;
                            });
                            $("#items").find(".cneto").val(1);//data[0][0].length
                            $("#items").find(".cneto").attr('readonly','readonly');
                            var ids_consulta = "";
                            var valor = 0;
                            data[0][0].forEach(function(dat){
                                ids_consulta += "<input type='hidden' value='"+dat.hc_id_procedimiento+"' name='id_hc_consulta[]'/> ";
                                ids_consulta += "<input type='hidden' value='"+dat.valor_oda+"' name='id_hc_consulta[]'/> ";
                                var vl = dat.valor_final != null  ? dat.valor_final : 0; 
                                valor = valor + parseFloat(vl);

                            });
                            var html = '<input type="text" class="form-control pneto" onblur="this.value=parseFloat(this.value).toFixed(2);" value="'+valor+'" name="precio[]" style="width:40%;display:inline;height:20px;" readonly>'+
                                        '<button type="button" class="btn btn-info btn-gray btn-xs cp" disabled>'+
                                        '<i class="glyphicon glyphicon-pencil" aria-hidden="true"></i>'+
                                        '</button>';
                            $("#items").find(".pneto").parent().html(html);
                            $("#items").append(ids_consulta);
                            //console.log("mydata",mydata);
                            var html2 =  '<tr ><td colspan="9" class="well" id="datos"><button type="button" id="preview" class="btn btn-success btn-gray btn-sm ">'+
                                        'Ver datos'+
                                        '</button></td></tr>';
                            $("#items").find(".well").parent().append(html2);
                        }else{
                            $("#items").append("<div class='title'>No hay resultados</div>");
                        }
    ...
    function consultas(){
        ...
        var html = '<div class="panel panel-default">'+
                ...
                '<thead><tr class="well-dark"><th width="35%" class="" tabindex="0">Descripci&oacute;n del Producto</th>'+
                '<th width="10%" class="" tabindex="0">Cantidad</th><th width="10%" class="" tabindex="0">Precio</th>'+
                '<th width="10%" class="" tabindex="0">Cobrar Seguro</th><th width="10%" class="" tabindex="0">% Desc</th>'+
                '<th width="10%" class="" tabindex="0">Descuento</th><th width="10%" class="" tabindex="0">Precio Neto</th>'+
                '<th width="5%" class="" tabindex="0">IVA</th><th width="10%" class="" tabindex="0">'+
    ...
    $('#btn_pago').click(function(event){
        ...
        '<td width="10%"><div><input class="form-control text-right input-number fpago" type="text" id="valor'+id+'" name="valor[]"  onkeypress="return isNumberKey(event)" onblur="this.value=parseFloat(this.value).toFixed(2);" onchange="return redondea_valor(this,'+id+',2);" onkeyup="suma_valor_forma_pago()"></div></td>'+
   ...
   /* function obtener_num_factura(){
    ...
    function excelPreview(){
        ...
        url="{{ url('contable/venta/previewExcelx/')}}/"+fechaini+"/"+fechafin+"/"+seguro+"/"+tipo+"/"+id_empresa;
