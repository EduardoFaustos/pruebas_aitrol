                    ...
                    <div class="col-md-12">
                        <div class="header row">
                            <div class="col-md-2 col-xs-2  px-1">
                                <label class=" label_header">{{trans('contableM.buscarpedido')}}</label>
                            ...
                            <div class="col-md-2 col-xs-2  px-1">
                                <label class=" label_header">{{trans('contableM.busquedafacturacompra')}}</label>
                                <div class="input-group">
                    ...
                    <div class="col-md-12">
                        <div class="row  ">
                            ...
                            <div class="col-md-12 col-xs-12 col-12 px-0">
                                <label for="id_empresa" class=" label_header">{{trans('contableM.empresa')}}</label>
