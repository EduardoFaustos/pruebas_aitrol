  ...
  <div class="box dobra" style=" background-color: white;">
    ...
    <div class="box-body " >
      <form   method="POST" id="reporte_master" action="{{ route('compras.informe') }}">
        ...
        <div class="form-group col-md-4 col-xs-4 container-4">
          <input class="form-control" type="text" id="secuencia_f" name="secuencia_f" placeholder="Ingrese Secuencia..." />
        </div>
    ...
    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="col-md-4">
            <h4 style="text-align: center;">{{trans('contableM.informecomprainventario')}}</h4>
            ...
            <table id="example2" class="display compact" role="grid" aria-describedby="example2_info" style="font-size: 12px; text-align:center; width:100%;">
              <thead>
                <tr>
                  ...
                  <th  style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.numero')}}</th>
                  ...
                  <th  style="text-align:center;" tabindex="0" aria-controls="example2" colspan="1">{{trans('contableM.tipocomprobante')}}</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align:left;">{{$value->proveedor}}</td>
                  <td style="text-align:left;"> @if(($value->proveedorf!=null)) {{$value->proveedorf->nombrecomercial}} @endif </td>
