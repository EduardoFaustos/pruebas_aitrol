...
<body>
        ...
        <td class="info_nota">
          <div class="round">
            ...
            <p style="padding-left: 10px;font-size: 0.6em">
              <strong>No.:</strong>&nbsp;{{$nota_debito->numero}}<br/>
                ...
                <tr>
                  <td>
                    ...
                    <div class="row">
                      ...
                      <div class="mValue">
                      {{$nota_debito->venta->nro_comprobante}}
                      </div>
                    </div>
                    <div class="row">
                      <div class="mLabel3">
    ...
    <table id="factura_detalle"  cellpadding="0">
      <thead>
        <tr>
          ...
          <th style="font-size: 16px"><div class="details_title_border_right">Precio Total</div></th>
        </tr>
      </thead>
  ...
  <div id="page_pdf2" style="float: left;">
    ...
    <table id="factura_detalle" border="0"  cellpadding="0">
      <thead>
        <tr>
          <th style="font-size: 16px"><div class="details_title">Código Principal</div></th>
          <th style="font-size: 16px"><div class="details_title">{{trans('contableM.cantidad')}}</div></th>
