...
<section class="content">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Visualizador Cruce de Cuentas</li>
        </ol>
    </nav>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6 col-sm-9 col-6">
                            <div class="box-title"><b>Visualizador Cruce de Cuentas</b></div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                 <a class="btn btn-success btn-gray " data-remote="{{ route('compras.modal_estado',[$cruce->id_asiento_cabecera])}}" class="btn btn-info btn-sm" data-toggle="modal" data-target="#visualizar_estado">
                                       <i class="glyphicon glyphicon-eye-open"  aria-hidden="true"></i>&nbsp;&nbsp;{{trans('contableM.visualizarasiento')}}
                                    </a>
                                    <a class="btn btn-success btn-gray" style="margin-left: 3px;" href="{{route('librodiario.edit',['id'=>$cruce->id_asiento_cabecera])}}" target="_blank">
                    ...
                    <div class="col-md-12 px-1">
                        <div class="form-row ">
                            ...
                            <div class=" col-md-2 px-1">
                                ...
                                <input style="background-color: {{ $cruce->estado == 1 ? 'green' : 'red' }}" readonly class="form-control col-md-1">
                            </div>
                            <div class=" col-md-2 px-1">

                                <label class="col-md-12 label_header" for="id_factura">{{trans('contableM.id')}}:</label>
                                <input class="form-control" type="text" name="id_factura" id="id_factura" value="{{$cruce->id}}" readonly>

                            </div>
                            <div class=" col-md-2 px-1">

                                <label class="label_header" for="numero_factura">{{trans('contableM.numero')}}</label>
                                <input class="form-control" type="text" id="numero_factura" name="numero_factura" value="{{$cruce->id}}" readonly>
                            ...
                            <div class=" col-md-2 px-1">
                                ...
                                <input class="form-control" type="text" id="asiento" name="asiento" value="{{$cruce->id_asiento_cabecera}}" readonly>
                            ...
                            <div class=" col-md-2 px-1">
                                ...
                                <input class="form-control" type="date" name="fecha_hoy" id="fecha_hoy" value="{{$cruce->fecha}}" readonly>
                        ...
                        <div class="form-row " id="no_visible">
                            <div class="col-md-6 px-1">
                                ...
                                <input class="form-control col-md-12" autocomplete="off" type="text" value="{{$cruce->detalle}}" name="concepto" id="concepto" readonly>
                            </div>
                            <div class="col-md-4 col-xs-4 px-1">
                                <label class="control-label label_header">{{trans('contableM.FacturaId')}}</label>
                                <select class="select2 form-control" style="width: 100%;" onchange="traer_valor(this)" name="id_facturas" id="id_facturas" disabled>
                                    <option value="">Seleccione..</option>
                                    @foreach($facturas as $value)
                                    <option value="{{$value->id}}" @if(($value->id)==$cruce->id_factura) selected="selected" @endif data-observacion="{{$value->observacion}}" data-codigo="{{$value->id}}"> C: {{$value->observacion}} - #: {{$value->id}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-2 px-1">
                                <label class="control-label label_header">{{trans('contableM.Informacion')}}</label>
                                <input class="form-control" type="text" name="infox" id="infox" value="{{$cruce->total}}" readonly> 
                            </div>
                            {{--  
                            <div class=" col-md-6 px-0">
                                <label class="col-md-12 label_header" for="nombre_cliente">{{trans('contableM.proveedor')}}</label>
                                <select class="form-control select2" name="id_proveedor" style="width: 100%;" id="id_proveedor" readonly>
                                    <option value="">Seleccione...</option>
                                    @foreach($proveedores as $value)
                                    <option @if(($cruce->id_proveedor)==$value->id) selected="selected" @endif value="{{$value->id}}">{{$value->nombrecomercial}}</option>
                                    @endforeach
                                </select>
                            </div>
                            --}}
                            ...
                            <table id="example3" role="grid" aria-describedby="example2_info" style="width: 100%;">
                                <thead style="background-color: #9E9E9E; color: white;">
                                    <tr>
                                        ...
                                        <th >{{trans('contableM.TotalBase')}}</th>
                                        
                                    </tr>
                                </thead>
                                <tbody id="det_recibido">
                                {{--$cruce->detalles--}}
                                    @foreach($cruce->detalles as $value)
                        ...
                        <div class="col-md-12"> 
                            <div class="row">
                                ...
                                <div class="col-md-2 px-1">
                                    ...
                                    <input class="form-control  col-md-12" value="{{$cruce->total}}" type="text" name="total" id="total" readonly>
                                </div>
                            </div>
                        </div>
