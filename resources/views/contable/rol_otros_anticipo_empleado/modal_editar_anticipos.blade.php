...
<div class="modal-content" style="width: 100%;">
  ...
  @php
    ...
    $forma_pago = Sis_medico\Ct_Rh_Tipo_Pago::all();
  @endphp
  <div class="box-body dobra ">
    <form id="ver_otros_anticipo" method="get">
      ...
      <div class="form-group col-xs-6">
        ...
        <select name="anio_pmes_cobro" class="form-control">
      ...
      <div class="form-group col-xs-6">
        ...
        <select name="pmes_cobro" class="form-control">
      ...
      <div class="form-group col-xs-6">
        ...
        <!--select name="tipo_pago" class="form-control">
          <option value="1">ACREDITACION</option>
          <option value="2">{{trans('contableM.Efectivo')}}</option>
          <option value="3">{{trans('contableM.cheque')}}</option>
        </select-->
        <select name="tipo_pago" class="form-control">
      ...
      <div id="num_cuenta" class="form-group col-xs-6">
        <label for="numero_cuenta" class="col-md-4 texto">N# CTA BENEFICIARIO O CHEQUE(COBRA)</label>
        <div class="col-md-7">
  ...
  <!--div  class="modal-footer" style ="text-align: center">
   ...
   <div  class="modal-footer" style ="text-align: center">
    <button type="button" class="btn btn-primary" data-dismiss="modal">{{trans('contableM.guardar')}}</button>
...
<script type="text/javascript">
  ...
  function obtener_seleccion() {
    ...
    //var id_tipo = document.getElementById("tipo_pago").value;
