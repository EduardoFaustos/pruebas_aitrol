	...
	<form class="form-vertical" role="form" method="POST" action="{{ route('empresa.update', ['id' => $empresa->id]) }}">
                    <div class="box-body">
                        ...
                        <div class="form-group col-xs-6{{ $errors->has('id') ? ' has-error' : '' }}">
                            <label for="id" class="col-xs-6 control-label">{{trans('contableM.ruc')}}</label>
                        ...
                        <div class="form-group col-xs-6{{ $errors->has('razonsocial') ? ' has-error' : '' }}">
                            <label for="razonsocial" class="col-xs-6 control-label">{{trans('contableM.razonsocial')}}</label>
                        ...
                        <div class="form-group col-xs-6{{ $errors->has('nombrecomercial') ? ' has-error' : '' }}">
                            <label for="nombrecomercial" class="col-xs-8 control-label">{{trans('contableM.nombrecomercial')}}</label>
                        ...
                        <div class="form-group col-xs-6{{ $errors->has('ciudad') ? ' has-error' : '' }}">
                            <label for="ciudad" class="col-xs-6 control-label">{{trans('contableM.ciudad')}}</label>
                        ...
                        <div class="form-group col-xs-6{{ $errors->has('direccion') ? ' has-error' : '' }}">
                            <label for="direccion" class="col-xs-6 control-label">{{trans('contableM.direccion')}}</label>
                        ...
                        <div class="form-group col-xs-6{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-xs-6 control-label">{{trans('contableM.email')}}</label>
                        ...
                        <div class="form-group col-xs-6{{ $errors->has('telefono1') ? ' has-error' : '' }}">
                            <label for="telefono1" class="col-xs-8 control-label">{{trans('contableM.telefonodomicilio')}}</label>
                        ...
                        <div class="form-group col-xs-6{{ $errors->has('telefono2') ? ' has-error' : '' }}">
                            <label for="telefono2" class="col-xs-6 control-label">{{trans('contableM.telefonocelular')}}</label>
                        ...
                        <div class="form-group col-xs-6{{ $errors->has('estado') ? ' has-error' : '' }}">
                            ...
                            <option {{$empresa->estado == 0 ? 'selected' : ''}} value="0">{{trans('contableM.inactivo')}}</option>
                            <option {{$empresa->estado == 1 ? 'selected' : ''}} value="1">{{trans('contableM.activo')}}</option>
