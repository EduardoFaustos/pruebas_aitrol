...
<script type="text/javascript">
    ...
    $('#btn_procedimiento').click(function(event){
        ...
        var txt_td = '<td id="n'+id+'" style="display: none;"><input type="text" name="nomb_deducible'+id+'" id="nomb_deducible'+id+'" value="Deducible" style="width:100%;text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></td>';
        txt_td = txt_td +'<td id="c_d'+id+'" style="display: none;"><input type="text" name="cantidad_deducible'+id+'" id="cantidad_deducible'+id+'" value="1" style="width:90%;text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></td>';
        txt_td = txt_td +'<td id="p_d'+id+'" style="display: none;"><input type="text" name="precio_deducible'+id+'" id="precio_deducible'+id+'" value="0.00"   onchange="revision_total_pro('+id+')" style="width:90%;text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></td>';
        txt_td = txt_td + '<td id="ps_d'+id+'" style="display: none;"><select id="porcent_seg_de'+id+'" name="porcent_seg_de'+id+'" readonly="readonly"><option value="%">%</option><option value="$">$</option></select></td>';
        txt_td = txt_td + '<td id="cp_d'+id+'" style="display: none;"><input type="text" name="cob_pac_deducible'+id+'" id="cob_pac_deducible'+id+'" value="0.00" style="width:100%;" readonly="readonly"></td>';
        txt_td = txt_td + '<td id="ps_d2'+id+'" style="display: none;"><select id="porcent_desc_de'+id+'" name="porcent_desc_de'+id+'" readonly="readonly"><option value="%">%</option><option value="$">$</option></select></td>';
        txt_td = txt_td + '<td id="desc_d'+id+'" style="display: none;"><input type="text" name="descuento_deducible'+id+'" id="descuento_deducible'+id+'" value="0.00" style="width:100%;" readonly="readonly"></td>';
        txt_td = txt_td + '<td id="iva_d'+id+'" style="display: none;"><input required style="text-align:center;" type="checkbox" name="iva_item_ded'+id+'" id="iva_item_ded'+id+'" value="1" readonly="readonly"></td>';
        txt_td = txt_td +'<td id="n_d'+id+'" style="display: none;"><input type="text" id="neto_deducible'+id+'" name="neto_deducible'+id+'" style="width:85%;" onkeypress="return soloNumeros(event);" onchange="return redondea_valor_base(this,'+id+',2);" readonly="readonly"></td>';
...
<script type="text/javascript">    
    ...
    function revision_total_pro(id){
        ...
        var cant_ded  = $('#cantidad_deducible'+id).val();
        var precio_ded  = $('#precio_deducible'+id).val();
        var neto_ded = cant_ded*precio_ded;

        if(isNaN(neto_ded)){
            neto_ded = 0;
        }
        $('#neto_deducible'+id).val(neto_ded);
