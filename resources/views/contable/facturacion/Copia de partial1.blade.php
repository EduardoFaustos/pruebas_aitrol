...
<script type="text/javascript">
    ...
    $('body').on('change', '.cneto', function() { 
        ...
        var desc_porc = $(this).parent().next().next().children().val();
        var desc = $(this).parent().next().next().next().children().val();
        var total = (parseInt(cant) * (precio));
        if (desc_porc!=0 && total!=0) {
            descuento = (total * desc_porc) / 100;
        } else {
            descuento = desc;
        }
        if (total!=0) {
        ...
        // console.log(total);
        $(this).parent().next().next().next().next().children().val(total.toFixed(2, 2)); 
        // totales(0); 
        calcular_total();
    }); 
    $('body').on('change', '.pneto', function() { 
        ...
        var desc_porc = $(this).parent().next().children().val();
        var desc = $(this).parent().next().next().children().val();
        var total = (parseInt(cant) * (precio)); 
        if (desc_porc!=0 && total!=0) {
            descuento = (total * desc_porc) / 100;
        } else {
        ...
        var total = ((parseInt(cant) * (precio)) - descuento);
        // console.log(total);
        $(this).parent().next().next().next().children().val(total.toFixed(2, 2)); 
        // totales(0);
        calcular_total();
    });
    ...
    $('body').on('change', '.pdesc', function() { 
        ...
        var descuento = 0;
        var desc = 0;
        var desc_porc = $(this).val();
        $(this).parent().next().children().val("0.00");  
        ...
        // console.log(total);
        $(this).parent().next().next().children().val(total.toFixed(2, 2)); 
        // totales(0);
        calcular_total();
    });
    ...
    $('body').on('change', '.desc', function() { 
        ...
        var desc_porc = 0;
        var desc = $(this).val();
        $(this).parent().prev().children().val("0.00");  
        ...
        // console.log(total);
        $(this).parent().next().children().val(total.toFixed(2, 2)); 
        // totales(0);
        console.log('ccalcular total');
        calcular_total();
    });
    ...
    function calcular_total() {  
        ...
        $('#agregar_cuentas tr').each(function () {  
            ...
            var desc_porc = $(this).find("td").eq(3).children().val(); 
            var desc = $(this).find("td").eq(4).children().val(); 
            // var total = $(this).find("td").eq(5).children().val(); 
            var total = (parseInt(cant) * (precio)); 
            $(this).find("td").eq(5).children().val(total.toFixed(2,2));  
            var por_seg = $(this).find("td").eq(6).children().val();
            var por_pac = $(this).find("td").eq(7).children().val(); 
            var deducible = $(this).find("td").eq(8).children().val();  
            var fee = $(this).find("td").eq(9).children().val();   
            ...
            if (por_seg!=0&&por_pac!=0&&oda=='si'&&num_oda!="") {
                if (id_seguro==4) {
                    console.log("Humana"); 
                    if (total==0) {
                        $(this).find("td").eq(10).children().val('0.00');  
                        $(this).find("td").eq(11).children().val('0.00');  
                    } else {
                        ...
                        $(this).find("td").eq(10).children().val(total_pag_pac.toFixed(2,2)); // pagar_paciente
                        $(this).find("td").eq(11).children().val(total_pag_seg.toFixed(2,2)); // pagar_seguro 
                    }
                ...
                $(this).find("td").eq(8).children().val("0.00"); // deducible
                $(this).find("td").eq(9).children().val("0.00"); // fee
                $(this).find("td").eq(10).children().val("0.00"); // pagar_paciente
                $(this).find("td").eq(11).children().val("0.00");  // pagar_seguro
            } 
