@extends('contable.rol_anticipo_funcionario.base')
  ...
  <section class="content">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Anticipos Funcionarios</li>
      </ol>
    </nav>
    <div class="box">
      <div class="row head-title">
        <div class="col-md-12 cabecera">
            <label class="color_texto" for="title">ANTICIPOS FUNCIONARIOS</label>
        </div>
      </div>
      <!-- /.box-header -->
