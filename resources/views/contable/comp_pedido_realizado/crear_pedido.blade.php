    ...
    <section class="content">
      <div class="box">
        <div class="box-header">
          <div class="row">
              <div class="col-sm-4">
                <h3 class="box-title">{{trans('contableM.IngresoaBodegadeProducto')}}</h3>
              </div>
          ...
          <form method="POST" id="ingreso">
              <div class="box box-default">
                <div class="box-header with-border">
                  <h3 class="box-title">{{trans('contableM.Ingresodeproducto')}}</h3>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                          <label for="inputid" class="col-sm-3 control-label">{{trans('contableM.codigo')}}</label>
                          <div class="col-sm-9">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                          <label for="inputapellido" class="col-sm-3 control-label">{{trans('contableM.nombre')}}</label>
                          <div class="col-sm-9">
              ...
              <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="fecha" class="col-md-4 control-label">{{trans('contableM.fechapedido')}}</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group cl_pedido col-md-6 {{ $errors->has('pedido') ? ' has-error' : '' }}">
                        <label for="pedido" class="col-md-4 control-label">{{trans('contableM.Numerodepedido')}}</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group cl_pedido col-md-6 {{ $errors->has('num_factura') ? ' has-error' : '' }}">
                        <label for="num_factura" class="col-md-4 control-label">{{trans('contableM.Numerodefactura')}}</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group col-md-6{{ $errors->has('id_proveedor') ? ' has-error' : '' }}">
                        <label for="id_proveedor" class="col-md-4 control-label">{{trans('contableM.proveedor')}}</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group col-md-6{{ $errors->has('id_proveedor') ? ' has-error' : '' }}">
                        <label for="tipo_" class="col-md-4 control-label">{{trans('contableM.tipo')}}</label>
                        <div class="col-md-8">
                          <select name="tipo_" class="form-control select2 " style="width: 100%;" required="" name="tipo_">
                              <option value="">Seleccione..</option>
                              <option value="1">{{trans('contableM.GuiadeRemision')}}</option>
                              <option value="2">{{trans('contableM.FacturaContraEntrega')}}</option>
                    ...
                    <div class="form-group col-md-6{{ $errors->has('id_empresa') ? ' has-error' : '' }}">
                        <label for="id_empresa" class="col-md-4 control-label">{{trans('contableM.empresa')}}</label>
                        <div class="col-md-8">

                        <input readonly type="text" class="form-control" name="empresa" value="{{$empresa->nombrecomercial}}">
                    ...
                    <div class="form-group  col-md-12 {{ $errors->has('observaciones') ? ' has-error' : '' }}">
                        <label for="observaciones" class="col-md-2 control-label">{{trans('contableM.observaciones')}}</label>
                        <div class="col-md-10">
              ...
              <div class="box-body">
                <div class="table-responsive col-md-12">
                  ...
                  <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                    <thead>
                      <tr role="row">
                         <th width="7.69%" class="" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Codigo: activate to sort column ascending">{{trans('contableM.codigo')}}</th>
                        <th width="7.69%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Nombre: activate to sort column descending" aria-sort="ascending">{{trans('contableM.nombre')}}</th>
                        <th width="7.69%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Cantidad: activate to sort column descending" aria-sort="sorting">{{trans('contableM.cantidad')}}</th>
                        <th width="7.69%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Serie: activate to sort column descending" aria-sort="sorting">{{trans('contableM.serie')}}</th>
                        ...
                        <th width="7.69%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Bodega: activate to sort column ascending">{{trans('contableM.Bodega')}}</th>
                        <th width="7.69%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Serie: activate to sort column descending" aria-sort="sorting">{{trans('contableM.Lote')}}</th>
                        <th width="7.69%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Serie: activate to sort column descending" aria-sort="sorting">{{trans('contableM.RegistroSanitario')}}</th>
                        <th width="12.69%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Fecha de Vecimiento: activate to sort column ascending">{{trans('contableM.FechadeVecimiento')}}</th>
                        ...
                        <th width="7.69%%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Fecha de Vecimiento: activate to sort column ascending">{{trans('contableM.preciounitario')}}</th>
                        <th width="7.69%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Fecha de Vecimiento: activate to sort column ascending">{{trans('contableM.PrecioFinal')}}</th>
                        <th width="7.69%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Consecion: activate to sort column ascending">{{trans('contableM.Consecion')}}</th>
                        <th width="2.69%" tabindex="0" aria-controls="example2" rowspan="1" colspan="2" aria-label="Action: activate to sort column ascending">{{trans('contableM.accion')}}</th>
                    ...
                    <tfoot>
                      <tr>
                        <td colspan="9"></td>
                        <td>{{trans('contableM.subtotal12')}}</td>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function()
    {
      ...
      $("#codigo").change( function(){
          $.ajax({
            type: 'GET',
            url:"{{route('pedido_realizados.codigo2')}}",
