      ...
      {{ csrf_field() }}
        ...
        <div class="box">    
            <div class="box-header color_cab">
              <div class="col-md-9">
                <h5><b>DETALLE TIPO AMBIENTE</b></h5>
              </div>
            ...
            <div class="box-body dobra">
              ...
              <div class="form-group  col-xs-6">
                ...
                <div class="col-md-7">
                  <input id="tipo_ambiente" name="tipo_ambiente" type="text" class="form-control" value="@if(!is_null($tip_ambiente)){{$tip_ambiente->tipo_ambiente}}@endif" autocomplete="off" required autofocus>
                </div>
              </div>
              ...
              <div class="form-group  col-xs-6">
                ...
                <div class="col-md-7">
                    <input id="cod_tip_ambiente" name="cod_tip_ambiente" type="text" maxlength="1" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="@if(!is_null($tip_ambiente)){{$tip_ambiente->codigo}}@endif"  autocomplete="off" required autofocus>
                </div>
              </div>
