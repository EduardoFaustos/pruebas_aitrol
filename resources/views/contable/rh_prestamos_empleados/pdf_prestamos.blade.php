...
<head>
    ...
    <title>Comprobante de Prestamos</title>
    <style type="text/css">
            ...
            <table id="factura_head" class="bordes_padding">
                <tr>
                    ...
                    <td class="info_factura">
                        <div>
                            <span class="h3" style="padding:20px">COMPROBANTE DE EGRESO (PRESTAMO)</span>
                            <p style="padding-left: 10px;font-size: 20px; text-align: center;">
                                No: <strong> {{$prest_empleado->secuencia}}</strong><br />

                                <strong>POR $***********{{$prest_empleado->monto_prestamo}}</strong>
                            </p>
                        </div>
                    </td>
                </tr>
                                        ...
                                        <td>
                                            <div class="col-md-12" style="border-right: 1px solid black;">
                                                ...
                                                <div class="row" style="padding-bottom: 0px;margin-bottom:0px ">
                                                    ...
                                                    <div class="mValue3">
                                                      {{$prest_empleado->usuario->nombre1}} @if($prest_empleado->usuario->nombre2!='(N/A)'){{$prest_empleado->usuario->nombre2}}@endif {{$prest_empleado->usuario->apellido1}} @if($prest_empleado->usuario->apellido2!='(N/A)'){{$prest_empleado->usuario->apellido2}}@endif  
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="mLabel">
                                                    ...
                                                    <div class="mValue3" id="resultado">
                                                        ...
                                                        @php
                                                          ...
                                                          $cent = $prest_empleado->monto_prestamo - (int)($prest_empleado->monto_prestamo);
                                                          $val = $prest_empleado->monto_prestamo - $cent;
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mValue3">
                                                    @if(!is_null($prest_empleado))
                                                      {{$prest_empleado->concepto}}
                                                    @endif
                                                    </div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="col-md-12">
                                                ...
                                                <div class="row" style="padding-bottom: 0px;margin-bottom:0px">
                                                    ...
                                                    <div class="mValue">
                                                        {{date("d-m-Y", strtotime($prest_empleado->fecha_creacion))}}
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="mLabel">
                                                    ...
                                                    <div class="mValue">
                                                      {{$prest_empleado->id_asiento_cabecera}}
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="mLabel">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mValue">
                                                        @if($prest_empleado->estado == 1)
                                                          ACTIVO
                                                        @elseif($prest_empleado->estado == 0)
                                                          INACTIVO
                                                        @endif
                                                    </div>
                                                </div>
            ...
            <table id="factura_detail" class="bordes_padding" cellpadding="0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="font-size: 16px;padding-left: 22px; border-bottom: 1px solid black; border-right: 1px solid black; ">
                        {{trans('contableM.nro')}}. Cheque  @if(($prest_empleado->num_cheque)!=null){{$prest_empleado->num_cheque}} @endif
                        </td>
                        <td style="font-size: 16px;padding-left: 22px; border-bottom: 1px solid black; ">
                            Fecha Ch. <strong>{{date("d-m-Y", strtotime($prest_empleado->fecha_cheque))}}</strong>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        <td class="totals_label2" style="font-size: 16px;padding-left: 22px; border-bottom: 1px solid black; border-right: 1px solid black; ">
                          Elaborado por {{$prest_empleado->usuario_crea->nombre1}}  {{$prest_empleado->usuario_crea->apellido1}}
                        </td>
                        <td class="totals_label2" style="font-size: 16px;padding-left: 22px; border-bottom: 1px solid black; border-right: 1px solid black; ">
                        ...
                        <td class="totals_label2" style="font-size: 16px;padding-left: 22px; border-bottom: 1px solid black; ">
                            Cédula Identidad No. : {{$prest_empleado->id_empl}}
                        </td>
                    </tr>
                </tbody>
            </table>
