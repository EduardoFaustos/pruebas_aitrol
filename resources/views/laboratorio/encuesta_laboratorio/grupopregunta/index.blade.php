...
<!-- Ventana modal editar -->
  ...
  <div class="box-header">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="col-md-3 ">
          <a class="btn btn-primary" href="{{ route('grupopreguntaslabs.create') }}" style="width: 100%;">Nuevo Grupos de Preguntas</a>
        </div>
      </div>
    </div>
  </div>  
  <!-- /.box-header -->
  <div class="box-body">
      <form method="POST" action="{{ route('grupopreguntaslabs.search') }}">
         {{ csrf_field() }}
