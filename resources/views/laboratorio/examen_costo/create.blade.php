    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border"><h3 class="box-title">Agregar Examen</h3></div>
                <div class="box-body">
                    <form class="form-vertical" role="form" method="POST" action="{{ route('examen.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group col-md-12{{ $errors->has('tarifario') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input id="tarifario" class="form-control input-sm" type="text" name="tarifario" value="{{old('tarifario')}}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required autofocus>
