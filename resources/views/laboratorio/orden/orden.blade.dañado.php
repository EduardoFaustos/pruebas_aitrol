      ...
      <table width="100%" border="0">
        ...
        <td width="65%">
          <table width="100%" border="1">
            ...
            @php $cont=0; $filas=1;@endphp
            @foreach($examenes as $examen)
                @if($examen->id != '639' && $examen->id != '1232' && $examen->id != '1231' && $examen->id != '632')
            ...
            @foreach($arrayTotal as $a) @php $cont ++; @endphp <td>{{$a}}
                </td>
      ...
      <table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 style='border-collapse:collapse;border:none;mso-border-alt:solid windowtext .5pt;
        ...
        <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
          ...
          solid windowtext .5pt;padding:5.5pt 5.4pt 0cm 5.4pt'>
            <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
          text-align:center;line-height:normal'><span style='font-size:5pt;
          mso-bidi-font-size:11.0pt'><b>@if($empresa->id==$empresa_prioridad_1) @else 11003 @endif</b>
                <o:p></o:p>
              </span></p>
          </td>
          <td width=10 valign=top style='width:10pt;border:solid windowtext 1.0pt;
          ...
          text-align:center;line-height:normal'><span style='font-size:6.0pt;
          mso-bidi-font-size:11.0pt'>
                <o:p><img style='position: absolute;top: -12px;padding-left: 0px;' width=300 height=120 @if($empresa->id==$empresa_prioridad_1) src="{{base_path().'/storage/app/avatars/'.$ruta}}" @else src="{{base_path().'/storage/app/logo/firma_rb.png'}}" @endif align=center hspace=12></o:p>
              </span></p>
            @endif
          </td>
          <td width=20 valign=top style='width:20pt;border:solid windowtext 1.0pt;
