                                        ...
                                        <div class="table-responsive">
                                          ...
                                          <div style="border-bottom: 1px solid black;padding: 0px;">
                                            ...
                                            @if($value_detalle->id_examen == '610' || $value_detalle->id_examen == '615')
                                              <br><a href="{{route('subresultado.crear',['id_orden' => $orden->id, 'id_examen' => $value_detalle->id_examen])}}" data-toggle="modal" data-target="#edit_crea_sub" class="btn btn-success btn-xs" ><span class="glyphicon glyphicon-plus"></span> Detalle</a>
                                            @endif
                                          ...
                                          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info" style="font-size: 14px;">
                                            ...
                                            <tbody>
                                              ...
                                              @if($value_detalle->id_examen=='661')
                                                <tr>
                                                    <td width="30%"><b>GRADO</b></td>
                                                    <td width="20%"><b>% CELULAS</b></td>
                                              ...
                                              @else
                                                @if(!(($value_detalle->id_examen == '414' || $value_detalle->id_examen == '412' || $value_detalle->id_examen == '680') && $orden->created_at<'2018-12-17' && $orden->id!='1543' && $orden->id!='1291'))
                                                  @foreach($parametro_nuevo as $value_agrupador)
                                                    ...
                                                    $resultado = $resultados->where('id_orden', $value_detalle->id_examen_orden)->where('id_parametro', $value_agrupador->id)->first();
                                                    @endphp
                                                      <tr role="row" class="clickable-row" data-href="{{ route('resultados.crea_actualiza', ['id_orden' => $value_detalle->id_examen_orden,'id_parametro' => $value_agrupador->id]) }}" data-toggle="xºmodal" data-target="#edit_crea">
                                                        <td width="30%" style="padding-top: 2px;padding-bottom: 2px;">{{$value_agrupador->nombre}}</td>
