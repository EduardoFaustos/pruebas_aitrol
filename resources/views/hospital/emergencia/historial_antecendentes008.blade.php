        ...
        <div class="row">
            <div class="col-md-10 col-sm-10">
                ...
                {{trans('transformularios.Formulario008')}}
                    <small>{{trans('transformularios.AntecendentesPersonalesyFamiliares')}}</small>
                </h3>
            </div>
            <div class="col-2">
		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"> {{trans('transformularios.HistorialdeAntecendentes')}}</h3>
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-12">
                                ...
                                @endforeach
                                <table id="antecendentes" class="table table-bordered table-hover table-sm">
                                    <thead>
                                        <tr>
                                            <th>{{trans('transformularios.FechayHora')}}</th>
                                            <th>{{trans('transformularios.Cedula')}}</th>
                                            <th>{{trans('transformularios.Clinico')}}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
