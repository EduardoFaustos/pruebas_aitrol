...
<div class="row">
    ...
    <form id="hc_protocolo{{$procedimiento->id}}" style="width: 100%;">
        ...
        <br>
        <div class="col-12">
            <span style="">Plantilla de Procedimientos</span>
        </div>
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-5" >
                    <a class="btn btn-info btn_ordenes" style="color: white; height: 100%; " onClick="cargar_plantilla('1',{{$procedimiento->id}}{{$variable_tiempo}}, {{$procedimiento->id}});">Insertar Plantilla
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <textarea id="hallazgos" name="hallazgos" class="form-control"> @if(!is_null($protocolo)) {{$protocolo->hallazgos}} @endif</textarea>
        </div>
        <div class="col-12">&nbsp;</div>
        <div class="col-12">
        ...
        <div class="col-12">
            <textarea id="conclusion" name="conclusion" class="form-control">@if(!is_null($protocolo)) {{$protocolo->conclusion}} @endif </textarea>
        </div>
        <div class="col-12">&nbsp;</div>
        <div class="col-12">
        ...
        <div class="col-12">
            <select name="id_doctor_examinador" onchange="autoguardado({{$procedimiento->id}})" class="form-control">
