...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.6 -->
    <link href="{{ asset("/hospital/css/bootstrap.css") }}" rel="stylesheet" type="text/css" />
      <link href="{{ asset("/hc4/css/helvetica.css") }}" rel="stylesheet" type="text/css" />
      <link href="{{asset("/hc4/css/montserrat.css")}}" rel="stylesheet" type="text/css">
    <!-- Font Awesome -->
...
-->
  ...
  <body class=" layout-top-nav" id="body2" >
    ...
    <script src="{{ asset ("/hospital/js/bootstrap.js") }}" type="text/javascript"></script>
