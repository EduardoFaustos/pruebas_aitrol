...
<div class="container">
    <div class="row">
        <div class="box box-primary col-xs-24">
            <div class="box-header"><h3 class="box-title">Editar Oficina</h3></div>
            ...
            {{ csrf_field() }}
                <div class="box-body col-xs-24">
                    ...
                    <div class="form-group col-xs-12{{ $errors->has('id_unidad') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-7">
                                            <select class="form-control input-sm" name="id_unidad" id="id_unidad" required>
                                                ...
                                                <option @if($oficinas->id_unidad == $gn->id) selected @endif 
                    ...
                    <!--nombre-->
                    <div class="form-group col-xs-12{{ $errors->has('nombre_oficina') ? ' has-error' : '' }}">
                        <label for="nombre_oficina" class="col-md-2 control-label">Nombre de Oficina</label>
                        <div class="col-md-7">
                            ...
                            <input id="nombre_db" type="hidden" class="form-control" name="nombre_db" value="{{ $oficinas->nombre_db }}" style="text-transform:uppercase;">
                    ...
                    <div class="form-group col-xs-12{{ $errors->has('descripcion') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-7">
                            <input id="descripcion" type="text" class="form-control" name="descripcion" value="{{ $oficinas->descripcion }}" required autofocus>
                    ...
                    <div class="form-group col-xs-12{{ $errors->has('estado') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-7">
                            <select id="estado" name="estado" class="form-control">
                                <option {{$oficinas->estado == 0 ? 'selected' : ''}} value="0">INACTIVO</option>
                                <option {{$oficinas->estado == 1 ? 'selected' : ''}} value="1">ACTIVO</option>
                            </select>
...
<script>
  function editar() {
    ...
    if(confirmar) {
            $.ajax({
                url: "{{route('mantenimientos_oficinas.update')}}",
                headers: {
                ...
                success: function(data) {
                    var url = "{{route('mantenimientos_oficinas.index')}}"
                    if (data == 'ok') {
                        setTimeout(function() {
