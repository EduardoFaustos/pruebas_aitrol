    ...
    <div class="row">
        <div class="box box-primary col-xs-24">
            <div class="box-header">
                <h3 class="box-title">Agregar Nueva Oficina</h3>
                </div>
            <form class="form-vertical" role="form" id="formulario">
                ...
                <div class="box-body col-xs-24">
                    ...
                    <div class="form-group col-xs-12{{ $errors->has('nombre_oficina') ? ' has-error' : '' }}">
                        <label for="nombre_oficina" class="col-md-3 control-label">Nombre de la Oficina</label>
                        <div class="col-md-7">
...
<script type="text/javascript">
    function guardar(){
        ...
        var nombre = $("#nombre_oficina").val();
        if(nombre == "" ){
            swal("Error!", "Campos Vacios", "error");
        }else{
               $.ajax({
                url: "{{route('mantenimientos_oficinas.store')}}",
                headers: {
