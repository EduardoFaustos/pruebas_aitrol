    ...
    <div class="row">
        <div class="box box-primary col-xs-24">
            <div class="box-header">
                <h3 class="box-title">Agregar Nuevo Piso</h3>
            </div>
            <form class="form-vertical" role="form" id="formulario" action="{{route('mantenimientos_d.store')}}">
                {{ csrf_field() }}
...
<script type="text/javascript">
    function guardar() {
        ...
        if (nombre == "" || descri == "") {
            ...
            $.ajax({
                url: "{{route('mantenimientos_d.store')}}",
                headers: {
