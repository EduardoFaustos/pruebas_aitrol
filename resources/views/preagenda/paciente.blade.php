...
<div class="container">
    <div class="row">
            <div class="panel panel-default">
                <div class="panel-heading">Agregar nuevo Paciente</div>
                <div class="panel-body">

                <div class="box-header">
                    <h3 class="box-title">Datos del Asegurado </h3></div>
                    <span class="help-block">@if($user != Array()){{'**Usuario ya registrado en el sistema'}}@endif</span>
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('agenda.guardar') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group col-md-6 {{ $errors->has('nombre1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <input id="nombre1" type="text" class="form-control" name="nombre1" value="@if($user != Array()){{$user[0]->nombre1}}@else{{ old('nombre1') }}@endif" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required autofocus @if($user != Array()){{'readonly'}}@endif>
                        ...
                        <div class="form-group col-md-6 {{ $errors->has('nombre2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <div class="input-group dropdown">
                                    <input id="nombre2" type="text" class="form-control nombrecode dropdown-toggle" name="nombre2" value="@if($user != Array()){{$user[0]->nombre2}}@else{{ old('nombre2') }}@endif" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" autofocus @if($user != Array()){{'readonly'}}@endif required >
                        ...
                        <div class="form-group col-md-6{{ $errors->has('apellido1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <input id="apellido1" type="text" class="form-control" name="apellido1" value="@if($user != Array()){{$user[0]->apellido1}}@else{{ old('apellido1') }}@endif" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required autofocus @if($user != Array()){{'readonly'}}@endif>
                        ...
                        <div class="form-group col-md-6 {{ $errors->has('apellido2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <div class="input-group dropdown">
                                    <input id="apellido2" type="text" class="form-control nombrecode dropdown-toggle" name="apellido2" value="@if($user != Array()){{$user[0]->apellido2}}@else{{ old('apellido2') }}@endif" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" autofocus @if($user != Array()){{'readonly'}}@endif required>
                        ...
                        <div class="form-group col-md-6{{ $errors->has('fecha_nacimiento') ? ' has-error' : $errors->has('menoredad') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <div class="input-group date">
                                    ...
                                    <input onchange="fecha();" id="fecha_nacimiento" type="text" class="form-control pull-right" name="fecha_nacimiento" value="@if($user != Array()){{$user[0]->fecha_nacimiento}}@else{{ old('fecha_nacimiento') }}@endif" required autofocus @if($user != Array()){{'readonly'}}@endif>
                                </div>
                        ...
                        <div class="form-group col-md-6{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <input id="email" type="email" class="form-control" name="email" value="@if($user != Array()){{$user[0]->email}}@else{{ old('email') }}@endif" required @if($user != Array()){{'readonly'}}@endif>
                        ...
                        <div class="form-group col-md-6 {{ $errors->has('nombre12') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <input id="nombre12" type="text" class="form-control" name="nombre12" value="{{ old('nombre12') }}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required autofocus>
                        ...
                        <div class="form-group col-md-6 {{ $errors->has('nombre22') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <div class="input-group dropdown">
                                    <input id="nombre22" type="text" class="form-control nombrecode dropdown-toggle" name="nombre22" value="{{ old('nombre22') }}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" autofocus required>
                        ...
                        <div class="form-group col-md-6{{ $errors->has('apellido12') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <input id="apellido12" type="text" class="form-control" name="apellido12" value="{{ old('apellido12') }}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required autofocus>
                        ...
                        <div class="form-group col-md-6 {{ $errors->has('apellido22') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <div class="input-group dropdown">
                                    <input id="apellido22" type="text" class="form-control nombrecode dropdown-toggle" name="apellido22" value="{{ old('apellido22') }}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" autofocus required>
                        ...
                        <div class="form-group col-md-6{{ $errors->has('fecha_nacimiento2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7">
                                <div class="input-group date">
                                    ...
                                    <input onchange="edad();" id="fecha_nacimiento2" type="text" class="form-control" name="fecha_nacimiento2" value="{{ old('fecha_nacimiento2') }}" required autofocus>
...
<script src="{{ asset ("/plugins/fullcalendar/jquery.min.js") }}" type="text/javascript"></script>
<script src="{{ asset ("/plugins/datetimepicker/bootstrap-material-datetimepicker.js") }}"></script>

<script type="text/javascript">
$('#fecha_nacimiento2').bootstrapMaterialDatePicker({ 
    date: true,
    shortTime: false,
    time: false,
    format : 'YYYY-MM-DD',
...
function usuario()
{
        ...
        if (vcedula != ""){
            location.href =" {{route('agenda.paciente2', ['id' => $id])}}/"+vcedula;
        }
}
