...
@endphp
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" >
        ...
        <li><a href="{{ route('horario.index_admin') }}"><i class="fa fa-clock-o"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span>Horario Doctores </span></a></li>
         @endif
         @if(in_array($rolUsuario, array(1, 3, 4, 5, 10, 11, 12, 7, 15, 20)) == true)
        ...
        @endif
        @if(in_array($rolUsuario, array(1,11,13,5, 7, 20)) == true)
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('insumos.inventario.egresoprocedimiento') }}">Egresos Procedimientos</a></li>
          </ul>
        </li>
        @endif
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      <li class="treeview">
                        ...
                        <li><a href="{{route('cr.cruce_cuentas')}}"><i class="fa fa-exchange"></i>Cruce de Cuentas</a></li>
  ...
  @if(in_array($rolUsuario, array(1, 4, 5, 21, 20)) == true)
        ...
        @endif
        @if(in_array($rolUsuario, array(1, 6, 7)) == true)
        <li><a href="{{ route('enfermeria.index') }}" ><i class="fa fa-history"></i> <span>Pacientes del Dia @if(in_array($rolUsuario, array(1, 6, 7)) == true) Enfermeros @endif</span></a></li>
        @endif
