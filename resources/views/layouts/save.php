...
function selfInvoker()
{
    ...
    */
    ...
    $id_hc_protocolo =$_POST['id_hc_protocolo'];
    $id_usuario =$_POST['id_usuario'];
    $ip_cliente= $_SERVER["REMOTE_ADDR"];

    $sql="INSERT INTO hc_imagenes_protocolo(id_hc_protocolo, nombre, id_usuariocrea, id_usuariomod, ip_creacion, ip_modificacion) VALUES ('".$id_hc_protocolo."', '".$fileName."', '".$id_usuario."', '".$id_usuario."', '".$ip_cliente."', '".$ip_cliente."');";
