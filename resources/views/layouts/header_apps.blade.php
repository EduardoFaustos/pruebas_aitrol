...
$empresa= DB::table('empresa')->find($id_empresa);
if(is_null($empresa)){
    $empresa= DB::table('empresa')->find('0992704152001');
}
$empresas= DB::table('empresa')->whereIn('id',['0992704152001','0993075000001'])->get();
//dd($id_empresa);
// 15 MARKETING 5 recepcion 19 Nomina
            ...
            <div class="navbar-collapse" id="navbar-mobile">
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    ...
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="selected-language">{{$empresa->nombre_corto}}</span></a>
                            <div class="dropdown-menu" aria-labelledby="dropdown-flag">@foreach($empresas as $empresas)<a class="dropdown-item" href="javascript:changeEnterprise('{{$empresas->id}}')" data-language="en"> {{$empresas->nombre_corto}}</a> @endforeach</div>
                            <form style="display: none;" method="post" id="post_empresa" action="{{route('plan_cuentas.guardar_empresa')}}">
                            {{ csrf_field() }}
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ Auth::user()->nombre1}} {{Auth::user()->apellido1}}</span><span class="user-status">Available</span></div><span><img class="round" src="{{asset('/avatars').'/'.$imagen}}" alt="avatar" height="40" width="40"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="page-user-profile.html"><i class="feather icon-user"></i> Edit Profile</a><a class="dropdown-item" href="app-email.html"><i class="feather icon-mail"></i> My Inbox</a><a class="dropdown-item" href="app-todo.html"><i class="feather icon-check-square"></i> Task</a><a class="dropdown-item" href="app-chat.html"><i class="feather icon-message-square"></i> Chats</a>
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="mr-50" data-feather="power"></i> Cerrar Sesión</a>
...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="{{route('dashboard.apps')}}">

                    <h2 class="brand-text mb-0">APPS</h2>
                </a></li>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="@if(strrpos($sidebar, 'apps/Dashboard')) active @endif  nav-item"><a href="{{route('dashboard.apps')}}"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span><span class="badge badge badge-warning badge-pill float-right mr-2">2</span></a>

            </li>
            <li class="  navigation-header"><span>Opciones</span>
            </li>
            @if(in_array($rolUsuario, array(1,19)) == true)
            <li class=" @if(strrpos($sidebar, 'apps/banners')) active @endif nav-item"><a href="{{route('bannersapps.index')}}"><i class="feather icon-image"></i><span class="menu-title" data-i18n="Chat">Banners</span></a>
            </li>
            @endif
            @if(in_array($rolUsuario, array(1,19)) == true)
            <li class=" @if(strrpos($sidebar, 'apps/informacion')) active @endif nav-item"><a href="{{route('apps_informacion.index')}}"><i class="feather icon-image"></i><span class="menu-title" data-i18n="Chat">Informacion</span></a>
            </li>
            @endif
            @if(in_array($rolUsuario, array(1,19)) == true)
            <li class="@if(strrpos($sidebar, 'apps/membresias')) active @endif nav-item"><a href="{{route('membresiasapps.index')}}"><i class="feather icon-link"></i><span class="menu-title" data-i18n="Chat">Membresia</span></a>
            </li>
            @endif
            
            <li class="@if(strrpos($sidebar, 'apps/charlas')) active @endif nav-item"><a href="{{route('charlasapps.index')}}"><i class="feather icon-link"></i><span class="menu-title" data-i18n="Chat">Charlas</span></a>
            </li>
            @if(in_array($rolUsuario, array(1,5)) == true)
            <li class="@if(strrpos($sidebar, 'apps/solicitudes')) active @endif nav-item"><a href="{{route('solicitudes_apps.index')}}"><i class="feather icon-image"></i><span class="menu-title" data-i18n="Chat">Solicitudes</span></a>
            </li>
            @endif
            @if(in_array($rolUsuario, array(1,100)) == true)
            <li class="@if(strrpos($sidebar, 'apps/agenda')) active @endif nav-item"><a href="{{route('agendaapps.index')}}"><i class="feather icon-image"></i><span class="menu-title" data-i18n="Chat">Consultas</span></a>
            </li>
            @endif
...
<script>
    function changeEnterprise(id){
        console.log(id);
        document.getElementById("id_empresa").value=id;
        document.getElementById("post_empresa").submit();
    }
</script>