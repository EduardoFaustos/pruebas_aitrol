...
$especial = \Sis_medico\UsuarioEspecial::where('id_usuario', $id_auth)->where('id_empresa', $id_empresa)->first();
//dd($especial);
@endphp
</style>
...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      @endif
      @if(in_array($rolUsuario, array(1, 4, 12)) == true)
      ...
      <li><a href="{{ route('vacunas.empleados') }}"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span>Vacunas Empleados</span></a></li>
      @endif

      @if(in_array($rolUsuario, array(1)) == true)
      <li><a href="{{ route('vacunas.reporte_vacunas') }}"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span>Reporte Vacunas</span></a></li>
      @endif
      ...
      <!-- @if(in_array($rolUsuario, array(1, 5)) == true)
        <li class="treeview">
          <a href="#"><i class="fa fa-file"></i> <span>Comercial</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
      ...
      @endif
      @if(in_array($rolUsuario, array(1, 3, 4, 5, 10, 11, 12, 7, 15, 14)) == true)
      ...
      @endif
      @if(in_array($rolUsuario, array(1,11,13,5, 7, 9)) == true)
      <li><a href="{{ route('historia_clinica.fullcontrol') }}"><i class="fa fa-history"></i><span>Pacientes del Dia</span></a></li>
      @endif
      @if(in_array($rolUsuario, array(1, 3, 11, 22)) == true)
      <li><a href="{{ url('adelantado ') }}"><i class="fa fa-calendar-minus-o"></i> <span>Control Documental</span></a></li>
      @endif
      @if(in_array($rolUsuario, array(12,11)) == true )
      <!--Supervision-->
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="{{ url('consulta_tv') }}">Consulta TV</a></li>
        </ul>
      </li>
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li class="treeview @if(strrpos($sidebar, 'contable/contabilidad')) active @endif">
            ...
            <ul class="treeview-menu">
              ...
              @if(!is_null($especial))
              <li class="treeview @if(strrpos($sidebar, 'contabilidad/balance_general')) active @endif"><a href="{{ route('balance_general.index') }}"></i>Balance General E.</a></li>
              @endif
              ...
              @if(!is_null($especial))
              <li class="treeview @if(strrpos($sidebar, 'contabilidad/estado_especial/resultados')) active @endif"><a href="{{ route('estadoresultados.index', ['tipo' => 1]) }}"></i>Estado de Resultado Integral E.</a></li>
              @endif
      ...
      <ul class="treeview-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a style="color:red;" href="{{ route('documentofactura.new_factura') }}"> New Factura</a></li>
          </ul>
        </li>
        <li class="treeview">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        <li><a href="{{ route('contable.compraspedidos.index') }}"></i>Pedidos Compra</a></li>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        <li><a href="{{ route('productos.saldos_iniciales') }}"></i>Iniciales</a></li>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        <li><a href="{{ route('nuevo_rol.masivo_search') }}"></i>Roles de Pago por Empresa</a></li>
        ...
        <!--<li><a href="{{ route('nomina_anticipos_funcionario.index') }}"></i>Crear Anticipos Funcionarios</a></li>-->
        <li><a href="{{ route('nomina_anticipos_1eraquincena.index') }}"></i>Anticipo 1Ra Quinc Empl</a></li>
        <li><a href="{{ route('nominaquincena.index_quincena')}}"></i>Nuevo Anticipo Quincena</a></li>
        ...
        <!--<li><a href="{{ route('reporte_prestamo.index') }}"></i>Reportes de Prestamos</a></li>-->
    </li>
    </ul>
    <ul class="treeview-menu">
      <li class="treeview">
    ...
    <ul class="treeview-menu">
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li class="treeview">
          <li><a href="{{ route('area_rh.index') }}"><i class="fa fa-wrench"> </i> Área </a></li>
          <li><a href="{{ route('estado_civil.index') }}"><i class="fa fa-wrench"> </i> Estado Civil </a></li>
          <li><a href="{{ route('mantenimiento.horario.index') }}"><i class="fa fa-wrench"> </i> Horario </a></li>
          <li><a href="{{ route('nivel_academico.index') }}"><i class="fa fa-wrench"> </i>Nivel Académico</a></li>
          <li><a href="{{ route('pagobeneficio.index') }}"><i class="fa fa-wrench"> </i>Pago Benefico</a></li>
          <li><a href="{{ route('tipo_aporte.index') }}"><i class="fa fa-wrench"> </i> Tipo Aporte </a></li>
          <li><a href="{{ route('tipo_rol.index') }}"><i class="fa fa-wrench"> </i> Tipo Rol </a></li>
    ...
    <ul class="treeview-menu">
      <li class="treeview">
      <li><a href="{{ route('venta.create_recibo') }}"></i>Factura Recibo de Cobro</a></li>
      </li>
    </ul>
    <ul class="treeview-menu">
      <li class="treeview">
    ...
    <ul class="treeview-menu">
      <li class="treeview">
      <li><a href="{{ route('insumos') }}"></i>Facturas Conglomerada</a></li>
      </li>
    </ul>
    <ul class="treeview-menu">
      <li class="treeview">
      <li><a href="{{ route('reporte.reporte_comisiones') }}"></i>Reporte Comisiones</a></li>
      </li>
    </ul>
    @php
    ...
    <ul class="treeview-menu">
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          @if($id_empresa == $empresa_labs->id)
          <li><a href="{{ route('venta.infome_labs') }}"><i class="fa fa-file-excel-o"></i>Informe de Venta Labs</a></li>
          @endif
          @endif
          @if(isset($empresa_1))
    ...
    @endif
    @if(in_array($rolUsuario, array(1, 4, 5, 21)) == true)
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        <li><a href="{{ route('aparchivo.total_agrupado_contable') }}">Liquidacion Contable</a></li>
      </ul>
    </li>
    @endif

    @if(in_array($rolUsuario, array(1, 6, 11)) == true)
    ...
    @endif
    @if(in_array($rolUsuario, array(1, 4, 6,11, 24)) == true || $id_auth=='1111111115')
    <li class="treeview">
      <a href="#"> <i class="fa fa-file"> </i>Servicios Generales
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-rigth"></i>
        </span>
      </a>
      <ul class="treeview-menu">
        <li><a href="{{route('limpieza_banos.index')}}"><i class="fa fa-hospital-o" aria-hidden="true"></i>Registro de Limpieza de Baños</a></li>
        ...
        <li><a href="{{route('mantenimientohorario.index')}}"><i class="fa fa-leanpub" aria-hidden="true"></i><span style="text-overflow: ellipsis;">Registro de Limpieza y Desinfección de Salas</span></a></li>
      </ul>
    </li>
    @endif
    @if(in_array($rolUsuario, array(1, 6, 11)) == true)
    <li>
      <a href="{{ route('consulta_ordenes.index') }}"><i class="fa fa-book" aria-hidden="true"></i>
        <span>Procedimientos Diarios</span>
        <span class="pull-right-container">
          <small class="label pull-right bg-red" id="cantidadProc"></small>
        </span>
      </a>
    </li>
    @endif
    ...
    @if(in_array($rolUsuario, array(1, 6, 11)) == true)
    <li>
      <a href="{{ route('gestionarorden.index') }}"><i class="fa fa-file" aria-hidden="true"></i>
        <span>Gestionar Ordenes Procedimiento</span>
        <span class="pull-right-container">
          <small class="label pull-right bg-red" id="cantidadProc"></small>
        </span>
      </a>
    ...
    <li class="treeview">
      <a href="#"> <i class="fa fa-file"> </i>Turnero
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-rigth"></i>
        </span>
      </a>
    ...
    @if(in_array($rolUsuario, array(1, 3, 4, 5, 10, 11, 12, 7, 15)) == true)
    <li class="treeview">
      <a href="{{route('ticket_soporte_tecnico.index')}}"> <i class="fa fa-ticket" aria-hidden="true"></i>Ticket Soporte Tecnico </a>
    </li>
    @endif
    @if($rolUsuario == 1)
    <li class="treeview">
    ...
    @endif
    @php
    $control = \Sis_medico\UsuariosControl::where('estado',1)->get();
    ...
    <li><a href="{{ route('muestrabiopsias.index') }}"><i class="fa fa-calendar-minus-o"></i><span> Revision Ordenes Biopsia </span></a></li>
    @endif
...
<script type="text/javascript">
  ...
  var oras = function() {
    $.ajax({
      type: 'get',
      url: '{{ route('consulta_ordenes.numero')}}',
      success: function(data) {
        //alert(data);
        //console.log(data);
        if (data > 0) {
          $('#cantidadProc').empty().html(data);
        }
      }
    })
