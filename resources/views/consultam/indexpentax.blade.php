    ...
    <div class="col-md-12">
      ...
      <div class="box-body">
        <form method="POST" action="{{ route('consultam.pentax') }}" >
          ...
          <div class="form-group col-md-4 col-xs-6">
            <label for="fecha" class="col-md-3 control-label">{{trans('econsultam.FechaDesde')}}</label>
            <div class="col-md-9">
          ...
          <div class="form-group col-md-4 col-xs-6">
            <label for="fecha" class="col-md-3 control-label">{{trans('econsultam.FechaHasta')}}</label>
            <div class="col-md-9">
              <div class="input-group date">
                <div class="input-group-addon">
                  <i class="fa fa-calendar"></i>
          ...
          <div class="form-group col-md-1 col-xs-6">
            <button type="submit" class="btn btn-primary" formaction="{{route('consultam.search')}}">
              <span class="glyphicon glyphicon-triangle-left" aria-hidden="true"></span>{{trans('econsultam.Agenda')}}</button>
          </div>    
          @endif
            ...
            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info" style="font-size: 12px;">
              <thead>
                <tr>
                  ...
                  <th>{{trans('econsultam.DoctorAsignado')}}</th>
                  <th>{{trans('econsultam.DoctorPentax')}}</th>
                  <th>{{trans('econsultam.AsistentesEncargados')}}</th>
                  <th>{{trans('econsultam.ProcedimientosRealizados')}}</th>
                  <th>{{trans('econsultam.Estado')}}</th>
                  <th>{{trans('econsultam.Preparación')}}</th>
                  <th>{{trans('econsultam.Recuperación')}}</th>
                  <th>{{trans('econsultam.Alta')}}</th>
                </tr>
              </thead>
              <tbody>
