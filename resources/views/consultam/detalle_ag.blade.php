        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="col-md-3">
                    <a href="{{route('consultam.log_agenda',['id' => $agenda->id])}}"><button type="button" class="btn btn-primary" ><span class="glyphicon glyphicon-level-up"></span>{{trans('econsultam.LogAgenda')}}</button>
                    </a>
                    </div>
                ...
                <div class="box-body">
                    <div class="table-responsive col-md-12">
                        <table class="table table-striped">
                            <tbody>
                                <tr>
                                    <td><b>{{trans('ehistorialexam.Paciente:')}}</b></td>
                                    ...
                                    <td colspan="2"><b>{{trans('ehistorialexam.Cédula:')}}</b></td>
                                    <td colspan="2">{{$agenda->id_paciente}}</td>
                                    <td><b>{{trans('ehistorialexam.Edad:')}}</b></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><b>{{trans('econsultam.Celular')}}:</b></td>
