          ...
          <div class="col-md-12">
            <form method="POST" action="{{ route('consultam.search2') }}" >
              ...
              <div class="form-group col-md-4 col-xs-6">
                <label for="fecha" class="col-md-2 control-label">{{trans('econsultam.FechaDesde')}}</label>
                <div class="col-md-9">
              ...
              <div class="form-group col-md-4 col-xs-6">
                <label for="fecha_hasta" class="col-md-3 control-label">{{trans('econsultam.FechaHasta')}}</label>
                <div class="col-md-9">
                  <div class="input-group date">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
              ...
              <button type="submit" class="btn btn-primary" id="boton_buscar">
                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>{{trans('econsultam.Buscar')}}</button>
...
<script type="text/javascript" >
    ...
    $('#titulo1').text('{{trans('econsultam.ProcedimientosAgendadosporDoctores')}} - Total: {{$contador}}')
...
<script type="text/javascript" >
  ...
  @endphp
    ...
    $('#titulo2').text('{{trans('econsultam.ConsultasAgendadasporDoctores')}} - Total: {{$contador}}')
...
<script type="text/javascript" >
  ...
  @endphp
    ...
    $('#titulo3').text('{{trans('econsultam.ConsultasAgendadasRealizadasporDoctores')}} - Total: {{$contador}}')
...
<script type="text/javascript" >
  ...
  @endphp
    ...
    $('#titulo4').text('{{trans('econsultam.ProcedimientosRealizadosporDoctor(Pentax)')}} - Total: {{$contador}}')
...
<script type="text/javascript" >
  ...
  @endphp
    ...
    $('#titulo5').text('{{trans('econsultam.ProcedimientosAgendadosporSeguros')}} - Total: {{$contador}}')
...
<script type="text/javascript" >
  ...
  @endphp
    ...
    $('#titulo6').text('{{trans('econsultam.ConsultasAgendadosporSeguros')}} - Total: {{$contador}}')
...
<script type="text/javascript" >
  ...
  @endphp
    ...
    $('#titulo7').text('{{trans('econsultam.ProcedimientosRealizadosporSeguros')}} - Total: {{$contador}}')
...
<script type="text/javascript" >
  ...
  @endphp
    ...
    $('#titulo8').text('{{trans('econsultam.ConsultasRealizadosporSeguros')}} - Total: {{$contador}}')
