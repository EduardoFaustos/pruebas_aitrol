            ...
            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info" style="font-size: 12px;">
              <thead>
                <tr>
                  ...
                  <th>{{trans('econsultam.DescripcióndelCambio')}}</th>
                  <th>{{trans('econsultam.Usuario')}}</th>
                  <th>{{trans('econsultam.FechaAgendadaAnterior')}}</th>
                  <th>{{trans('econsultam.FechaAgendadaActual')}}</th>
                  <th>{{trans('econsultam.DoctorAnt')}}</th>
