            ...
            <div class="box box-primary">
                <div class="box-header with-border">  
                    ...
                    <table class="table table-striped">
                        ...
                        {{"CASADO(A)"}} @elseif($paciente->estadocivil==3) {{"VIUDO(A)"}} @elseif($paciente->estadocivil==5) {{"DIVORCIADO(A)"}} @elseif($paciente->estadocivil==5) 
                    ...
                    <div class="form-group col-md-12"> 
                        <form class="form-vertical" role="form" method="POST" action="{{ route('admisiones.update_doctor', ['id' => $paciente->id, 'id_cita' => $hca[0]->id_agenda, 'id_historia' => $hca[0]->hcid ]) }}" >
                            ...
                            <div class="form-group col-md-6{{ $errors->has('alergias') ? ' has-error' : '' }}">
                                ...
                                <textarea rows="2" cols="50" maxlength="255" id="alergias" class="form-control" name="alergias" >@if(old('alergias')!=''){{old('alergias')}}@else{{ $paciente->alergias }}@endif</textarea>
                            ...
                            <div class="form-group col-md-6{{ $errors->has('vacuna') ? ' has-error' : '' }}">
                                ...
                                <textarea rows="2" cols="50" maxlength="255" id="vacuna" class="form-control" name="vacuna" >@if(old('vacuna')!=''){{old('vacuna')}}@else{{ $paciente->vacuna }}@endif</textarea>
                            ...
                            <div class="form-group col-md-6{{ $errors->has('antecedentes_pat') ? ' has-error' : '' }}"> 
                                ...
                                <textarea rows="4" cols="50" maxlength="300" id="antecedentes_pat" class="form-control" name="antecedentes_pat" >@if(old('antecedentes_pat')!=''){{old('antecedentes_pat')}}@else{{ $paciente->antecedentes_pat }}@endif</textarea>
                            ...
                            <div class="form-group col-md-6{{ $errors->has('antecedentes_fam') ? ' has-error' : '' }}">                                   
                                ...
                                <textarea rows="4" cols="50" maxlength="300" id="antecedentes_fam" class="form-control" name="antecedentes_fam" >@if(old('antecedentes_fam')!=''){{old('antecedentes_fam')}}@else{{ $paciente->antecedentes_fam }}@endif</textarea>
                            ...
                            <div class="form-group col-md-12{{ $errors->has('antecedentes_quir') ? ' has-error' : '' }}">  
                                ...
                                <textarea rows="2" cols="50" maxlength="300" id="antecedentes_quir" class="form-control" name="antecedentes_quir"  >@if(old('antecedentes_quir')!=''){{old('antecedentes_quir')}}@else{{ $paciente->antecedentes_quir }}@endif</textarea>
                    ...
                    <div class="form-group col-md-12">
                        <form class="form-group" role="form" method="POST" action="{{ route('historiaclinica.guardar') }}">
                            ...
                            <div class="col-md-6{{ $errors->has('peso') ? ' has-error' : '' }}">
                                ...
                                <input id="peso" min=0 type="number" step="any" class="form-control" name="peso" value=@if(old('peso')!='')"{{old('peso')}}"@elseif($paciente->peso!="")"{{ $paciente->peso }}" @else "{{0}}" @endif >
                                    @if ($errors->has('peso'))
                                <span class="help-block">
                            ...
                            <div class="col-md-6{{ $errors->has('altura') ? ' has-error' : '' }}">
                                ...
                                <input id="altura" min=0 type="number" class="form-control" name="altura" value=@if(old('altura')!='')"{{old('altura')}}"@elseif($paciente->altura!="")"{{ $paciente->altura }}" @else "{{0}}" @endif >
                            ...
                            <div class="col-md-6{{ $errors->has('temperatura') ? ' has-error' : '' }}">
                                ...
                                <input id="temperatura" min=0 type="number" step="any" class="form-control" name="temperatura" value=@if(old('temperatura')!='')"{{old('temperatura')}}"@elseif($paciente->temperatura!="")"{{ $paciente->temperatura }}" @else "{{0}}" @endif >
                            ...
                            <div class="col-md-6{{ $errors->has('presion') ? ' has-error' : '' }}">
                                <label for="presion" class="col-md-12 control-label">Presión (mm Hg)</label>
