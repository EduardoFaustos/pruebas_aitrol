...
<div class="modal fade fullscreen-modal" id="favoritesModal3" tabindex="-1" role="dialog" aria-labelledby="favoritesModalLabel">
...
<div class="container-fluid" >
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            @foreach($fotos as $thumbnail)
                                                                <div class="col-sm-6 col-md-4">
                                                                    <div class="thumbnail">
                                                                        <a href="{{ route('procedimiento.imagen', ['id' => $thumbnail->id])}}" data-toggle="modal" data-target="#favoritesModal3">
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                $('#favoritesModal3').on('hidden.bs.modal', function(){
                    $(this).removeData('bs.modal');
                }); 
