    ...
    <div class="container-fluid">
        ...
        <div class="row" style="text-align: center;">
            ...
            <div class="col-md-12" style="margin-top: 20%;">
                ...
                <input id="campo" placeholder="Cédula o Pasaporte" style="text-align:center;font-size:20px;border-radius:25pc;border-color:#EF771D;width:60%;height: 50px;padding:10px;" />
            </div>
            <style>
                .numero_general {
                    width: 80px;
            ...
            <div class="col-md-12" style="margin-top: 2%;" id="numeros">
                <table id="table" class="table-center">
                    <tbody>
                        <tr>
                            <td><input class="numero numero_general" value="1" onclick="number(this)" type="button"></td>
                            <td><input class="numero numero_general" value="2" onclick="number(this)" type="button"></td>
                            <td><input class="numero numero_general" value="3" onclick="number(this)" type="button"></td>
                        </tr>
                        <tr>
                            <td><input class="numero numero_general" value="4" onclick="number(this)" type="button"></td>
                            <td><input class="numero numero_general" value="5" onclick="number(this)" type="button"></td>
                            <td><input class="numero numero_general" value="6" onclick="number(this)" type="button"></td>
                        </tr>
                        <tr>
                            <td><input class="numero numero_general" value="7" onclick="number(this)" type="button"></td>
                            <td><input class="numero numero_general" value="8" onclick="number(this)" type="button"></td>
                            <td><input class="numero numero_general" value="9" onclick="number(this)" type="button"></td>
                        </tr>
                        <tr>
                            <td><button onclick="aparecer()" class="numero_general">abc
                                </button></td>
                            <td><input class="numero numero_general" value="0" onclick="number(this)" type="button"></td>
                            <td><button onclick="eliminar()" class="numero_general"><i class="fa fa-window-close-o" aria-hidden="true"></i></button></td>
                        </tr>
                    </tbody>
                </table>
