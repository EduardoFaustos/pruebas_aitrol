            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <a class="btn btn-primary"  id="imprimir_etiquetas"  ><span class="glyphicon glyphicon-user"></span> Imprimir Etiqueta</a>
                        </div>
...
@endif */?>
                ...
                <form class="form-vertical" id="form_adm" role="form" method="POST" action="{{ route('admisiones.update', ['id' => $paciente->id]) }}" enctype="multipart/form-data" autocomplete="nope">
                    <div class="box-body">
                        ...
                        <div class="form-group col-md-3{{ $errors->has('id_seguro') ? ' has-error' : '' }}" style="margin-bottom: 0px;">
                        ...
                        <!--subseguro-->
                        <div class="form-group col-md-3{{ $errors->has('id_subseguro') ? ' has-error' : '' }}" id="dsub" style="margin-bottom: 0px;">
                            <div id="div_subseguro" class="col-md-12"></div>
                        ...
                        @endif
                            ...
                            <!--procedencia-->
                            <div class="form-group col-md-3 {{ $errors->has('procedencia') ? ' has-error' : '' }} " style="margin-bottom: 0px;">
                        ...
                        <fieldset class="col-md-12 oculto" id="principal" style="background-color: #e6eeff;"><legend style="background-color: #e6eeff;">Principal: </legend>
                            <div id="div_principal" ></div>

                        </fieldset>

                        <fieldset class="col-md-12" style="background-color: #f0f5f5;"><legend>Datos de ubicación: </legend>
                        ...
                        <fieldset class="col-md-12"><legend>@if($cita->proc_consul=='0')Familiar de Contacto: @else Representante/Acompañante (Quien firma)@endif</legend>
                            ...
                            <div class="form-group col-md-2{{ $errors->has('parentescofamiliar') ? ' has-error' : '' }}" >
                                ...
                                <select id="parentescofamiliar" name="parentescofamiliar" class="form-control input-sm" required onchange="Escoger_pr();" autocomplete="nope">
                                    <option value="">Seleccionar ..</option>
                                    <option @if($cita->proc_consul=='1' && $paciente->parentescofamiliar == 'Principal' ) @else {{$paciente->parentescofamiliar == "Principal" ? 'selected' : ''}}@endif value="Principal">Principal</option>
                                        <option @if($cita->proc_consul=='1' && $paciente->parentescofamiliar == 'Principal' ) @else {{$paciente->parentescofamiliar == "Padre/Madre" ? 'selected' : ''}}@endif value="Padre/Madre">Padre/Madre</option>
                                        <option @if($cita->proc_consul=='1' && $paciente->parentescofamiliar == 'Principal' ) @else {{$paciente->parentescofamiliar == "Conyugue" ? 'selected' : ''}}@endif value="Conyugue">Conyugue</option>
                                        <option @if($cita->proc_consul=='1' && $paciente->parentescofamiliar == 'Principal' ) @else {{$paciente->parentescofamiliar == "Hijo(a)" ? 'selected' : ''}}@endif value="Hijo(a)">Hijo(a)</option>
                                        <option @if($cita->proc_consul=='1' && $paciente->parentescofamiliar == 'Principal' ) @else {{$paciente->parentescofamiliar == "Hermano(a)" ? 'selected' : ''}}@endif value="Hermano(a)">Hermano(a)</option>
                                        <option @if($cita->proc_consul=='1' && $paciente->parentescofamiliar == 'Principal' ) @else {{$paciente->parentescofamiliar == "Sobrino(a)" ? 'selected' : ''}}@endif value="Sobrino(a)">Sobrino(a)</option>
                                        <option @if($cita->proc_consul=='1' && $paciente->parentescofamiliar == 'Principal' ) @else {{$paciente->parentescofamiliar == "Nieto(a)" ? 'selected' : ''}}@endif value="Nieto(a)">Nieto(a)</option>
                                        <option @if($cita->proc_consul=='1' && $paciente->parentescofamiliar == 'Principal' ) @else {{$paciente->parentescofamiliar == "Primo(a)" ? 'selected' : ''}}@endif value="Primo(a)">Primo(a)</option>
                                        <option @if($cita->proc_consul=='1' && $paciente->parentescofamiliar == 'Principal' ) @else {{$paciente->parentescofamiliar == "Familiar" ? 'selected' : ''}}@endif value="Familiar">Familiar</option>
                                    </select>
            ...
            $.ajax({
                ...
                success: function(data){
                    if(data!="null"){
                        ...
                        $('#div_subseguro').removeClass("oculto");
                    }else{

                        $('#div_subseguro').addClass("oculto");
                    }
                }
            })
        }
...
$('#imprimir_etiquetas').click(function(){
    ...
    if((alergias == "") || (alergias == "No") || (alergias == "NO") || (alergias == "no") || (alergias == "nO")){
        dato_alergia = 1;
    } else{
        dato_alergia = 2;
    }
