...
<div class="container">
    <div class="row">
        <div class="box box-primary col-xs-24">
            <div class="box-header"><h3 class="box-title">Agregar Nuevo Tipo de sugerencia</h3></div>
            <form class="form-vertical" role="form" method="POST" action="{{ route('tipo_sugerencia.store') }}">
                {{ csrf_field() }}
