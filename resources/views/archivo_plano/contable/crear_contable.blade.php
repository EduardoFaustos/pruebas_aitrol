      ...
      <form id="agrupado_contable">
          ...
          <div class="form-group col-md-12 col-xs-12 ">
            ...
            <div class="col-md-12">
              <select id="seguro" name="seguro" class="form-control input-sm" >
                <option  value="2">IESS</option>
                <option  value="3">ISSFA</option>
                <option  value="5">MSP</option>
                <option  value="6">ISSPOL</option>
              </select>
            </div>
          </div>
        ...
        <div class="form-group col-md-6 col-xs-6">
          ...
          <div class="form-group col-md-12 col-xs-12">
            ...
            <div class="col-md-12">
              <select class="form-control input-sm" id="estado_pago" name="estado_pago" class="form-control ">
          ...
          <div class="form-group col-md-12 col-xs-12">
            ...
            <div class="col-md-12">
              <input class="form-control input-sm" type="number" id="valor_facturado" name="valor_facturado" class="form-control " value="">
            </div>
          </div>
        ...
        <div class="form-group col-md-6 col-xs-6">
          ...
          <div class="col-md-6">
            ...
            <button id="guardar_agrupado_contable" type="button" class="btn btn-info btn-xs" onclick="guardar('')">GUARDAR</button>
          </div>
...
<script type="text/javascript">
  ...
  function guardar(){
    ...
    $.ajax({
        type: 'post',
        url:"{{route('aparchivo.total_agrupado_contable_store')}}",
        headers:{'X-CSRF-TOKEN':$('input[name=_token]').val()},
        datatype: 'json',
        data: $("#agrupado_contable").serialize(),
