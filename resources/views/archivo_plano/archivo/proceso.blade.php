...
<div class="modal-content" style="width: 100%;">
  <div class="modal-header" style="padding-top: 5px; padding-bottom: 1px;">
    ...
    <div class="row" style="border-bottom: 1px solid black;">
      ...
      <div class="col-md-4">
        <span id="Label8" style="color:#003366;font-family:Arial;font-size:14pt;font-weight:bold;">Codigo Proceso</span>
      </div>
    </div>
  </div>
    ...
    <div class="box-body">
      ...
      <div class="form-group col-md-6 col-xs-6">
        ...
        <div class="col-md-6">
          ...
          <button id="guardar_agrupado" type="submit" class="btn btn-info btn-xs" onclick="guardar('{{$id}}')">GUARDAR</button>
        </div>
