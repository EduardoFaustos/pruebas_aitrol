...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-6">
          <a class="btn btn-primary" href="{{route('plantillas.crear')}}">Agregar Nueva Plantilla</a>
        </div>
    </div>
  </div> 
  <!-- /.box-header -->
...
<form method="POST" action="{{route('plantillas.buscar')}}">
  {{ csrf_field() }}
  <div class="col-md-6">
    <div class="col-md-3">
    ...
    <div class="col-md-4">
      <input type="text" name="descripcion" value="{{$plantilla}}" class="form-control" required/>
    </div>
    <div class="col-md-4">
                ...
                <tr role="row" class="odd">
                  ...
                  <td>
                    <!--input type="hidden" name="_token" value="{{ csrf_token() }}"-->
                        <a href="{{ route('plantillas.edit', ['id' => $plantilla->codigo])}}" class="btn btn-warning ">
                        Editar
                        </a>
                        <a href="{{ route('plantillas.items', ['id' => $plantilla->codigo])}}" class="btn btn-success ">
                        Ver
                        </a>
                  </td>
              </tr>
