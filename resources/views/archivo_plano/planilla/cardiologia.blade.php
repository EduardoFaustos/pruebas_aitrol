...
<div class="modal-content" style="width: 100%;">
  <div class="modal-header" style="padding-top: 5px; padding-bottom: 1px;">
    ...
    <div class="row" style="border-bottom: 1px solid black;">
      ...
      <div class="col-md-4">
        <span id="Label8" style="color:#003366;font-family:Arial;font-size:14pt;font-weight:bold;">Órdenes de Interconsulta</span>
      </div>
    </div>
  </div>
          ...
          @foreach($ic as $value)
            @foreach($value as $espe)
              <tr>
                ...
                @endphp
                  <td><button type="button" class="btn btn-xs btn-success" onclick="seleccionar_cardio('{{$espe->hcid}}','{{$a_plano->id}}','{{$id_seguro}}','{{$id_empresa}}','{{$espe->id_agenda}}')"><span class="glyphicon glyphicon-ok-sign"></span></button></td>
