...
<div class="modal-content" style="width: 100%;">
    <div class="modal-header" style="padding-top: 5px; padding-bottom: 1px;">
        <div class="row" style="border-bottom: 1px solid black;">
            <div class="col-md-2">
              <a class="btn btn-light" onclick="store_item_planilla()">
    ...
    <div class="box-body" style="padding-bottom: 180px;">
      <form id="guardar_item" method="post">
          {{ csrf_field() }}
          ...
          <input type="hidden" name="porcent_10" id="porcent_10">
          ...
          <div class="form-group col-md-10 col-xs-9">
              ...
              <div class="col-md-10">
                <input id="descripcion" type="text" class="form-control input-sm"  name="descripcion" value="{{old('descripcion')}}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase(); " autocomplete="on">
              </div>
          </div>
          ...
          <div class="form-group col-md-3 col-xs-6">
              <label for="porcent_honorario" class="col-md-4 control-label">% Honorario:</label>
              <div class="col-md-7">
                <select id="porcent_honorario" name="porcent_honorario" class="form-control input-sm" >
          ...
          <div class="form-group col-md-1 col-xs-6">
              <a class="btn btn-light" onclick="crea_detalle_items()">
                <h1 style="font-size: 12px; margin:0;">
        ...
        <input type="hidden" name="contador_item" id="contador_item"  value="0">
        </form>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  function obtener_data(id_ap_proced,tip){
    ...
    var nivel_conve =$("#nivel_convenio").val();
    console.log(id_ap_proced,nivel_conve,tip);
    $.ajax({
        type: "GET",
  ...
  function crea_detalle_items(){

    var formulario = document.forms["guardar_item"];
    ...
    var proc_separ = formulario.proceso_separ.value;
    var porce_hono = formulario.porcent_honorario.value;
    ...
    /*f(proc_separ == ""){
        msj = msj + "Por favor, Ingrese el Proceso Separado<br/>";
    }*/
    if(porce_hono == ""){
        msj = msj + "Por favor, Seleccione el Pòrcentaje Honorario<br/>";
    }
    ...
    id= document.getElementById('contador_item').value;
    ...
    var porcentaje_honor = $("#porcent_honorario").val();
    var porc_honor = $("#porcent_honorario").val();
    ...
    //igual a 100%
    if((honorario_anest>0)&&(porcentaje_honor == const2)){
      ...
      midiv_item.innerHTML = '<td><input required type="hidden" id="visibilidad_item'+id+'" name="visibilidad_item'+id+'" value="1"><input type="hidden" id="porcent_hon'+id+'" name="porcent_hon'+id+'" value="'+porc_honor+'"><input type="hidden" id="porce_10'+id+'" name="porce_10'+id+'" value="'+porce_10+'"><input type="hidden" id="idcabecera'+id+'" name="idcabecera'+id+'" value="'+cabecera+'"><input type="hidden" id="fecha'+id+'" name="fecha'+id+'" value="'+fecha+'"><input type="hidden" name="niv_convenio'+id+'" id="niv_convenio'+id+'" value="'+niv_conv+'" readonly><input type="hidden" name="tipo'+id+'" id="tipo'+id+'" value="'+tipo+'" readonly><p>'+tipo+'</p></td><td><input type="hidden" name="codigo'+id+'" id="codigo'+id+'"  value="'+codigo+'" readonly><p>'+codigo+'</p></td> <td> <input type="hidden" name="descripcion'+id+'" id="descripcion'+id+'" value="'+descripcion+'" readonly><p>'+descripcion+'</p></td><td> <input type="hidden" name="cantidad'+id+'" id="cantidad'+id+'" value="'+cantidad+'" readonly><p>'+cantidad+'</p></td><td> <input type="hidden" name="precio'+id+'" id="precio'+id+'" value="'+div_dos+'" readonly><p>'+div_dos+'</p></td><td> <input type="hidden" name="iva'+id+'" id="iva'+id+'" value="'+iva+'" readonly><p>'+iva+'</p></td><td> <input type="hidden" name="total'+id+'" id="total'+id+'" value="'+total+'" readonly><p>'+total+'</p></td><td style="width: 40px;"><button type="button" onclick="eliminar_item_iess('+id+')" class="btn btn-light"><img style="width: 15px;height:15px" src="{{asset('/')}}hc4/img/eliminar_item.png"></button></td>';
      
      document.getElementById('detalle_items').appendChild(midiv_item);
    ...
    }else if((honorario_anest>0)&&(porcentaje_honor == const3)&&(proce_separado=='V')){
      ...
      if((cantidad>0)&&(precio>0)){
        ...
        midiv_item.innerHTML = '<td><input required type="hidden" id="visibilidad_item'+id+'" name="visibilidad_item'+id+'" value="1"><input type="hidden" id="porcent_hon'+id+'" name="porcent_hon'+id+'" value="'+porc_honor+'"><input type="hidden" id="porce_10'+id+'" name="porce_10'+id+'" value="'+porce_10+'"><input type="hidden" id="idcabecera'+id+'" name="idcabecera'+id+'" value="'+cabecera+'"><input type="hidden" id="fecha'+id+'" name="fecha'+id+'" value="'+fecha+'"><input type="hidden" name="niv_convenio'+id+'" id="niv_convenio'+id+'" value="'+niv_conv+'" readonly><input type="hidden" name="tipo'+id+'" id="tipo'+id+'" value="'+tipo+'" readonly><p>'+tipo+'</p></td><td><input type="hidden" name="codigo'+id+'" id="codigo'+id+'"  value="'+codigo+'" readonly><p>'+codigo+'</p></td> <td> <input type="hidden" name="descripcion'+id+'" id="descripcion'+id+'" value="'+descripcion+'" readonly><p>'+descripcion+'</p></td><td> <input type="hidden" name="cantidad'+id+'" id="cantidad'+id+'" value="'+cantidad+'" readonly><p>'+cantidad+'</p></td><td> <input type="hidden" name="precio'+id+'" id="precio'+id+'" value="'+precio+'" readonly><p>'+precio+'</p></td><td> <input type="hidden" name="iva'+id+'" id="iva'+id+'" value="'+iva+'" readonly><p>'+iva+'</p></td><td> <input type="hidden" name="total'+id+'" id="total'+id+'" value="'+total+'" readonly><p>'+total+'</p></td><td style="width: 40px;"><button type="button" onclick="eliminar_item_iess('+id+')" class="btn btn-light"><img style="width: 15px;height:15px" src="{{asset('/')}}hc4/img/eliminar_item.png"></button></td>';
    ...
    }else if((honorario_anest>0)&&(porcentaje_honor == const3)&&(proce_separado=='F')){
      ...
      if((cantidad>0)&&(honorario_anest>0)){
        ...
        midiv_item.innerHTML = '<td><input required type="hidden" id="visibilidad_item'+id+'" name="visibilidad_item'+id+'" value="1"><input type="hidden" id="porcent_hon'+id+'" name="porcent_hon'+id+'" value="'+porc_honor+'"><input type="hidden" id="porce_10'+id+'" name="porce_10'+id+'" value="'+porce_10+'"><input type="hidden" id="idcabecera'+id+'" name="idcabecera'+id+'" value="'+cabecera+'"><input type="hidden" id="fecha'+id+'" name="fecha'+id+'" value="'+fecha+'"><input type="hidden" name="niv_convenio'+id+'" id="niv_convenio'+id+'" value="'+niv_conv+'" readonly><input type="hidden" name="tipo'+id+'" id="tipo'+id+'" value="'+tip_an+'" readonly><p>'+tip_an+'</p></td><td> <input type="hidden" name="codigo'+id+'" id="codigo'+id+'"  value="'+codigo+'" readonly ><p>'+codigo+'</p></td> <td> <input type="hidden" name="descripcion'+id+'" id="descripcion'+id+'" value="'+descripcion+'" readonly><p>'+descripcion+'</p></td><td> <input type="hidden"  name="cantidad'+id+'" id="cantidad'+id+'" value="'+cantidad+'" readonly><p>'+cantidad+'</p></td><td> <input type="hidden" name="precio'+id+'" id="precio'+id+'" value="'+honorario_anest+'" readonly><p>'+honorario_anest+'</p></td><td> <input type="hidden" name="iva'+id+'" id="iva'+id+'" value="'+iva+'" readonly><p>'+iva+'</p></td><td> <input type="hidden" name="total'+id+'" id="total'+id+'" value="'+total_anest+'" readonly><p>'+total_anest+'</p>  </td><td style="width: 40px;"><button type="button" onclick="eliminar_item_iess('+id+')" class="btn btn-light"><img style="width: 15px;height:15px" src="{{asset('/')}}hc4/img/eliminar_item.png"></button></td>';
      ...
      if((tiempo_anest>0)&&(val_t_ane>0)){
        ...
        midiv_item.innerHTML = '<td><input required type="hidden" id="visibilidad_item'+id+'" name="visibilidad_item'+id+'" value="1"><input type="hidden" id="porcent_hon'+id+'" name="porcent_hon'+id+'" value="'+porc_honor+'"><input type="hidden" id="porce_10'+id+'" name="porce_10'+id+'" value="'+porce_10+'"><input type="hidden" id="idcabecera'+id+'" name="idcabecera'+id+'" value="'+cabecera+'"><input type="hidden" id="fecha'+id+'" name="fecha'+id+'" value="'+fecha+'"><input type="hidden" name="niv_convenio'+id+'" id="niv_convenio'+id+'" value="'+niv_conv+'" readonly><input type="hidden" name="tipo'+id+'" id="tipo'+id+'" value="'+tip_t_anest+'" readonly><p>'+tip_t_anest+'</p></td><td> <input type="hidden" name="codigo'+id+'" id="codigo'+id+'"  value="'+codigo+'" readonly ><p>'+codigo+'</p></td> <td> <input type="hidden" name="descripcion'+id+'" id="descripcion'+id+'" value="'+descrip+'" readonly><p>'+descrip+'</p></td><td> <input type="hidden"  name="cantidad'+id+'" id="cantidad'+id+'" value="'+tiempo_anest+'" readonly><p>'+tiempo_anest+'</p></td><td> <input type="hidden" name="precio'+id+'" id="precio'+id+'" value="'+val_t_ane+'" readonly><p>'+val_t_ane+'</p></td><td> <input type="hidden" name="iva'+id+'" id="iva'+id+'" value="'+iva+'" readonly><p>'+iva+'</p></td><td> <input type="hidden" name="total'+id+'" id="total'+id+'" value="'+total_t_anes+'" readonly><p>'+total_t_anes+'</p>  </td><td style="width: 40px;"><button type="button" onclick="eliminar_item_iess('+id+')" class="btn btn-light"><img style="width: 15px;height:15px" src="{{asset('/')}}hc4/img/eliminar_item.png"></button></td>';
    ...
    if((honorario_anest == 0)&&(tiempo_anest == 0)&&(iva == 0)){
      ...
      porcentaje_honor = porcentaje_honor / '100';
      precio = precio * porcentaje_honor;
    ...
    document.getElementById('contador_item').value = id;

  }

  function eliminar_item_iess(valor)
  {
  ...
  /*Guardado de Item IESS*/
    function store_item_planilla(){

      cont_tabla = document.getElementById('contador_item').value;
      ...
      $.ajax({
            type: 'post',
            url:"{{route('iess_store.item')}}",
            headers:{'X-CSRF-TOKEN':$('input[name=_token]').val()},
            datatype: 'json',
            data: $("#guardar_item").serialize(),
            success: function(data){
                //console.log(data);
                location.reload();
