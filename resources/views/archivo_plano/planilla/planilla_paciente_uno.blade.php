               ...
               <div class="row" style="padding-left: 1px;">
                   ...
                   <div class="form-group col-md-4 ">
                    ...
                    <div class="form-group col-md-8 ">
                        ...
                        <div class="col-md-9">
                            <input id="nom_procedimiento" maxlength="40" type="text" class="form-control input-sm" name="nom_procedimiento"  value="{{$archivo_plano->nom_procedimiento}}" >
                        </div>
                    </div>
                    <div class="form-group col-md-4 ">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                   <a id="planilla1" class="btn btn-success btn-xs oculto" href="{{route('archivo_plano.planilla_individual',['hcid' => $archivo_plano->id])}}"><span class="glyphicon glyphicon-download-alt"></span> Planilla individual</a>
                    <a id="planilla" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-download-alt"></span> Planilla individual</a>
                    

                    <!--<a id="planilla" class="btn btn-success btn-xs" onclick="verifica_existe({{$archivo_plano->id}})"><span class="glyphicon glyphicon-download-alt"></span> Planilla individual</a>-->
...
<script type="text/javascript">
    ...
    function verifica_existe(id_cabecera){
