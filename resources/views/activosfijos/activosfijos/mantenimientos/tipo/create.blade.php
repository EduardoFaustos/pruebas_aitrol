        ...
        <div class="col-md-12 col-xs-24" >
            <div class="box box-primary">
                ...
                <div class="box-body dobra">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('afTipo.store') }}">
                        {{ csrf_field() }}
                        <div class="form-group{{ $errors->has('id') ? ' has-error' : '' }}">
                            <label for="nombre" class="texto col-md-4 control-label">ID:</label>
                            <div class="col-md-2">
                                <input type="text" class="form-control" id="id" name="id" value="" readonly/>
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('codigo') ? ' has-error' : '' }}">
                            <label for="nombre" class="texto col-md-4 control-label">Codigo:</label>
                            <div class="col-md-2">
                            <input type="number" class="form-control number" id="codigo" name="codigo" value="{{ $codigo }}" required readonly/>
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
                            <label for="nombre" class="texto col-md-4 control-label">Nombre:</label>
                            <div class="col-md-5">
                                <input type="text" class="form-control" size="59" id="nombre" name="nombre" value="" autocomplete="off" required/>
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('cuentamayor') ? ' has-error' : '' }}">
                            <label for="nombre" class="texto col-md-4 control-label">Cta. Mayor:</label>
                            <div class="col-md-5">
                                <select id="cuentamayor" name="cuentamayor"  class="form-control select2_find_cta_activofijo" style="width: 100%;" required>
                                </select>
                            </div>
                            <!-- <div class="col-md-3">
                        ...
                        <div class="form-group{{ $errors->has('cuentagastos') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-5">
                                <select id="cuentagastos" name="cuentagastos"  class="form-control select2_find_cta_activofijo" style="width: 100%;" required>
                                </select>
                            </div>
                            <!-- <div class="col-md-3">
                        ...
                        <div class="form-group{{ $errors->has('cuantadepreciacion') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-5">
                                <select id="cuantadepreciacion" name="cuantadepreciacion"  class="form-control select2_find_cta_activofijo" style="width: 100%;" required>
                                </select>
                            </div>
                            <!-- <div class="col-md-3">
                        ...
                        <div class="form-group">
                                ...
                                <label for="nombre" class="texto col-md-4 control-label">Tasa:</label>
                                <div class="col-md-2">
                                    <input type="number" class="form-control number" id="tasa" name="tasa" value="" required/>
                                </div>
                        ...
                        <div class="form-group">
                            <label for="nombre" class="texto col-md-4 control-label">Vida Util:</label>
                            <div class="col-md-2">
                                <input type="number" class="form-control number" id="vidautil" name="vidautil" value="" required/>
                            </div>
                        </div>   
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('.select2_find_cta_activofijo').select2({
            placeholder: "Seleccione la cuenta",
            allowClear: true,
            ajax: {
                url: '{{route("tipo.find_cta_activofijo")}}',
