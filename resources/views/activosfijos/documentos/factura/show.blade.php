                    ...
                    <table id="example2" class="table table-hover dataTable" role="grid" aria-describedby="example2_info">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 20%;">{{trans('contableM.descripcionactivos')}}</th>
                                <th>{{trans('contableM.cantidad')}}</th>
                                <th>{{trans('contableM.Costo')}}</th>

                                <th>% {{trans('contableM.prctdesc')}}</th>
                                <th>{{trans('contableM.descuento')}}</th>
                                <th>{{trans('contableM.total')}}</th>
                                {{-- <th class="" tabindex="0">{{trans('contableM.iva')}}</th> --}}
                                <th>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <!--button type="button" class="btn btn-primary btn_add" onclick="mdguardar()">{{trans('contableM.agregar')}}</button-->
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
