...
<form method="POST" id="store_reporte_master" action="{{ route('afDepreciacion.store') }}">
    ...
    <div class="box-body">
        ...
        <div class="form-group col-md-4 col-xs-5" style="padding-left: 0px;padding-right: 0px;">
          <label for="fecha_asiento" class="texto col-md-4 control-label">{{trans('contableM.FechadeAsiento')}}:</label>
        ...
        <div class="form-group col-md-8 col-xs-4" style="padding-left: 0px;padding-right: 0px;">
          <label for="det_asiento" class=" texto col-sm-2 control-label">{{trans('contableM.detalle')}}:</label>
    ...
    <b>{{trans('contableM.activosdepreciar')}}</b>
    ...
    <div id="contenedor">
        <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap t9">
                    ...
                    <table id="tbl_depreciacion" class="table-bordered table-hover dataTable table-striped" role="grid" aria-describedby="example2_info">
                        <thead>
                            <tr class="well-dark">
                                ...
                                <th width="5%" class="" tabindex="0" aria-controls="tbl_ventas" rowspan="1" colspan="1" aria-label="Codigo: activate to sort column ascending">{{trans('contableM.fechacompra')}}</th>
                                ...
                                <th width="25%" class="" tabindex="0" aria-controls="tbl_ventas" rowspan="1" colspan="1" aria-label="Codigo: activate to sort column ascending">{{trans('contableM.factura')}} / {{trans('contableM.saldo')}}</th>
                                <th width="25%" class="" tabindex="0" aria-controls="tbl_ventas" rowspan="1" colspan="1" aria-label="Codigo: activate to sort column ascending">{{trans('contableM.diascomprado')}}</th>
                                <th width="25%" class="" tabindex="0" aria-controls="tbl_ventas" rowspan="1" colspan="1" aria-label="Codigo: activate to sort column ascending">{{trans('contableM.ultimadepredciacion')}}</th>
                                ...
                                <th width="5%" class="" tabindex="0" aria-controls="tbl_ventas" rowspan="1" colspan="1" aria-label="Codigo: activate to sort column ascending">{{trans('contableM.depreciacionAcumulado')}}</th>
                                <th width="5%" class="" tabindex="0" aria-controls="tbl_ventas" rowspan="1" colspan="1" aria-label="Codigo: activate to sort column ascending">{{trans('contableM.saldoactual')}}</th>
                                <th width="5%" class="" tabindex="0" aria-controls="tbl_ventas" rowspan="1" colspan="1" aria-label="Codigo: activate to sort column ascending">{{trans('contableM.valoradepreciar')}}</th>
                                <th width="5%" class="" tabindex="0" aria-controls="tbl_ventas" rowspan="1" colspan="1" aria-label="Codigo: activate to sort column ascending">{{trans('contableM.saldodespuesdepreciar')}}</th>
                            </tr>
                        </thead>
            ...
            <div class="row">
                <div class="col-xs-2">
                    <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">{{trans('contableM.TotalRegistros')}} {{count($activos)}} </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-2">
                ...
                <div class="col-xs-2">
                    <button type="button" id="buscarAsiento" onclick="seleccionar_todo(false,'tbl_detalles')" class="btn btn-default">
                        <span class="glyphicon glyphicon-unchecked" aria-hidden="true"></span>&nbsp; {{trans('contableM.descamarcartodos')}}
                    </button>
                </div>
                <div class="col-xs-4">
