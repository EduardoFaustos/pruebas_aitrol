...
class Hc_Evolucion_Indicacion extends Model
{
    //
    protected $table = 'hc_evolucion_indicacion';
    ...
    */
    ...
    {
        return $this->belongsTo('Sis_medico\Tipo_Anesteciologia', 'id_tipoanesteciologia');
    }
