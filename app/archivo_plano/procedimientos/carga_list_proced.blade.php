            ...
            <tbody>
              ...
              @foreach ($proc as $value)
                @php
                  ...
                  $valor_nivel = Sis_medico\ApProcedimientoNivel::where('codigo',$value->codigo)->where('cod_conv',$id_nivel)->first();
                ...
                <tr  role="row" class="odd">
                  @if($j_seguro == 5)
                  <td>@if(!is_null($tip_examen)){{$tip_examen->clasificado}}@endif</td>
                  @endif
