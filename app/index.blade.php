  ...
  <div class="box">
    ...
    <div class="box-body dobra">
      <form method="POST" id="reporte_master" action="{{ route('ventas_search') }}">
        ...
        <div class="form-group col-md-1 col-xs-2">
          <label class="texto" for="paciente">Omni: </label>
        </div>
        <div class="form-group col-md-2 col-xs-10 container-4">
          <select class="form-control" name="omni" id="omni">
              <option value="">Seleccione</option>
              <option @if(isset($searchingVals)) @if($searchingVals['omni']==1) selected="selected" @endif @endif value="1">SI</option>
              <option @if(isset($searchingVals)) @if($searchingVals['omni']==2) selected="selected" @endif @endif value="2">NO</option>
          </select>
        </div>
                  ...
                  <table id="example2" class="table table-bordered table-hover dataTable table-striped" role="grid" aria-describedby="example2_info">
                    <thead>
                      <tr class="well-dark">
                        ...
                        <th >Creado por </th>
                        <th>Anulado por</th>
                        <th  style="font-size: 14px;">Electronica</th>
                        <th>Información</th>
                        <th>Acción</th>
                      </tr>
                    </thead>
