...
class Ct_Imp_Asientos_Cabecera extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'ct_imp_asientos_cabecera';
    ...
    {
        return $this->hasMany('Sis_medico\Ct_Imp_Asientos_Detalle', 'id_asiento_cabecera');
    }
