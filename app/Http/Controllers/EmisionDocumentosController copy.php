...
class EmisionDocumentosController extends Controller
{
                ...
                if ($codDoc == '06') { //GuiaRemision
                    ...
                    if (isset($data['infoNotaCredito'])) {
                        if ($data['infoNotaCredito'] != '') {
                            $error = $this->validarInfoFactura($data['infoNotaCredito'], $cont, $error);
                        } else {
    ...
    public function validarInfoNotaCredito($data, &$cont, $error)
    {
        try {
            ...
            if (isset($data['totalConImpuestos'])) {
                $totalConImpuestos = $data['totalConImpuestos'];
                if (count($totalConImpuestos) > 0) {
                    $conImp = 0;
                    foreach ($totalConImpuestos as $totalConImpuesto) {
                        //Codigo
                        if (isset($totalConImpuesto['Codigo'])) {
                            if (strlen($totalConImpuesto['Codigo']) != 1) {
                                $error[$cont] = "Error " . ($cont + 1) . ': el campo Codigo del totalImpuesto ' . ($conImp + 1) . ' solo puede ser un digito';
                                $cont++;
                            }

                            if (!is_numeric($totalConImpuesto['Codigo'])) {
                                $error[$cont] = "Error " . ($cont + 1) . ': el campo Codigo del totalImpuesto ' . ($conImp + 1) . ' debe ser numerico';
                                $cont++;
                            }
                        } else {
                            $error[$cont] = "Error " . ($cont + 1) . ': el campo Codigo del totalImpuesto ' . ($conImp + 1) . ' es obligatorio';
                            $cont++;
                        }

                        //codigoPorcentaje
                        if (isset($totalConImpuesto['codigoPorcentaje'])) {
                            if (strlen($totalConImpuesto['codigoPorcentaje']) < 1 || strlen($totalConImpuesto['codigoPorcentaje']) > 4) {
                                $error[$cont] = "Error " . ($cont + 1) . ': el campo codigoPorcentaje del totalImpuesto ' . ($conImp + 1) . ' debe tener entre 1 y 4 digitos';
                                $cont++;
                            }

                            if (!is_numeric($totalConImpuesto['codigoPorcentaje'])) {
                                $error[$cont] = "Error " . ($cont + 1) . ': el campo codigoPorcentaje del totalImpuesto ' . ($conImp + 1) . ' debe ser numerico';
                                $cont++;
                            }
                        } else {
                            $error[$cont] = "Error " . ($cont + 1) . ': el campo codigoPorcentaje del totalImpuesto ' . ($conImp + 1) . ' es obligatorio';
                            $cont++;
                        }

                        //baseImponible
                        if (isset($totalConImpuesto['baseImponible'])) {
                            if (strlen($totalConImpuesto['Codigo']) < 1 || strlen($totalConImpuesto['Codigo']) > 4) {
                                $error[$cont] = "Error " . ($cont + 1) . ': el campo codigoPorcentaje del totalImpuesto ' . ($conImp + 1) . ' debe tener entre 1 y 4 digitos';
                                $cont++;
                            }
            ...
            //validar totalConImpuestos
            if (isset($data['totalConImpuestos'])) {
                if ($data['infoNotaCredito']['totalConImpuestos'] != '') {
                    $totalConImpuestos = $data['infoNotaCredito']['totalConImpuestos'];
                    if (count($totalConImpuestos['totalConImpuesto']) > 0) {
                        $conImp = 0;
                        foreach ($totalConImpuestos as $totalConImpuesto) {
                            //codigo
                            if (isset($totalConImpuesto['codigo'])) {
                                if ($totalConImpuesto['codigo'] != '') {
                                    ...
                                    if (!strlen($digitsCod)) {
                                        $error[$cont] = "Error " . ($cont + 1) . ': el campo codigo del impuesto ' . ($conImp + 1) . ' debe ser un digito';
                                        $cont++;
                                    }
                                } else {
                                    $error[$cont] = "Error " . ($cont + 1) . ': el campo codigo del impuesto ' . ($conImp + 1) . ' no puede estar vacio';
                            ...
                            if (isset($totalConImpuesto['codigoPorcentaje'])) {
                                if ($totalConImpuesto['codigoPorcentaje'] != '') {
                                    $digitsCod = str_replace(array('.', ','), array('', ''), strrev($totalConImpuesto['codigoPorcentaje']));
                                    if (!is_numeric($digitsCod)) {
                                        $error[$cont] = "Error " . ($cont + 1) . ': el campo codigoPorcentaje del impuesto ' . ($conImp + 1) . ' debe contener solo numeros';
                                        $cont++;
                                    }

                                    if (strlen($digitsCod) < 1 || strlen($digitsCod) > 4) {
                                        $error[$cont] = "Error " . ($cont + 1) . ': el campo codigoPorcentaje del impuesto ' . ($conImp + 1) . ' debe tener entre 1 y 4 digitos';
                                        $cont++;
                                    }
                                } else {
                            ...
                            if (isset($totalConImpuesto['baseImponible'])) {
                                if ($totalConImpuesto['baseImponible'] != '') {
                                    $digitsCod = str_replace(array('.', ','), array('', ''), strrev($totalConImpuesto['baseImponible']));
                                    if (!is_numeric($digitsCod)) {
                                        $error[$cont] = "Error " . ($cont + 1) . ': el campo baseImponible del impuesto ' . ($conImp + 1) . ' debe ser numerico';
                                        $cont++;
                                    }

                                    if (strlen($digitsCod) > 14) {
                                        $error[$cont] = "Error " . ($cont + 1) . ': el campo baseImponible del impuesto ' . ($conImp + 1) . ' debe contener maximo 14 digitos';
                                        $cont++;
                                    }
                                } else {
                                    $error[$cont] = "Error " . ($cont + 1) . ': el campo baseImponible del impuesto ' . ($conImp + 1) . ' no puede estar vacio';
                            ...
                            if (isset($totalConImpuesto['valor'])) {
                                if ($totalConImpuesto['valor'] != '') {
                                    $digitsCod = str_replace(array('.', ','), array('', ''), strrev($totalConImpuesto['valor']));
                                    if (!is_numeric($digitsCod)) {
                                        $error[$cont] = "Error " . ($cont + 1) . ': el campo valor del impuesto ' . ($conImp + 1) . ' debe ser numerico';
                                        $cont++;
                                    }

                                    if (strlen($digitsCod) > 14) {
                                        $error[$cont] = "Error " . ($cont + 1) . ': el campo valor del impuesto ' . ($conImp + 1) . ' debe contener maximo 14 digitos';
                                        $cont++;
                                    }
                                } else {
                                    $error[$cont] = "Error " . ($cont + 1) . ': el campo valor del impuesto ' . ($conImp + 1) . ' no puede estar vacio';
