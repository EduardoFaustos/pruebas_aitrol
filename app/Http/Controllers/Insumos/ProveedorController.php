...
class ProveedorController extends Controller
{
    ...
    { 
        ...
        $proveedores = DB::table('ct_acreedores as proveedor')->join('tipoproveedor', 'proveedor.id_tipoproveedor', '=', 'tipoproveedor.id')->where('id_empresa', $id_empresa)->select('proveedor.*', 'tipoproveedor.nombre')->paginate('5');
    ...
    private function doSearchingQuery($constraints) {
        $id_empresa = Session::get('id_empresa');
        $query = Ct_Acreedores::query()->join('tipoproveedor', 'ct_acreedores.id_tipoproveedor', '=', 'tipoproveedor.id')->where('id_empresa', $id_empresa)->select('ct_acreedores.*', 'tipoproveedor.nombre');
