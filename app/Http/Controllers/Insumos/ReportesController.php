...
class ReportesController extends Controller
{
    ...
    public static function busqueda_master($request)
    {
        ...
        $productos = DB::table('inv_kardex as ik')
            ...
            ->whereNull('p.deleted_at')
            ->select('p1.codigo', 'p1.nombre as nombre_producto','p1.descripcion', 'b.id','b.nombre as nombre_bodega', 'ik.cantidad', 'idm.serie', 'p.pedido', 'prov.nombrecomercial', 'm.nombre as nombre_marca', 'tip.nombre as nombre_tipop', 'idm.fecha_vence', 'ik.tipo');
