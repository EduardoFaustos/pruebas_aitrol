...
use Sis_medico\Ct_Tipo_Ambiente;
...
class TipoAmbienteController extends Controller
{
    ...
    **********LISTADO TIPO DE AMBIENTE***************
    ...
    public function index(Request $request)
    {
        ...
        $tip_ambiente = Ct_Tipo_Ambiente::where('estado', '!=', null)->orderby('id', 'asc')->paginate(10);

        
         return view('contable.tipo_ambiente.index', ['tip_ambiente' => $tip_ambiente]); 
    }
