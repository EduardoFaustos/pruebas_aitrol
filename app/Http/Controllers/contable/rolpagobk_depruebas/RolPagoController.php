...
class RolPagoController extends Controller
{
    ...
    public function imprimir_rol_pago($id_rolpag)
    {
        ...
        if (($rolUsuario != 1) && ($rolUsuario != 20) && ($rolUsuario != 21)) {
    ...
    public function store_asientos_diario(Request $request)
    {
        ...
        if (!is_null($existe_asiento)) {
            ...
            if ($sueldo_salario > 0) {
                ...
                $plan_cuentas = Plan_Cuentas::where('id', '5.2.02.01.01')->first();

                Ct_Asientos_Detalle::create([

                    'id_asiento_cabecera' => $id_asiento_cabecera,
                    'id_plan_cuenta'      => '5.2.02.01.01',
    ...
    public function exportar_excel(Request $request)
    {
        ...
        Excel::create('Reporte Roles de Pago' . ':' . ' ' . 'Mes' . ':' . $mes_rol . ' del ' . $anio, function ($excel) use ($rol_det_consulta, $mes_rol, $empresa, $anio) {
            $excel->sheet('Datos Roles de Pago', function ($sheet) use ($rol_det_consulta, $mes_rol, $empresa, $anio) {
                ...
                $sheet->cell('B' . $i, function ($cell) use ($total_sueldo) {
                    // manipulate the cel
                ...
                $sheet->cell('C' . $i, function ($cell) use ($total_cantidad_50) {
                    // manipulate the cel
                ...
                $sheet->cell('D' . $i, function ($cell) use ($total_sobret_50) {
                    // manipulate the cel
                ...
                $sheet->cell('E' . $i, function ($cell) use ($total_cantidad_100) {
                    // manipulate the cel
                ...
                $sheet->cell('F' . $i, function ($cell) use ($total_sobret_100) {
                    // manipulate the cel
                ...
                $sheet->cell('G' . $i, function ($cell) use ($total_bono) {
                    // manipulate the cel
                ...
                $sheet->cell('H' . $i, function ($cell) use ($total_bonoimp) {
                    // manipulate the cel
                ...
                $sheet->cell('I' . $i, function ($cell) use ($total_alimentacion) {
                    // manipulate the cel
                    $cell->setValue($total_alimentacion);
                    $cell->setAlignment('right');
                    $cell->setBorder('thin', 'thin', 'thin', 'thin');
                });
                $sheet->cell('J' . $i, function ($cell) use ($total_transporte) {
                    // manipulate the cel
                ...
                $sheet->cell('K' . $i, function ($cell) use ($total_fond_reserva) {
                    // manipulate the cel
                ...
                $sheet->cell('L' . $i, function ($cell) use ($total_dec_tercero) {
                    // manipulate the cel
                ...
                $sheet->cell('M' . $i, function ($cell) use ($total_dec_cuarto) {
                    // manipulate the cel
                ...
                $sheet->cell('N' . $i, function ($cell) use ($total_ingr) {
                    // manipulate the cel
                ...
                $sheet->cell('O' . $i, function ($cell) use ($total_anticip_1eraq) {
                    // manipulate the cel
                ...
                $sheet->cell('P' . $i, function ($cell) use ($total_aporte_iess) {
                    // manipulate the cel
                ...
                $sheet->cell('Q' . $i, function ($cell) use ($total_otros_anticip) {
                    // manipulate the cel
                ...
                $sheet->cell('R' . $i, function ($cell) use ($total_otros_egresos) {
                    // manipulate the cel
                ...
                $sheet->cell('S' . $i, function ($cell) use ($total_prest_emp) {
                    // manipulate the cel
                ...
                $sheet->cell('T' . $i, function ($cell) use ($total_sald_inicial) {
                    // manipulate the cel
                ...
                $sheet->cell('U' . $i, function ($cell) use ($total_seg_medico) {
                    // manipulate the cel
                ...
                $sheet->cell('V' . $i, function ($cell) use ($total_imp_renta) {
                    // manipulate the cel
                ...
                $sheet->cell('W' . $i, function ($cell) use ($total_prest_quirog) {
                    // manipulate the cel
                ...
                $sheet->cell('X' . $i, function ($cell) use ($total_prest_hipotec) {
                    // manipulate the cel
                ...
                $sheet->cell('Y' . $i, function ($cell) use ($total_multas) {
                    // manipulate the cel
                    $cell->setValue($total_multas);
                    $cell->setAlignment('right');
                    $cell->setBorder('thin', 'thin', 'thin', 'thin');
                });
                $sheet->cell('Z' . $i, function ($cell) use ($total_multas) {
                    // manipulate the cel
                    $cell->setValue($total_multas);
                    $cell->setAlignment('right');
                    $cell->setBorder('thin', 'thin', 'thin', 'thin');
                ...
                $sheet->cell('AA' . $i, function ($cell) use ($total_sum_desc) {
                    // manipulate the cel
                ...
                $sheet->cell('AB' . $i, function ($cell) use ($total_net_seg) {
                    // manipulate the cel
