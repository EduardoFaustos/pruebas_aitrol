...
use Sis_medico\Providers\AppServiceProvider;
...
class PreAgendaController extends Controller
{
    ...
    public function pentax(Request $request)
    {
        ...
        //dd($reuniones);
        return view('preagenda/salas', ['salas_encontradas' => $salas_encontradas, 'calendarios' => $arreglo, 'fecha' => $fecha, 'sel_sala' => $sel_sala, 'reuniones' => $reuniones, 'pentax_pend' => $pentax_pend]);
    }   
    ...
    public function nuevo($fecha, $i, $sala)
    {
        ...
        return view('preagenda/agregar', ['salas' => $salas, 'paciente' => $paciente, 'procedimiento' => $procedimiento, 'procedimiento2' => $procedimiento, 'i' => $i, 'empresa' => $empresa, 'seguro' => $seguro, 'hora' => $fecha2, 'unix' => $fecha, 'cortesia_paciente' => $cortesia_paciente, 'citas' => $citas, 'sala2' => $sala]);
    }
    ...
    public function edit($id)
    {
        ...
        $usuarios = DB::table('users')->where('id_tipo_usuario', '=', 3)->where('estado','=',1)->orderBy('apellido1')->get(); //3=DOCTORES;
                ...
                $excel->sheet('Examenes', function($sheet) use($agendas, $salas, $periodo, $fecha) {
                    ...
                    foreach ($agendas as $value) {
                        ...
                        $sheet->cell($letras[$k_y*3 + 3].$k_x, function($cell) use($value) {
                            ...
                            if($value->pnombre2=='(N/A)' || $value->pnombre2=='N/A'){ //regresar aqui
                                $x_nombre2 = '';
                            }
