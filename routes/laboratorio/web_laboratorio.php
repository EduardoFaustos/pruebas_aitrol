...
Route::match(['get', 'post'], 'orden/reporte/comercial', 'laboratorio\OrdenController@reporte_comercial')->name('orden.reporte_comercial');
...
Route::get('nuevo_recibo_de_cobro/datos_cliente/actualizar/{id_cliente}/{id_orden}', 'contable\NuevoReciboCobroController@modal_actualiza_cliente')->name('nuevorecibocobro.modal_actualiza_cliente');
//modal forma de pago
...
Route::get('pendientes/agregar/{mes}/{anio}', 'laboratorio\FacturaAgrupadaController@pendientes_labs')->name('orden.pendientes_labs');
...
Route::get('comercial/', 'comercial\ProdTarifarioController@index')->name('prodtarifario.index');
...
Route::post('nuevo_rc/cabecera/cliente', 'contable\NuevoReciboCobroController@actualizar_cliente')->name('nuevorecibocobro.actualizar_cliente');
...
//REPORTE DE PAGO 5/5/2022
Route::get('orden/reporte/modal', 'laboratorio\OrdenController@modal_pendiente_pago')->name('ordenes.modal_pendiente_pago');
Route::post('orden/reporte/modal_buscar', 'laboratorio\OrdenController@modal_buscar')->name('ordenes.modal_buscar');
Route::get('orden/reporte/agregar_valor', 'laboratorio\OrdenController@agregar_valor')->name('ordenes.agregar_valor');
Route::get('orden/reporte/guardarvalor', 'laboratorio\OrdenController@guardarvalor')->name('ordenes.guardarvalor');
Route::get('orden/reporte/nuevo/comprobante', 'laboratorio\OrdenController@nuevo_combrobante')->name('ordenes.nuevo_combrobante');
Route::get('orden/reporte/nuevo/llenar_campos', 'laboratorio\OrdenController@llenar_campos')->name('ordenes.llenar_campos');
...
Route::get('labs_particulares_a_iess/exel', 'ImportarController@particulares_a_iess')->name('importar.particulares_a_iess');
...
//Proforma por paciente
Route::get('comercial/proforma/por_paciente/{id_paciente}', 'comercial\ProformaController@proforma_paciente')->name('proforma.proforma_paciente');
...
//Empresa por usuario
Route::match(['get', 'post'],'user-management/listado_empresa_usuario/{$id}', 'UserManagementController@listado_empresa')->name('user-management.listado_empresa');
...
//Proforma por paciente
Route::get('comercial/proforma/por_paciente/{id_paciente}', 'comercial\ProformaController@proforma_paciente')->name('proforma.proforma_paciente');
Route::get('mem_labs_puntos/validar/{id_orden}', 'laboratorio\MembresiasLabsController@validar_puntos')->name('orden.validar_puntos');
Route::get('mem_labs_puntos/aplicacion/{id_orden}', 'laboratorio\MembresiasLabsController@aplicar_puntos')->name('orden.aplicar_puntos');

//27/9/2022
Route::post('laboratorio/cierre_caja/verificar', 'contable\CierreCajaController@verificar_fecha')->name('vericar_fecha_cierra');
Route::post('laboratorio/cierre_caja/valor_actualizado', 'contable\CierreCajaController@valor_actualizado')->name('valor_actualizado');
